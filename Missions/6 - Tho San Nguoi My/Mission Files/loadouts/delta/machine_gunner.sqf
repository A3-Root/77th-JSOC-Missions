...
comment "Add weapons";
ACE_player addWeapon "rhs_weap_m249_pip_ris";
...
ACE_player addPrimaryWeaponItem "rhsusf_200Rnd_556x45_mixed_soft_pouch_coyote";
ACE_player addPrimaryWeaponItem "rhsusf_acc_saw_bipod";
...
ACE_player addVest "VSM_FAPC_MG_Multicam";
...
for "_i" from 1 to 4 do {ACE_player addItemToVest "rhsusf_200Rnd_556x45_mixed_soft_pouch_coyote";};
