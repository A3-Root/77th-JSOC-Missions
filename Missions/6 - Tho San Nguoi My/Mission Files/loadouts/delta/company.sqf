...
ACE_player addBackpack "jsoc_RadioBag_multicam";
...
for "_i" from 1 to 20 do {ACE_player addItemToUniform "ACE_fieldDressing";};
...
for "_i" from 1 to 2 do {ACE_player addItemToVest "ACE_salineIV_500";};
ACE_player addItemToVest "ACE_HuntIR_monitor";
...
ACE_player addItemToBackpack "UMB_Beret_JSOC";
...
for "_i" from 1 to 5 do {ACE_player addItemToBackpack "ACE_HuntIR_M203";};
for "_i" from 1 to 2 do {ACE_player addItemToBackpack "1Rnd_SmokeRed_Grenade_shell";};
for "_i" from 1 to 2 do {ACE_player addItemToBackpack "1Rnd_Smoke_Grenade_shell";};
ACE_player addItemToBackpack "ACRE_PRC343";
