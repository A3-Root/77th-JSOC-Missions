...
ROOT_fnc_rocketAIOModule = {
            ...
            while { diag_tickTime < _endTime } do {
                uiSleep 0.5;
                {
                    ...
                    if ((typeOf _ent != "EmptyDetector") && (typeOf _ent != "Land_Pod_Heli_Transport_04_bench_F") && (isNull (attachedTo _ent))) then {
                        ...
                        switch true do {
                            case (_distanceFromRocket <= 50) : {_burndmg = 10;};
                            case (_distanceFromRocket <= 100) : {_burndmg = 5};
                            case (_distanceFromRocket <= 150) : {_burndmg = 3};
                            case (_distanceFromRocket <= 200) : {_burndmg = 1};
                            default {_burndmg = 0};
                        };
    ...
    switch (_action) do {
        case "CREATE": {
            ...
            [_intelBase, 2, false, 0, "Recover Log Data and Execute Failsafe", _pcsearchsound, 15, "Log Data Recovered", "Recovered Encrypted Log and Debug Data of the AAREV."] call zen_modules_fnc_addIntelAction;
