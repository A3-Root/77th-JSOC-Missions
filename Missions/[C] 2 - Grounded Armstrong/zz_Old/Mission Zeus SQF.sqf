...
satview_west = objNull;
if (_layer5595) then {
	satview_west = createVehicle ["Land_HelipadEmpty_F",[7049.96,832.819,12.9337],[],0,"CAN_COLLIDE"];
	_this = satview_west;
	_objects pushback _this;
...
satview_screen_west = objNull;
if (_layerRoot) then {
	satview_screen_west = createVehicle ["Land_BriefingRoomScreen_01_F",[6070.67,-1390.04,46.19],[],0,"CAN_COLLIDE"];
	_this = satview_screen_west;
	_objects pushback _this;
...
if !(isnull satview_screen_west) then {
	this = satview_screen_west;
