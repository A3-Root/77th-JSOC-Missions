    ...
    if (side player != sideLogic) then {     
        ...
        [ 
			[ 
				...
				["box",["\a3\missions_f_aow\data\img\artwork\standard\showcase_aow_picture_26_co.paa","Do Robots have Humanity? Pentagon Explains!"]], 
				["textbold","Fierce fighting between Russian Armed Forces and Sehreno Armed Forces!"], 
				["image",["\a3\missions_f_aow\data\img\artwork\standard\showcase_aow_picture_07_co.paa","Raytheon's One Billion Dollar hardware! All you need to know!"]], 
...

{
	...
	satview_screen_west setObjectTextureGlobal [0, "#(argb,512,512,1)r2t(uavrtt8,1)"];
