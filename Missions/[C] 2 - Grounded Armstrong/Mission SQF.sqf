// Export of 'Grounded%20Armstrong.fapovo' by [Pfc.] Root on v0.9
...
private _layer9898 = (_allWhitelisted || {"off shore safe start" in _layerWhiteList}) && {!("off shore safe start" in _layerBlackList)};
private _layer9076 = (_allWhitelisted || {"abandoned mine interior" in _layerWhiteList}) && {!("abandoned mine interior" in _layerBlackList)};
private _layer9007 = (_allWhitelisted || {"rocket empty" in _layerWhiteList}) && {!("rocket empty" in _layerBlackList)};
private _layer9058 = (_allWhitelisted || {"rocket empty" in _layerWhiteList}) && {!("rocket empty" in _layerBlackList)};
private _layer9003 = (_allWhitelisted || {"soviet launch pad and secret bunker" in _layerWhiteList}) && {!("soviet launch pad and secret bunker" in _layerBlackList)};
private _layer5111 = (_allWhitelisted || {"props" in _layerWhiteList}) && {!("props" in _layerBlackList)};
private _layer5205 = (_allWhitelisted || {"rocks" in _layerWhiteList}) && {!("rocks" in _layerBlackList)};
private _layer5595 = (_allWhitelisted || {"abandoned mine" in _layerWhiteList}) && {!("abandoned mine" in _layerBlackList)};
private _layer4882 = (_allWhitelisted || {"hq - nato - side table 4 sever 2" in _layerWhiteList}) && {!("hq - nato - side table 4 sever 2" in _layerBlackList)};
private _layer4865 = (_allWhitelisted || {"hq - nato - side table 3 server" in _layerWhiteList}) && {!("hq - nato - side table 3 server" in _layerBlackList)};
private _layer4849 = (_allWhitelisted || {"hq - nato - side table 2" in _layerWhiteList}) && {!("hq - nato - side table 2" in _layerBlackList)};
private _layer4833 = (_allWhitelisted || {"hq - nato - side table 1" in _layerWhiteList}) && {!("hq - nato - side table 1" in _layerBlackList)};
private _layer4819 = (_allWhitelisted || {"hq - nato - small middel table" in _layerWhiteList}) && {!("hq - nato - small middel table" in _layerBlackList)};
private _layer4799 = (_allWhitelisted || {"hq - nato - big middle table" in _layerWhiteList}) && {!("hq - nato - big middle table" in _layerBlackList)};
private _layer4795 = (_allWhitelisted || {"hq - nato - mutiple screen" in _layerWhiteList}) && {!("hq - nato - mutiple screen" in _layerBlackList)};
private _layer4794 = (_allWhitelisted || {"hq - nato - desk set" in _layerWhiteList}) && {!("hq - nato - desk set" in _layerBlackList)};
private _layer4526 = (_allWhitelisted || {"fischer's mansion (incomplete)" in _layerWhiteList}) && {!("fischer's mansion (incomplete)" in _layerBlackList)};
private _layer4905 = (_allWhitelisted || {"mansion w/ underground bunker" in _layerWhiteList}) && {!("mansion w/ underground bunker" in _layerBlackList)};
...
if (_layer5595) then {
	_item9751 = createVehicle ["Land_HelipadEmpty_F",[7227.65,512.01,0.0630002],[],0,"CAN_COLLIDE"];
	_this = _item9751;
	_objects pushback _this;
...
private _item9848 = objNull;
if (_layer5595) then {
	_item9848 = createVehicle ["Land_HelipadEmpty_F",[7423.2,321.74,-0.0970001],[],0,"CAN_COLLIDE"];
	_this = _item9848;
	_objects pushback _this;
...
private _item10514 = objNull;
if (_layer5595) then {
	_item10514 = createVehicle ["Land_HelipadEmpty_F",[7049.96,832.819,12.9337],[],0,"CAN_COLLIDE"];
	_this = _item10514;
	_objects pushback _this;
	_objectIDs pushback 10514;
	_this setPosWorld [7049.96,832.819,18.31];
	_this setVectorDirAndUp [[0.411338,-0.911463,0.00600746],[-0.00246091,0.00548029,0.999982]];
	satview_west = _this;
	_this setVehicleVarName "satview_west";
	_this enableSimulation false;
	_this allowdamage false;;
};
...
private _item9023 = objNull;
if (_layer9007 && _layer9058) then {
	_item9023 = createVehicle ["Land_A_TVTower_Base",[9420.67,1464.14,12.242],[],0,"CAN_COLLIDE"];
	_this = _item9023;
	_objects pushback _this;
...
private _item9054 = objNull;
if (_layer9058) then {
	_item9054 = createVehicle ["Land_Battery_F",[9417.01,1464.95,10.108],[],0,"CAN_COLLIDE"];
	_this = _item9054;
	_objects pushback _this;
...
private _item9055 = objNull;
if (_layer9058) then {
	_item9055 = createVehicle ["Land_Battery_F",[9419.31,1470.4,11.885],[],0,"CAN_COLLIDE"];
	_this = _item9055;
	_objects pushback _this;
...
private _item9056 = objNull;
if (_layer9058) then {
	_item9056 = createVehicle ["Land_Battery_F",[9424.27,1468.8,10.918],[],0,"CAN_COLLIDE"];
	_this = _item9056;
	_objects pushback _this;
...
private _item9057 = objNull;
if (_layer9058) then {
	_item9057 = createVehicle ["Land_Battery_F",[9421.55,1463.43,9.501],[],0,"CAN_COLLIDE"];
	_this = _item9057;
	_objects pushback _this;
...
private _item9104 = objNull;
if (_layer9058) then {
	_item9104 = createVehicle ["Land_Battery_F",[9404.76,1494.82,6.507],[],0,"CAN_COLLIDE"];
	_this = _item9104;
	_objects pushback _this;
...
private _item9105 = objNull;
if (_layer9058) then {
	_item9105 = createVehicle ["Land_Battery_F",[9420.36,1465.37,9.009],[],0,"CAN_COLLIDE"];
	_this = _item9105;
	_objects pushback _this;
...
private _item9106 = objNull;
if (_layer9058) then {
	_item9106 = createVehicle ["Land_Battery_F",[9421.94,1462.57,15.443],[],0,"CAN_COLLIDE"];
	_this = _item9106;
	_objects pushback _this;
...
private _item9108 = objNull;
if (_layer9058) then {
	_item9108 = createVehicle ["Land_Battery_F",[9422.7,1467,11.571],[],0,"CAN_COLLIDE"];
	_this = _item9108;
	_objects pushback _this;
...
private _item9109 = objNull;
if (_layer9058) then {
	_item9109 = createVehicle ["Land_Battery_F",[9419.23,1466.3,9.625],[],0,"CAN_COLLIDE"];
	_this = _item9109;
	_objects pushback _this;
...
private _item10356 = objNull;
if (_layer9058) then {
	_item10356 = createVehicle ["Land_Battery_F",[9421.41,1468.53,0],[],0,"CAN_COLLIDE"];
	_this = _item10356;
	_objects pushback _this;
...
private _item9570 = objNull;
if (_layerRoot) then {
	_item9570 = createVehicle ["Land_BriefingRoomScreen_01_F",[8917.49,1348.68,1.07386],[],0,"CAN_COLLIDE"];
	_this = _item9570;
	_objects pushback _this;
...
private _item9854 = objNull;
if (_layerRoot) then {
	_item9854 = createVehicle ["Land_Bunker_F",[7418.74,322.964,0.159002],[],0,"CAN_COLLIDE"];
	_this = _item9854;
	_objects pushback _this;
...
private _item9865 = objNull;
if (_layerRoot) then {
	_item9865 = createVehicle ["Land_dp_smallTank_F",[9411.08,1465.9,37.944],[],0,"CAN_COLLIDE"];
	_this = _item9865;
	_objects pushback _this;
...
private _item9867 = objNull;
if (_layerRoot) then {
	_item9867 = createVehicle ["Land_dp_smallTank_F",[9428.51,1462.88,37.755],[],0,"CAN_COLLIDE"];
	_this = _item9867;
	_objects pushback _this;
...
private _item9899 = objNull;
if (_layerRoot) then {
	_item9899 = createVehicle ["Land_TripodScreen_01_large_F",[6072.69,-1397.15,46.3089],[],0,"CAN_COLLIDE"];
	_this = _item9899;
	_objects pushback _this;
...
private _item9910 = objNull;
if (_layerRoot) then {
	_item9910 = _item9909 createUnit ["rhs_vmf_recon_officer",[7119.23,545.376,0],[],0,"CAN_COLLIDE"];
	_item9909 selectLeader _item9910;
	_this = _item9910;
	_objects pushback _this;
...
private _item10104 = objNull;
if (_layerRoot) then {
	_item10104 = createVehicle ["Land_BriefingRoomScreen_01_F",[8931.15,1351.4,1.01344],[],0,"CAN_COLLIDE"];
	_this = _item10104;
	_objects pushback _this;
...
private _item10285 = objNull;
if (_layerRoot) then {
	_item10285 = createVehicle ["Land_Bunker_F",[7229.9,508.302,0.0170002],[],0,"CAN_COLLIDE"];
	_this = _item10285;
	_objects pushback _this;
...
private _item10341 = objNull;
if (_layerRoot) then {
	_item10341 = createVehicle ["Land_HandyCam_F",[9330.29,1336.68,48.361],[],0,"CAN_COLLIDE"];
	_this = _item10341;
	_objects pushback _this;
...
private _item10353 = objNull;
if (_layerRoot) then {
	_item10353 = _item10352 createUnit ["C_scientist_F",[7643.95,469.157,0],[],0,"CAN_COLLIDE"];
	_item10352 selectLeader _item10353;
	_this = _item10353;
	_objects pushback _this;
	_objectIDs pushback 10353;
	_this setPosWorld [7643.95,469.207,4.98144];
	_this setVectorDirAndUp [[-0.754732,0.656033,0],[0,0,1]];
	_this setname "Kostis Moritiadou";;
...
private _item10370 = objNull;
if (_layerRoot) then {
	_item10370 = createVehicle ["Land_Tablet_02_black_F",[8922.28,1355.95,2.021],[],0,"CAN_COLLIDE"];
	_this = _item10370;
	_objects pushback _this;
...
private _item10403 = objNull;
if (_layerRoot) then {
	_item10403 = _item10402 createUnit ["UK3CB_CHC_C_POLITIC",[7122.13,537.376,0],[],0,"CAN_COLLIDE"];
	_item10402 selectLeader _item10403;
	_this = _item10403;
	_objects pushback _this;
...
private _item10406 = objNull;
if (_layerRoot) then {
	_item10406 = _item10405 createUnit ["C_scientist_F",[4522.13,503.375,0.168],[],0,"CAN_COLLIDE"];
	_item10405 selectLeader _item10406;
	_this = _item10406;
	_objects pushback _this;
...
private _item10408 = objNull;
if (_layerRoot) then {
	_item10408 = _item10407 createUnit ["C_Man_casual_2_F",[4534.25,478.876,0.168],[],0,"CAN_COLLIDE"];
	_item10407 selectLeader _item10408;
	_this = _item10408;
	_objects pushback _this;
...
private _item10411 = objNull;
if (_layerRoot) then {
	_item10411 = _item10410 createUnit ["rhs_vmf_recon_officer",[4503.97,510.437,0.168],[],0,"CAN_COLLIDE"];
	_item10410 selectLeader _item10411;
	_this = _item10411;
	_objects pushback _this;
...
private _item10413 = objNull;
if (_layerRoot) then {
	_item10413 = _item10412 createUnit ["UK3CB_CHC_C_POLITIC",[4539.88,506.834,0.168],[],0,"CAN_COLLIDE"];
	_item10412 selectLeader _item10413;
	_this = _item10413;
	_objects pushback _this;
...
if (_layerRoot) then {
	...
	_this setVariable ['rhs_decalNumber_type', 0,true];[_this,[['Number', cRHSZSUNumberPlaces, 0]]] call rhs_fnc_decalsInit;
...
private _item10516 = objNull;
if (_layerRoot) then {
	_item10516 = createVehicle ["Land_BriefingRoomScreen_01_F",[6070.67,-1390.04,46.19],[],0,"CAN_COLLIDE"];
	_this = _item10516;
	_objects pushback _this;
	_objectIDs pushback 10516;
	_this setPosWorld [6070.69,-1390.11,4.32109];
	_this setVectorDirAndUp [[-0.881929,-0.471382,-2.28354e-006],[0.00076038,-0.00142747,0.999999]];
	satview_screen_west = _this;
	_this setVehicleVarName "satview_screen_west";
	_this allowdamage false;;
	_this setObjectTextureGlobal [0,"a3\boat_f_destroyer\destroyer_01\data\destroyer_01_screen_01_co.paa"];
};

private _item10517 = objNull;
if (_layerRoot) then {
	_item10517 = createVehicle ["Land_BriefingRoomScreen_01_F",[6071.06,-1401.68,46.19],[],0,"CAN_COLLIDE"];
	_this = _item10517;
	_objects pushback _this;
...
private _item10518 = objNull;
if (_layerRoot) then {
	_item10518 = createVehicle ["Land_HelipadEmpty_F",[9338.17,1448.33,0.000468731],[],0,"CAN_COLLIDE"];
	_this = _item10518;
	_objects pushback _this;
...
if (_layerRoot) then {
	...
	_this setVariable ['s',1];;
	[_this, 4] call ace_cargo_fnc_setSpace;;
	_this setVariable ['rhs_decalNumber_type', 0];[_this,[['Number', cRHSBMP3NumberPlaces, 0]]] call rhs_fnc_decalsInit;
	if( -1 >= 0)then{if( -1 == 0)then{{[_this setobjectTexture [_x,'a3\data_f\clear_empty.paa']]}foreach cRHSBMP3NumberPlaces}else{[_this, [['Number', cRHSBMP3NumberPlaces, _this getVariable ['rhs_decalNumber_type','DefaultRed'], -1] ] ] call rhs_fnc_decalsInit}};;
	_this setVariable ['rhs_decalPlatoon_type', 0];;
	if(parseNumber -1 >= 0)then{ [_this, [ [ 'Label', cRHSBMP3PlnSymPlaces,  _this getVariable ['rhs_decalPlatoon_type','Platoon'],call compile -1] ] ] call rhs_fnc_decalsInit};;
};
...
///////////////////////////////////////////////////////////////////////////////////////////
// Layers
