...
private _layer18796 = (_allWhitelisted || {"poi omega" in _layerWhiteList}) && {!("poi omega" in _layerBlackList)};
...
private _item18783 = "";
if (_layer17433) then {
	_item18783 = createMarker ["marker_23",[9370.25,589.578,0]];
	_this = _item18783;
	_markers pushback _this;
	_markerIDs pushback 18783;
	_this setMarkerType "loc_ViewPoint";
	_this setMarkerText "POI Omega";
	_this setMarkerShape "ICON";
	if (([0,0,0] # 0 isNotEqualTo 0) || ([0,0,0] # 1 isNotEqualTo 0)) then {[_this, [0,0,0] # 0, [0,0,0] # 1] spawn BIS_fnc_blinkMarker};;
};
...
private _item18840 = grpNull;
if (_layer16010) then {
	_item18840 = createGroup east;
	_this = _item18840;
	_groups pushback _this;
	_groupIDs pushback 18840;
};
...
private _item18784 = grpNull;
if (_layer17433) then {
	_item18784 = createGroup east;
	_this = _item18784;
	_groups pushback _this;
	_groupIDs pushback 18784;
};

private _item18787 = grpNull;
if (_layer17433) then {
	_item18787 = createGroup east;
	_this = _item18787;
	_groups pushback _this;
	_groupIDs pushback 18787;
};

private _item18797 = grpNull;
if (_layer17433) then {
	_item18797 = createGroup east;
	_this = _item18797;
	_groups pushback _this;
	_groupIDs pushback 18797;
};

private _item18800 = grpNull;
if (_layer17433) then {
	_item18800 = createGroup east;
	_this = _item18800;
	_groups pushback _this;
	_groupIDs pushback 18800;
};

private _item18803 = grpNull;
if (_layer17433) then {
	_item18803 = createGroup east;
	_this = _item18803;
	_groups pushback _this;
	_groupIDs pushback 18803;
};

private _item18806 = grpNull;
if (_layer17433) then {
	_item18806 = createGroup east;
	_this = _item18806;
	_groups pushback _this;
	_groupIDs pushback 18806;
};

private _item18808 = grpNull;
if (_layer17433) then {
	_item18808 = createGroup east;
	_this = _item18808;
	_groups pushback _this;
	_groupIDs pushback 18808;
};

private _item18810 = grpNull;
if (_layer17433) then {
	_item18810 = createGroup east;
	_this = _item18810;
	_groups pushback _this;
	_groupIDs pushback 18810;
};

private _item18812 = grpNull;
if (_layer17433) then {
	_item18812 = createGroup east;
	_this = _item18812;
	_groups pushback _this;
	_groupIDs pushback 18812;
};

private _item18814 = grpNull;
if (_layer17433) then {
	_item18814 = createGroup east;
	_this = _item18814;
	_groups pushback _this;
	_groupIDs pushback 18814;
};

private _item18816 = grpNull;
if (_layer17433) then {
	_item18816 = createGroup east;
	_this = _item18816;
	_groups pushback _this;
	_groupIDs pushback 18816;
};

private _item18818 = grpNull;
if (_layer17433) then {
	_item18818 = createGroup east;
	_this = _item18818;
	_groups pushback _this;
	_groupIDs pushback 18818;
};

private _item18820 = grpNull;
if (_layer17433) then {
	_item18820 = createGroup east;
	_this = _item18820;
	_groups pushback _this;
	_groupIDs pushback 18820;
};

private _item18822 = grpNull;
if (_layer17433) then {
	_item18822 = createGroup east;
	_this = _item18822;
	_groups pushback _this;
	_groupIDs pushback 18822;
};

private _item18824 = grpNull;
if (_layer17433) then {
	_item18824 = createGroup east;
	_this = _item18824;
	_groups pushback _this;
	_groupIDs pushback 18824;
};

private _item18827 = grpNull;
if (_layer17433) then {
	_item18827 = createGroup east;
	_this = _item18827;
	_groups pushback _this;
	_groupIDs pushback 18827;
};
...
if (_layer16010) then {
	...
	_this setPosWorld [9988.58,6158.39,14.4479];
...
if (_layer16010) then {
	...
	_this setPosWorld [9988.37,6160.53,14.2702];
	_this setVectorDirAndUp [[-0.00112638,-0.999999,0],[0,0,1]];
...
if (_layer16010) then {
	...
	_this setPosWorld [9798.67,5351.62,5.64219];
...
if (_layer16010) then {
	...
	_this setPosWorld [9799.85,5351.53,5.63802];
	_this setVectorDirAndUp [[0.0444813,0.99901,0],[0,0,1]];
...
if (_layer16010) then {
	_item16289 = createVehicle ["UK3CB_GAF_O_BRDM2",[9867.96,5217.67,-1.90735e-005],[],0,"CAN_COLLIDE"];
	_this = _item16289;
	_objects pushback _this;
	_objectIDs pushback 16289;
	_this setPosWorld [9867.96,5217.67,7.13613];
	_this setVectorDirAndUp [[0.999047,0.0436548,0],[0,0,1]];
	[_this,"[[[[],[]],[[],[]],[[""FirstAidKit"",""ACE_rope12""],[1,1]],[[],[]]],false]"] call bis_fnc_initAmmoBox;;
	_this setVariable ['s',1];;
	[_this, 6] call ace_cargo_fnc_setSpace;
	if !(true) then { _this call UK3CB_Factions_Vehicles_fnc_disable_randomize; };;
...
if (_layer16010) then {
	...
	_this setPosWorld [9869.61,5218.02,6.01607];
	_this setVectorDirAndUp [[0.999047,0.0436548,0],[0,0,1]];
...
if (_layer16010) then {
	...
	_this setPosWorld [9869.47,5217.46,6.14772];
	_this setVectorDirAndUp [[0.999047,0.0436548,0],[0,0,1]];
...
if (_layer16010) then {
	...
	_this setPosWorld [9868.07,5217.91,6.19489];
	_this setVectorDirAndUp [[0.999047,0.0436548,0],[0,0,1]];
...
if (_layer16010) then {
	...
	_this setPosWorld [9783.46,5454.2,5.98859];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer16010) then {
	...
	_this setPosWorld [9783.7,5452.57,6.42144];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer16010) then {
	...
	_this setPosWorld [9831.79,5190.1,6.38395];
...
if (_layer16010) then {
	...
	_this setPosWorld [9815.39,5138.15,6.00242];
	_this setVectorDirAndUp [[0.86369,0.504023,0],[0,0,1]];
...
if (_layer16010) then {
	...
	_this setPosWorld [9812.99,5136.38,5.74157];
	_this setVectorDirAndUp [[0.86369,0.504023,0],[0,0,1]];
...
if (_layer16010) then {
	...
	_this setPosWorld [9802.53,5287.3,6.38395];
...
if (_layer16010) then {
	_item16313 = createVehicle ["UK3CB_GAF_O_Offroad_HMG",[9815.26,5137.55,0],[],0,"CAN_COLLIDE"];
	_this = _item16313;
	_objects pushback _this;
	_objectIDs pushback 16313;
	_this setPosWorld [9815.26,5137.59,7.03357];
	_this setVectorDirAndUp [[0.86369,0.504023,0],[0,0,1]];
	[_this,"[[[[],[]],[[],[]],[[""FirstAidKit"",""ACE_rope12""],[1,1]],[[],[]]],false]"] call bis_fnc_initAmmoBox;;
	_this setVariable ['s',1];;
	[_this, 4] call ace_cargo_fnc_setSpace;
...
if (_layer16010) then {
	...
	_this setPosWorld [9789.14,5113.5,5.64219];
...
if (_layer16010) then {
	...
	_this setPosWorld [9787.99,5113.81,5.63802];
	_this setVectorDirAndUp [[-0.23449,-0.972118,0],[0,0,1]];
...
if (_layer16010) then {
	...
	_this setPosWorld [9789.32,5116.36,6.02979];
	_this setVectorDirAndUp [[-0.23449,-0.972118,0],[0,0,1]];
...
if (_layer16010) then {
	...
	_this setPosWorld [9965.53,6117.37,13.2602];
...
if (_layer16010) then {
	...
	_this setPosWorld [9966.95,6117.39,13.6661];
	_this setVectorDirAndUp [[-0.999656,0.0262107,0],[0,0,1]];
...
if (_layer16010) then {
	...
	_this setPosWorld [9810.21,5112.82,4.81019];
...
if (_layer16010) then {
	...
	_this setPosWorld [9810.68,5114.15,5.2161];
	_this setVectorDirAndUp [[-0.366469,-0.93043,0],[0,0,1]];
...
if (_layer16010) then {
	...
	_this setPosWorld [9668.67,4300.32,6.00242];
...
if (_layer16010) then {
	...
	_this setPosWorld [9671.65,4300.37,5.74157];
	_this setVectorDirAndUp [[-0.995851,0.0909985,0],[0,0,1]];
...
private _item18842 = objNull;
if (_layer16010) then {
	_item18842 = _item18840 createUnit ["UK3CB_GAF_O_RIF_1",[9792.17,5125.94,1.611],[],0,"CAN_COLLIDE"];
	_item18840 selectLeader _item18842;
	_this = _item18842;
	_objects pushback _this;
	_objectIDs pushback 18842;
	_this setPosWorld [9792.4,5126.54,4.74704];
	_this setVectorDirAndUp [[0.0524565,-0.998623,0],[0,0,1]];
	_this setname "Osvald Koudelka";;
	_this setface "WhiteHead_15";;
	_this setspeaker "rhs_male03cz";;
	_this setpitch 0.96746;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
private _item18841 = objNull;
if (_layer16010) then {
	_item18841 = createVehicle ["UK3CB_GAF_O_DSHKM",[9792.17,5125.94,0],[],0,"CAN_COLLIDE"];
	_this = _item18841;
	_objects pushback _this;
	_objectIDs pushback 18841;
	_this setPosWorld [9792.17,5125.94,6.411];
	_this setVectorDirAndUp [[0.0524565,-0.998623,0],[0,0,1]];
	[_this, 2] call ace_cargo_fnc_setSize;
	_this setTurretLimits [ [0], -180, (_this getTurretLimits [0])#1, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
	_this setTurretLimits [ [0], (_this getTurretLimits [0])#0, 180, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
...
private _item18914 = objNull;
if (_layer16010) then {
	_item18914 = createSimpleObject ["Land_Antibiotic_F",[9755.3,5209.29,9.29298]];
	_this = _item18914;
	_objects pushback _this;
	_objectIDs pushback 18914;
	_this setPosWorld [9755.3,5209.29,9.31092];
	_this setVectorDirAndUp [[-0.241922,0.970296,0],[0,0,1]];
};

private _item19045 = objNull;
if (_layer16010) then {
	_item19045 = createSimpleObject ["Land_Antibiotic_F",[9782.3,5212.58,8.66963]];
	_this = _item19045;
	_objects pushback _this;
	_objectIDs pushback 19045;
	_this setPosWorld [9782.3,5212.58,8.68757];
	_this setVectorDirAndUp [[-0.5,-0.866025,0],[0,0,1]];
};

private _item18913 = objNull;
if (_layer16010) then {
	_item18913 = createSimpleObject ["Land_Bandage_F",[9755.18,5209.61,9.27802]];
	_this = _item18913;
	_objects pushback _this;
	_objectIDs pushback 18913;
	_this setPosWorld [9755.18,5209.61,9.28131];
	_this setVectorDirAndUp [[-0.838671,-0.544639,0],[0,0,1]];
};

private _item18941 = objNull;
if (_layer16010) then {
	_item18941 = createVehicle ["BloodSplatter_01_Small_New_F",[9780.87,5212.08,3.85947],[],0,"CAN_COLLIDE"];
	_this = _item18941;
	_objects pushback _this;
	_objectIDs pushback 18941;
	_this setPosWorld [9780.87,5212.08,8.66447];
	_this setVectorDirAndUp [[-0.999391,-0.0348993,0],[0,0,1]];
...
if (_layer16010) then {
	_item18940 = createSimpleObject ["Land_Bodybag_01_blue_F",[9772.19,5211.67,5.76529]];
	_this = _item18940;
	_objects pushback _this;
	_objectIDs pushback 18940;
	_this setPosWorld [9772.19,5211.67,5.9009];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item18946 = objNull;
if (_layer16010) then {
	_item18946 = createSimpleObject ["Land_Bodybag_01_folded_white_F",[9760.79,5211.39,8.65679]];
	_this = _item18946;
	_objects pushback _this;
	_objectIDs pushback 18946;
	_this setPosWorld [9760.79,5211.39,8.67207];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
};

private _item18947 = objNull;
if (_layer16010) then {
	_item18947 = createSimpleObject ["Land_Bodybag_01_folded_white_F",[9760.57,5211.89,8.65679]];
	_this = _item18947;
	_objects pushback _this;
	_objectIDs pushback 18947;
	_this setPosWorld [9760.57,5211.89,8.67207];
	_this setVectorDirAndUp [[-0.5,-0.866025,0],[0,0,1]];
};

private _item18948 = objNull;
if (_layer16010) then {
	_item18948 = createSimpleObject ["Land_Bodybag_01_folded_white_F",[9775.6,5207.61,8.65954]];
	_this = _item18948;
	_objects pushback _this;
	_objectIDs pushback 18948;
	_this setPosWorld [9775.6,5207.61,8.67482];
	_this setVectorDirAndUp [[0.5,-0.866025,0],[0,0,1]];
};

private _item18949 = objNull;
if (_layer16010) then {
	_item18949 = createSimpleObject ["Land_Bodybag_01_folded_white_F",[9776.14,5207.55,8.65954]];
	_this = _item18949;
	_objects pushback _this;
	_objectIDs pushback 18949;
	_this setPosWorld [9776.14,5207.55,8.67482];
	_this setVectorDirAndUp [[0.5,0.866025,0],[0,0,1]];
};

private _item19008 = objNull;
if (_layer16010) then {
	_item19008 = createSimpleObject ["Land_PaperBox_01_open_water_F",[9777.84,5207.86,5.32476]];
	_this = _item19008;
	_objects pushback _this;
	_objectIDs pushback 19008;
	_this setPosWorld [9777.84,5207.86,5.95595];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
	[_this, 7] call ace_cargo_fnc_setSize;
};

private _item18916 = objNull;
if (_layer16010) then {
	_item18916 = createSimpleObject ["Land_Camera_01_F",[9760.45,5208.24,9.46906]];
	_this = _item18916;
	_objects pushback _this;
	_objectIDs pushback 18916;
	_this setPosWorld [9760.45,5208.24,9.50616];
	_this setVectorDirAndUp [[0.707107,0.707107,0],[0,0,1]];
};

private _item18901 = objNull;
if (_layer16010) then {
	_item18901 = createSimpleObject ["Land_CampingChair_V2_F",[9755.77,5206.86,5.36481]];
	_this = _item18901;
	_objects pushback _this;
	_objectIDs pushback 18901;
	_this setPosWorld [9755.77,5206.86,5.8713];
	_this setVectorDirAndUp [[0.866025,-0.5,0],[0,0,1]];
};

private _item18902 = objNull;
if (_layer16010) then {
	_item18902 = createSimpleObject ["Land_CampingChair_V2_F",[9755.78,5205.91,5.36481]];
	_this = _item18902;
	_objects pushback _this;
	_objectIDs pushback 18902;
	_this setPosWorld [9755.78,5205.91,5.8713];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
};

private _item18955 = objNull;
if (_layer16010) then {
	_item18955 = createSimpleObject ["Land_CampingChair_V2_F",[9760.83,5213.22,5.36481]];
	_this = _item18955;
	_objects pushback _this;
	_objectIDs pushback 18955;
	_this setPosWorld [9760.83,5213.22,5.8713];
	_this setVectorDirAndUp [[-0.5,-0.866025,0],[0,0,1]];
};

private _item18956 = objNull;
if (_layer16010) then {
	_item18956 = createSimpleObject ["Land_CampingChair_V2_F",[9765.32,5212.05,8.65268]];
	_this = _item18956;
	_objects pushback _this;
	_objectIDs pushback 18956;
	_this setPosWorld [9765.32,5212.05,9.15917];
	_this setVectorDirAndUp [[0.5,0.866025,0],[0,0,1]];
};

private _item18957 = objNull;
if (_layer16010) then {
	_item18957 = createSimpleObject ["Land_CampingChair_V2_F",[9771.84,5212.07,8.64434]];
	_this = _item18957;
	_objects pushback _this;
	_objectIDs pushback 18957;
	_this setPosWorld [9771.84,5212.07,9.15083];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18958 = objNull;
if (_layer16010) then {
	_item18958 = createSimpleObject ["Land_CampingChair_V2_F",[9766.7,5205.5,5.30912]];
	_this = _item18958;
	_objects pushback _this;
	_objectIDs pushback 18958;
	_this setPosWorld [9766.7,5205.5,5.81561];
	_this setVectorDirAndUp [[0.5,-0.866025,0],[0,0,1]];
};

private _item18959 = objNull;
if (_layer16010) then {
	_item18959 = createSimpleObject ["Land_CampingChair_V2_F",[9759.65,5207.71,8.65605]];
	_this = _item18959;
	_objects pushback _this;
	_objectIDs pushback 18959;
	_this setPosWorld [9759.65,5207.71,9.16254];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18960 = objNull;
if (_layer16010) then {
	_item18960 = createSimpleObject ["Land_CampingChair_V2_F",[9760.82,5207.52,8.65605]];
	_this = _item18960;
	_objects pushback _this;
	_objectIDs pushback 18960;
	_this setPosWorld [9760.82,5207.52,9.16254];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18961 = objNull;
if (_layer16010) then {
	_item18961 = createSimpleObject ["Land_CampingChair_V2_F",[9765.49,5205.85,5.30919]];
	_this = _item18961;
	_objects pushback _this;
	_objectIDs pushback 18961;
	_this setPosWorld [9765.49,5205.85,5.81568];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18962 = objNull;
if (_layer16010) then {
	_item18962 = createSimpleObject ["Land_CampingChair_V2_F",[9759.88,5213.22,5.36481]];
	_this = _item18962;
	_objects pushback _this;
	_objectIDs pushback 18962;
	_this setPosWorld [9759.88,5213.22,5.8713];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18963 = objNull;
if (_layer16010) then {
	_item18963 = createSimpleObject ["Land_CampingChair_V2_F",[9766.37,5212.07,8.65268]];
	_this = _item18963;
	_objects pushback _this;
	_objectIDs pushback 18963;
	_this setPosWorld [9766.37,5212.07,9.15917];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18964 = objNull;
if (_layer16010) then {
	_item18964 = createSimpleObject ["Land_CampingChair_V2_F",[9770.9,5212.33,8.60226]];
	_this = _item18964;
	_objects pushback _this;
	_objectIDs pushback 18964;
	_this setPosWorld [9770.9,5212.33,9.10875];
	_this setVectorDirAndUp [[-0.866025,0.5,0],[0,0,1]];
};

private _item18965 = objNull;
if (_layer16010) then {
	_item18965 = createSimpleObject ["Land_CampingChair_V2_F",[9776,5207.38,5.36611]];
	_this = _item18965;
	_objects pushback _this;
	_objectIDs pushback 18965;
	_this setPosWorld [9776,5207.38,5.8726];
	_this setVectorDirAndUp [[0.258819,-0.965926,0],[0,0,1]];
};

private _item18966 = objNull;
if (_layer16010) then {
	_item18966 = createSimpleObject ["Land_CampingChair_V2_F",[9774.64,5207.21,5.36611]];
	_this = _item18966;
	_objects pushback _this;
	_objectIDs pushback 18966;
	_this setPosWorld [9774.64,5207.21,5.8726];
	_this setVectorDirAndUp [[-0.866025,-0.5,0],[0,0,1]];
};

private _item18967 = objNull;
if (_layer16010) then {
	_item18967 = createSimpleObject ["Land_CampingChair_V2_F",[9762.8,5211.65,5.32127]];
	_this = _item18967;
	_objects pushback _this;
	_objectIDs pushback 18967;
	_this setPosWorld [9762.8,5211.65,5.82775];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
};

private _item18897 = objNull;
if (_layer16010) then {
	_item18897 = createSimpleObject ["Land_CampingTable_F",[9755.23,5206.35,5.36481]];
	_this = _item18897;
	_objects pushback _this;
	_objectIDs pushback 18897;
	_this setPosWorld [9755.23,5206.35,5.77637];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
};

private _item18931 = objNull;
if (_layer16010) then {
	_item18931 = createSimpleObject ["Land_CampingTable_F",[9760.25,5208.1,8.65476]];
	_this = _item18931;
	_objects pushback _this;
	_objectIDs pushback 18931;
	_this setPosWorld [9760.25,5208.1,9.06631];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18932 = objNull;
if (_layer16010) then {
	_item18932 = createSimpleObject ["Land_CampingTable_F",[9765.81,5211.54,8.65138]];
	_this = _item18932;
	_objects pushback _this;
	_objectIDs pushback 18932;
	_this setPosWorld [9765.81,5211.54,9.06293];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18933 = objNull;
if (_layer16010) then {
	_item18933 = createSimpleObject ["Land_CampingTable_F",[9760.32,5213.77,5.36481]];
	_this = _item18933;
	_objects pushback _this;
	_objectIDs pushback 18933;
	_this setPosWorld [9760.32,5213.77,5.77637];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18934 = objNull;
if (_layer16010) then {
	_item18934 = createSimpleObject ["Land_CampingTable_F",[9771.38,5211.53,8.64711]];
	_this = _item18934;
	_objects pushback _this;
	_objectIDs pushback 18934;
	_this setPosWorld [9771.38,5211.53,9.05866];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18935 = objNull;
if (_layer16010) then {
	_item18935 = createSimpleObject ["Land_CampingTable_F",[9775.39,5208.03,5.36481]];
	_this = _item18935;
	_objects pushback _this;
	_objectIDs pushback 18935;
	_this setPosWorld [9775.39,5208.03,5.77637];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18936 = objNull;
if (_layer16010) then {
	_item18936 = createSimpleObject ["Land_CampingTable_F",[9765.97,5206.23,5.30924]];
	_this = _item18936;
	_objects pushback _this;
	_objectIDs pushback 18936;
	_this setPosWorld [9765.97,5206.23,5.72079];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18937 = objNull;
if (_layer16010) then {
	_item18937 = createSimpleObject ["Land_CampingTable_small_F",[9762.38,5211.64,5.321]];
	_this = _item18937;
	_objects pushback _this;
	_objectIDs pushback 18937;
	_this setPosWorld [9762.38,5211.64,5.7262];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
};

private _item19046 = objNull;
if (_layer16010) then {
	_item19046 = createSimpleObject ["Land_Can_Rusty_F",[9760.06,5208.3,9.46906]];
	_this = _item19046;
	_objects pushback _this;
	_objectIDs pushback 19046;
	_this setPosWorld [9760.06,5208.3,9.50909];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18915 = objNull;
if (_layer16010) then {
	_item18915 = createSimpleObject ["Land_CanisterPlastic_F",[9755.78,5209.58,5.31859]];
	_this = _item18915;
	_objects pushback _this;
	_objectIDs pushback 18915;
	_this setPosWorld [9755.78,5209.58,5.66642];
	_this setVectorDirAndUp [[0.866025,0.5,0],[0,0,1]];
};

private _item18988 = objNull;
if (_layer16010) then {
	_item18988 = createSimpleObject ["Land_PaperBox_01_small_closed_brown_F",[9769.57,5212.02,8.65387]];
	_this = _item18988;
	_objects pushback _this;
	_objectIDs pushback 18988;
	_this setPosWorld [9769.57,5212.02,8.86084];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
...
if (_layer16010) then {
	_item18992 = createSimpleObject ["Land_PaperBox_01_small_closed_brown_F",[9779.15,5208.01,5.73529]];
	_this = _item18992;
	_objects pushback _this;
	_objectIDs pushback 18992;
	_this setPosWorld [9779.15,5208.01,5.94226];
...
if (_layer16010) then {
	_item18995 = createSimpleObject ["Land_PaperBox_01_small_closed_brown_F",[9769.27,5211.28,8.65387]];
	_this = _item18995;
	_objects pushback _this;
	_objectIDs pushback 18995;
	_this setPosWorld [9769.27,5211.28,8.86084];
	_this setVectorDirAndUp [[-0.25882,-0.965926,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};

private _item18987 = objNull;
if (_layer16010) then {
	_item18987 = createSimpleObject ["Land_PaperBox_01_small_closed_brown_IDAP_F",[9777.38,5212.01,5.32631]];
	_this = _item18987;
	_objects pushback _this;
	_objectIDs pushback 18987;
	_this setPosWorld [9777.38,5212.01,5.53328];
	_this setVectorDirAndUp [[-0.0523365,-0.99863,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};

private _item18994 = objNull;
if (_layer16010) then {
	_item18994 = createSimpleObject ["Land_PaperBox_01_small_closed_brown_IDAP_F",[9765.83,5206.26,8.65483]];
	_this = _item18994;
	_objects pushback _this;
	_objectIDs pushback 18994;
	_this setPosWorld [9765.83,5206.26,8.8618];
	_this setVectorDirAndUp [[0.978148,0.207912,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};

private _item18983 = objNull;
if (_layer16010) then {
	_item18983 = createVehicle ["Land_PaperBox_01_small_open_brown_F",[9766.5,5206.24,0.505442],[],0,"CAN_COLLIDE"];
	_this = _item18983;
	_objects pushback _this;
	_objectIDs pushback 18983;
	_this setPosWorld [9766.5,5206.24,5.51834];
	_this setVectorDirAndUp [[0.258819,-0.965926,0],[0,0,1]];
};

private _item18982 = objNull;
if (_layer16010) then {
	_item18982 = createVehicle ["Land_PaperBox_01_small_open_brown_IDAP_F",[9766.11,5206.27,4.27257],[],0,"CAN_COLLIDE"];
	_this = _item18982;
	_objects pushback _this;
	_objectIDs pushback 18982;
	_this setPosWorld [9766.11,5206.27,9.28547];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18984 = objNull;
if (_layer16010) then {
	_item18984 = createVehicle ["Land_PaperBox_01_small_open_brown_IDAP_F",[9777.44,5211.67,0.943963],[],0,"CAN_COLLIDE"];
	_this = _item18984;
	_objects pushback _this;
	_objectIDs pushback 18984;
	_this setPosWorld [9777.44,5211.67,5.95686];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item18985 = objNull;
if (_layer16010) then {
	_item18985 = createVehicle ["Land_PaperBox_01_small_open_brown_IDAP_F",[9764.33,5211.48,3.85387],[],0,"CAN_COLLIDE"];
	_this = _item18985;
	_objects pushback _this;
	_objectIDs pushback 18985;
	_this setPosWorld [9764.33,5211.48,8.86677];
	_this setVectorDirAndUp [[0.258819,0.965926,0],[0,0,1]];
};

private _item18990 = objNull;
if (_layer16010) then {
	_item18990 = createSimpleObject ["Land_PaperBox_01_small_closed_brown_food_F",[9779.21,5208.32,5.32594]];
	_this = _item18990;
	_objects pushback _this;
	_objectIDs pushback 18990;
	_this setPosWorld [9779.21,5208.32,5.53291];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};
...
if (_layer16010) then {
	_item18993 = createSimpleObject ["Land_PaperBox_01_small_closed_brown_food_F",[9766.45,5206.28,8.65503]];
	_this = _item18993;
	_objects pushback _this;
	_objectIDs pushback 18993;
	_this setPosWorld [9766.45,5206.28,8.862];
	_this setVectorDirAndUp [[-0.99863,0.0523366,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};

private _item18996 = objNull;
if (_layer16010) then {
	_item18996 = createSimpleObject ["Land_PaperBox_01_small_closed_brown_food_F",[9767.32,5205.84,5.32386]];
	_this = _item18996;
	_objects pushback _this;
	_objectIDs pushback 18996;
	_this setPosWorld [9767.32,5205.84,5.53083];
	_this setVectorDirAndUp [[0.965926,0.258819,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};
...
if (_layer16010) then {
	_item18906 = createSimpleObject ["Land_PaperBox_01_small_closed_white_med_F",[9755.13,5214.1,5.32117]];
	_this = _item18906;
	_objects pushback _this;
	_objectIDs pushback 18906;
	_this setPosWorld [9755.13,5214.1,5.52814];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};
...
if (_layer16010) then {
	_item18907 = createSimpleObject ["Land_PaperBox_01_small_closed_white_med_F",[9755.13,5213.47,5.31776]];
	_this = _item18907;
	_objects pushback _this;
	_objectIDs pushback 18907;
	_this setPosWorld [9755.13,5213.47,5.52473];
	_this setVectorDirAndUp [[0.258819,-0.965926,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};
...
if (_layer16010) then {
	_item18986 = createSimpleObject ["Land_PaperBox_01_small_closed_white_med_F",[9769.59,5211.67,9.07055]];
	_this = _item18986;
	_objects pushback _this;
	_objectIDs pushback 18986;
	_this setPosWorld [9769.59,5211.67,9.27752];
	_this setVectorDirAndUp [[0.965926,-0.258819,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};
...
if (_layer16010) then {
	_item18989 = createSimpleObject ["Land_PaperBox_01_small_closed_white_med_F",[9779.21,5207.69,5.32253]];
	_this = _item18989;
	_objects pushback _this;
	_objectIDs pushback 18989;
	_this setPosWorld [9779.21,5207.69,5.5295];
	_this setVectorDirAndUp [[0.258819,-0.965926,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};
...
if (_layer16010) then {
	_item18991 = createSimpleObject ["Land_PaperBox_01_small_closed_white_med_F",[9777.45,5211.39,5.32631]];
	_this = _item18991;
	_objects pushback _this;
	_objectIDs pushback 18991;
	_this setPosWorld [9777.45,5211.39,5.53328];
	_this setVectorDirAndUp [[-0.207912,0.978148,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};

private _item19030 = objNull;
if (_layer16010) then {
	_item19030 = createVehicle ["Land_CratesPlastic_F",[9770.64,5213.9,3.85763],[],0,"CAN_COLLIDE"];
	_this = _item19030;
	_objects pushback _this;
	_objectIDs pushback 19030;
	_this setPosWorld [9770.64,5213.9,8.8901];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
};

private _item18912 = objNull;
if (_layer16010) then {
	_item18912 = createSimpleObject ["Land_DisinfectantSpray_F",[9755.22,5209.66,9.61802]];
	_this = _item18912;
	_objects pushback _this;
	_objectIDs pushback 18912;
	_this setPosWorld [9755.22,5209.66,9.75604];
	_this setVectorDirAndUp [[-0.5,-0.866025,0],[0,0,1]];
};

private _item19042 = objNull;
if (_layer16010) then {
	_item19042 = createSimpleObject ["Land_DisinfectantSpray_F",[9782.31,5211.69,5.3312]];
	_this = _item19042;
	_objects pushback _this;
	_objectIDs pushback 19042;
	_this setPosWorld [9782.31,5211.69,5.46922];
	_this setVectorDirAndUp [[0.5,-0.866025,0],[0,0,1]];
};

private _item19043 = objNull;
if (_layer16010) then {
	_item19043 = createSimpleObject ["Land_DisinfectantSpray_F",[9777.61,5207.99,8.664]];
	_this = _item19043;
	_objects pushback _this;
	_objectIDs pushback 19043;
	_this setPosWorld [9777.61,5207.99,8.80202];
	_this setVectorDirAndUp [[-0.5,0.866025,0],[0,0,1]];
};

private _item19044 = objNull;
if (_layer16010) then {
	_item19044 = createSimpleObject ["Land_DisinfectantSpray_F",[9757.6,5211.42,8.66605]];
	_this = _item19044;
	_objects pushback _this;
	_objectIDs pushback 19044;
	_this setPosWorld [9757.6,5211.42,8.80407];
	_this setVectorDirAndUp [[0.5,-0.866025,0],[0,0,1]];
};

private _item18896 = objNull;
if (_layer16010) then {
	_item18896 = createSimpleObject ["Land_EmergencyBlanket_01_discarded_F",[9756.38,5211.69,9.13074]];
	_this = _item18896;
	_objects pushback _this;
	_objectIDs pushback 18896;
	_this setPosWorld [9756.38,5211.69,9.17588];
	_this setVectorDirAndUp [[-0.99863,-0.0523356,0],[0,0,1]];
};

private _item18926 = objNull;
if (_layer16010) then {
	_item18926 = createSimpleObject ["Land_EmergencyBlanket_01_discarded_F",[9777.6,5206.83,9.14123]];
	_this = _item18926;
	_objects pushback _this;
	_objectIDs pushback 18926;
	_this setPosWorld [9777.6,5206.83,9.18637];
	_this setVectorDirAndUp [[-0.052336,0.99863,0],[0,0,1]];
};

private _item18927 = objNull;
if (_layer16010) then {
	_item18927 = createSimpleObject ["Land_EmergencyBlanket_01_discarded_F",[9781.71,5211.44,5.80866]];
	_this = _item18927;
	_objects pushback _this;
	_objectIDs pushback 18927;
	_this setPosWorld [9781.71,5211.44,5.8538];
	_this setVectorDirAndUp [[-0.99863,-0.0523356,0],[0,0,1]];
};

private _item18925 = objNull;
if (_layer16010) then {
	_item18925 = createSimpleObject ["Land_EmergencyBlanket_02_stack_F",[9762.35,5211.5,6.13496]];
	_this = _item18925;
	_objects pushback _this;
	_objectIDs pushback 18925;
	_this setPosWorld [9762.35,5211.5,6.23335];
	_this setVectorDirAndUp [[-0.453991,-0.891006,0],[0,0,1]];
};

private _item18951 = objNull;
if (_layer16010) then {
	_item18951 = createSimpleObject ["Land_FirstAidKit_01_open_F",[9781.49,5211.93,5.3312]];
	_this = _item18951;
	_objects pushback _this;
	_objectIDs pushback 18951;
	_this setPosWorld [9781.49,5211.93,5.39399];
	_this setVectorDirAndUp [[0.707107,-0.707107,0],[0,0,1]];
};

private _item18952 = objNull;
if (_layer16010) then {
	_item18952 = createSimpleObject ["Land_FirstAidKit_01_open_F",[9778.37,5208.08,8.664]];
	_this = _item18952;
	_objects pushback _this;
	_objectIDs pushback 18952;
	_this setPosWorld [9778.37,5208.08,8.72679];
	_this setVectorDirAndUp [[-0.707107,0.707107,0],[0,0,1]];
};

private _item18953 = objNull;
if (_layer16010) then {
	_item18953 = createSimpleObject ["Land_FirstAidKit_01_open_F",[9782.48,5211.58,9.12887]];
	_this = _item18953;
	_objects pushback _this;
	_objectIDs pushback 18953;
	_this setPosWorld [9782.48,5211.58,9.19166];
	_this setVectorDirAndUp [[0.707107,0.707107,0],[0,0,1]];
};

private _item18846 = objNull;
if (_layer16010) then {
	_item18846 = createVehicle ["Flag_GAF",[9771.49,5202.55,0],[],0,"CAN_COLLIDE"];
	_this = _item18846;
	_objects pushback _this;
	_objectIDs pushback 18846;
	_this setPosWorld [9771.49,5202.55,8.7768];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18905 = objNull;
if (_layer16010) then {
	_item18905 = createSimpleObject ["Land_FlowerPot_01_Flower_F",[9755.16,5210.41,8.65067]];
	_this = _item18905;
	_objects pushback _this;
	_objectIDs pushback 18905;
	_this setPosWorld [9755.16,5210.41,9.45174];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
};

private _item18981 = objNull;
if (_layer16010) then {
	_item18981 = createSimpleObject ["Land_FlowerPot_01_F",[9776.13,5206.6,8.65402]];
	_this = _item18981;
	_objects pushback _this;
	_objectIDs pushback 18981;
	_this setPosWorld [9776.13,5206.6,8.7767];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item19029 = objNull;
if (_layer16010) then {
	_item19029 = createSimpleObject ["Land_FlowerPot_01_F",[9769.28,5211.63,5.32061]];
	_this = _item19029;
	_objects pushback _this;
	_objectIDs pushback 19029;
	_this setPosWorld [9769.28,5211.63,5.44329];
	_this setVectorDirAndUp [[-0.965926,0.258819,0],[0,0,1]];
};

private _item18899 = objNull;
if (_layer16010) then {
	_item18899 = createSimpleObject ["Land_FoodContainer_01_F",[9755.19,5208.18,5.32191]];
	_this = _item18899;
	_objects pushback _this;
	_objectIDs pushback 18899;
	_this setPosWorld [9755.19,5208.18,5.54971];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18919 = objNull;
if (_layer16010) then {
	_item18919 = createSimpleObject ["Land_FoodContainer_01_F",[9765.32,5206.35,6.11347]];
	_this = _item18919;
	_objects pushback _this;
	_objectIDs pushback 18919;
	_this setPosWorld [9765.32,5206.35,6.34128];
	_this setVectorDirAndUp [[0.777146,0.629321,0],[0,0,1]];
};

private _item18942 = objNull;
if (_layer16010) then {
	_item18942 = createSimpleObject ["Land_FoodContainer_01_F",[9776.07,5212.31,5.32199]];
	_this = _item18942;
	_objects pushback _this;
	_objectIDs pushback 18942;
	_this setPosWorld [9776.07,5212.31,5.5498];
	_this setVectorDirAndUp [[-0.965926,0.258819,0],[0,0,1]];
};

private _item18917 = objNull;
if (_layer16010) then {
	_item18917 = createSimpleObject ["Land_FoodContainer_01_White_F",[9770.63,5208.28,5.31914]];
	_this = _item18917;
	_objects pushback _this;
	_objectIDs pushback 18917;
	_this setPosWorld [9770.63,5208.28,5.54695];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
};

private _item18943 = objNull;
if (_layer16010) then {
	_item18943 = createSimpleObject ["Land_FoodContainer_01_White_F",[9775.12,5208.31,5.32449]];
	_this = _item18943;
	_objects pushback _this;
	_objectIDs pushback 18943;
	_this setPosWorld [9775.12,5208.31,5.55229];
	_this setVectorDirAndUp [[0.777146,0.629321,0],[0,0,1]];
};

private _item18939 = objNull;
if (_layer16010) then {
	_item18939 = createSimpleObject ["Land_FoodSack_01_empty_brown_F",[9766.74,5205.01,8.64509]];
	_this = _item18939;
	_objects pushback _this;
	_objectIDs pushback 18939;
	_this setPosWorld [9766.74,5205.01,8.68635];
	_this setVectorDirAndUp [[0.258819,-0.965926,0],[0,0,1]];
};

private _item18938 = objNull;
if (_layer16010) then {
	_item18938 = createSimpleObject ["Land_FoodSack_01_full_brown_F",[9767.28,5205.07,8.61746]];
	_this = _item18938;
	_objects pushback _this;
	_objectIDs pushback 18938;
	_this setPosWorld [9767.28,5205.07,8.72626];
	_this setVectorDirAndUp [[-0.25882,-0.965926,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};

private _item18954 = objNull;
if (_layer16010) then {
	_item18954 = createSimpleObject ["Land_FoodSacks_01_small_brown_F",[9767.16,5205.89,8.65889]];
	_this = _item18954;
	_objects pushback _this;
	_objectIDs pushback 18954;
	_this setPosWorld [9767.16,5205.89,8.87538];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
	[_this, 2] call ace_cargo_fnc_setSize;
};

private _item18928 = objNull;
if (_layer16010) then {
	_item18928 = createSimpleObject ["Land_HeatPack_F",[9777.8,5208.09,8.664]];
	_this = _item18928;
	_objects pushback _this;
	_objectIDs pushback 18928;
	_this setPosWorld [9777.8,5208.09,8.67335];
	_this setVectorDirAndUp [[0.258819,0.965926,0],[0,0,1]];
};

private _item18929 = objNull;
if (_layer16010) then {
	_item18929 = createSimpleObject ["Land_HeatPack_F",[9757.55,5211.65,8.66605]];
	_this = _item18929;
	_objects pushback _this;
	_objectIDs pushback 18929;
	_this setPosWorld [9757.55,5211.65,8.6754];
	_this setVectorDirAndUp [[-0.25882,-0.965926,0],[0,0,1]];
};

private _item18930 = objNull;
if (_layer16010) then {
	_item18930 = createSimpleObject ["Land_HeatPack_F",[9782.12,5211.59,5.3312]];
	_this = _item18930;
	_objects pushback _this;
	_objectIDs pushback 18930;
	_this setPosWorld [9782.12,5211.59,5.34055];
	_this setVectorDirAndUp [[-0.25882,-0.965926,0],[0,0,1]];
};

private _item18910 = objNull;
if (_layer16010) then {
	_item18910 = createSimpleObject ["Land_IntravenBag_01_full_F",[9755.23,5209.29,9.61802]];
	_this = _item18910;
	_objects pushback _this;
	_objectIDs pushback 18910;
	_this setPosWorld [9755.23,5209.29,9.64157];
	_this setVectorDirAndUp [[0.422618,0.906308,0],[0,0,1]];
};

private _item18923 = objNull;
if (_layer16010) then {
	_item18923 = createSimpleObject ["Land_IntravenStand_01_1bag_F",[9760.97,5207.7,5.36481]];
	_this = _item18923;
	_objects pushback _this;
	_objectIDs pushback 18923;
	_this setPosWorld [9760.97,5207.7,6.29621];
	_this setVectorDirAndUp [[-0.052336,0.99863,0],[0,0,1]];
};

private _item18921 = objNull;
if (_layer16010) then {
	_item18921 = createSimpleObject ["Land_IntravenStand_01_2bags_F",[9761.1,5212.03,8.65679]];
	_this = _item18921;
	_objects pushback _this;
	_objectIDs pushback 18921;
	_this setPosWorld [9761.1,5212.03,9.58818];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18922 = objNull;
if (_layer16010) then {
	_item18922 = createSimpleObject ["Land_IntravenStand_01_2bags_F",[9775.74,5208.14,8.65954]];
	_this = _item18922;
	_objects pushback _this;
	_objectIDs pushback 18922;
	_this setPosWorld [9775.74,5208.14,9.59093];
	_this setVectorDirAndUp [[0.866025,-0.5,0],[0,0,1]];
};

private _item18924 = objNull;
if (_layer16010) then {
	_item18924 = createSimpleObject ["Land_IntravenStand_01_2bags_F",[9782.02,5211.37,8.65947]];
	_this = _item18924;
	_objects pushback _this;
	_objectIDs pushback 18924;
	_this setPosWorld [9782.02,5211.37,9.59086];
	_this setVectorDirAndUp [[0.99863,0.0523361,0],[0,0,1]];
};

private _item18950 = objNull;
if (_layer16010) then {
	_item18950 = createVehicle ["MedicalGarbage_01_1x1_v1_F",[9760.51,5207.85,0.527104],[],0,"CAN_COLLIDE"];
	_this = _item18950;
	_objects pushback _this;
	_objectIDs pushback 18950;
	_this setPosWorld [9760.51,5207.85,5.34797];
	_this setVectorDirAndUp [[-0.866025,-0.5,0],[0,0,1]];
};

private _item18969 = objNull;
if (_layer16010) then {
	_item18969 = createVehicle ["MedicalGarbage_01_1x1_v2_F",[9757.31,5211.58,3.86605],[],0,"CAN_COLLIDE"];
	_this = _item18969;
	_objects pushback _this;
	_objectIDs pushback 18969;
	_this setPosWorld [9757.31,5211.58,8.69478];
	_this setVectorDirAndUp [[0.866025,-0.5,0],[0,0,1]];
};

private _item18970 = objNull;
if (_layer16010) then {
	_item18970 = createVehicle ["MedicalGarbage_01_1x1_v2_F",[9780.95,5211.97,0.531199],[],0,"CAN_COLLIDE"];
	_this = _item18970;
	_objects pushback _this;
	_objectIDs pushback 18970;
	_this setPosWorld [9780.95,5211.97,5.35993];
	_this setVectorDirAndUp [[0.866025,-0.5,0],[0,0,1]];
};

private _item18971 = objNull;
if (_layer16010) then {
	_item18971 = createVehicle ["MedicalGarbage_01_1x1_v2_F",[9778.97,5207.71,3.864],[],0,"CAN_COLLIDE"];
	_this = _item18971;
	_objects pushback _this;
	_objectIDs pushback 18971;
	_this setPosWorld [9778.97,5207.71,8.69273];
	_this setVectorDirAndUp [[-0.866025,0.5,0],[0,0,1]];
};

private _item18968 = objNull;
if (_layer16010) then {
	_item18968 = createVehicle ["MedicalGarbage_01_5x5_v1_F",[9780.54,5212.74,3.85947],[],0,"CAN_COLLIDE"];
	_this = _item18968;
	_objects pushback _this;
	_objectIDs pushback 18968;
	_this setPosWorld [9780.54,5212.74,8.69402];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item18903 = objNull;
if (_layer16010) then {
	_item18903 = createVehicle ["MedicalGarbage_01_Injector_F",[9755.3,5209.32,4.16889],[],0,"CAN_COLLIDE"];
	_this = _item18903;
	_objects pushback _this;
	_objectIDs pushback 18903;
	_this setPosWorld [9755.3,5209.32,8.9829];
	_this setVectorDirAndUp [[0.866025,0.5,0],[0,0,1]];
};

private _item19025 = objNull;
if (_layer16010) then {
	_item19025 = createSimpleObject ["Land_PCSet_01_case_F",[9760.4,5208.02,8.65605]];
	_this = _item19025;
	_objects pushback _this;
	_objectIDs pushback 19025;
	_this setPosWorld [9760.4,5208.02,8.91309];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setVariable ['expEden_PCSetCaseDmg_enable', false, true];
};

private _item19026 = objNull;
if (_layer16010) then {
	_item19026 = createSimpleObject ["Land_PCSet_01_case_F",[9775.54,5207.95,5.36611]];
	_this = _item19026;
	_objects pushback _this;
	_objectIDs pushback 19026;
	_this setPosWorld [9775.54,5207.95,5.62315];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setVariable ['expEden_PCSetCaseDmg_enable', false, true];
};

private _item19027 = objNull;
if (_layer16010) then {
	_item19027 = createSimpleObject ["Land_PCSet_01_case_F",[9765.93,5211.61,8.65268]];
	_this = _item19027;
	_objects pushback _this;
	_objectIDs pushback 19027;
	_this setPosWorld [9765.93,5211.61,8.90972];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
	_this setVariable ['expEden_PCSetCaseDmg_enable', false, true];
};

private _item19028 = objNull;
if (_layer16010) then {
	_item19028 = createSimpleObject ["Land_PCSet_01_case_F",[9760.13,5208.03,8.65605]];
	_this = _item19028;
	_objects pushback _this;
	_objectIDs pushback 19028;
	_this setPosWorld [9760.13,5208.03,8.91309];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setVariable ['expEden_PCSetCaseDmg_enable', false, true];
};
...
if (_layer16010) then {
	_item19009 = createSimpleObject ["Land_PCSet_01_keyboard_F",[9766.39,5211.46,9.46568]];
	_this = _item19009;
	_objects pushback _this;
	_objectIDs pushback 19009;
	_this setPosWorld [9766.39,5211.46,9.47361];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item19010 = objNull;
if (_layer16010) then {
	_item19010 = createSimpleObject ["Land_PCSet_01_keyboard_F",[9775.74,5207.94,6.17912]];
	_this = _item19010;
	_objects pushback _this;
	_objectIDs pushback 19010;
	_this setPosWorld [9775.74,5207.94,6.18705];
	_this setVectorDirAndUp [[0.258819,0.965926,0],[0,0,1]];
};

private _item19011 = objNull;
if (_layer16010) then {
	_item19011 = createSimpleObject ["Land_PCSet_01_keyboard_F",[9760.55,5207.92,9.46906]];
	_this = _item19011;
	_objects pushback _this;
	_objectIDs pushback 19011;
	_this setPosWorld [9760.55,5207.92,9.477];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item19012 = objNull;
if (_layer16010) then {
	_item19012 = createSimpleObject ["Land_PCSet_01_keyboard_F",[9759.65,5207.9,9.46906]];
	_this = _item19012;
	_objects pushback _this;
	_objectIDs pushback 19012;
	_this setPosWorld [9759.65,5207.9,9.477];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item19013 = objNull;
if (_layer16010) then {
	_item19013 = createSimpleObject ["Land_PCSet_01_mousepad_F",[9760.05,5207.95,9.46906]];
	_this = _item19013;
	_objects pushback _this;
	_objectIDs pushback 19013;
	_this setPosWorld [9760.05,5207.95,9.47269];
	_this setVectorDirAndUp [[0.965926,0.258819,0],[0,0,1]];
};

private _item19014 = objNull;
if (_layer16010) then {
	_item19014 = createSimpleObject ["Land_PCSet_01_mousepad_F",[9766.01,5211.69,9.46568]];
	_this = _item19014;
	_objects pushback _this;
	_objectIDs pushback 19014;
	_this setPosWorld [9766.01,5211.69,9.46931];
	_this setVectorDirAndUp [[-0.965926,-0.258819,0],[0,0,1]];
};

private _item19015 = objNull;
if (_layer16010) then {
	_item19015 = createSimpleObject ["Land_PCSet_01_mousepad_F",[9776.11,5207.81,6.17912]];
	_this = _item19015;
	_objects pushback _this;
	_objectIDs pushback 19015;
	_this setPosWorld [9776.11,5207.81,6.18275];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item19016 = objNull;
if (_layer16010) then {
	_item19016 = createSimpleObject ["Land_PCSet_01_mousepad_F",[9760.98,5207.88,9.46906]];
	_this = _item19016;
	_objects pushback _this;
	_objectIDs pushback 19016;
	_this setPosWorld [9760.98,5207.88,9.47269];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item19017 = objNull;
if (_layer16010) then {
	_item19017 = createSimpleObject ["Land_PCSet_01_mouse_F",[9760.99,5207.88,9.47632]];
	_this = _item19017;
	_objects pushback _this;
	_objectIDs pushback 19017;
	_this setPosWorld [9760.99,5207.88,9.50153];
	_this setVectorDirAndUp [[0.258819,0.965926,0],[0,0,1]];
};

private _item19018 = objNull;
if (_layer16010) then {
	_item19018 = createSimpleObject ["Land_PCSet_01_mouse_F",[9776.13,5207.81,6.18638]];
	_this = _item19018;
	_objects pushback _this;
	_objectIDs pushback 19018;
	_this setPosWorld [9776.13,5207.81,6.21159];
	_this setVectorDirAndUp [[0.258819,0.965926,0],[0,0,1]];
};

private _item19019 = objNull;
if (_layer16010) then {
	_item19019 = createSimpleObject ["Land_PCSet_01_mouse_F",[9766.01,5211.71,9.47295]];
	_this = _item19019;
	_objects pushback _this;
	_objectIDs pushback 19019;
	_this setPosWorld [9766.01,5211.71,9.49816];
	_this setVectorDirAndUp [[0.5,-0.866025,0],[0,0,1]];
};

private _item19020 = objNull;
if (_layer16010) then {
	_item19020 = createSimpleObject ["Land_PCSet_01_mouse_F",[9760.05,5207.93,9.47632]];
	_this = _item19020;
	_objects pushback _this;
	_objectIDs pushback 19020;
	_this setPosWorld [9760.05,5207.93,9.50153];
	_this setVectorDirAndUp [[-0.5,0.866025,0],[0,0,1]];
};

private _item19021 = objNull;
if (_layer16010) then {
	_item19021 = createSimpleObject ["Land_PCSet_01_screen_F",[9766.41,5211.26,9.46568]];
	_this = _item19021;
	_objects pushback _this;
	_objectIDs pushback 19021;
	_this setPosWorld [9766.41,5211.26,9.72036];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
	_this setObjectTextureGlobal [0,"#(argb,8,8,3)color(0,0,0,0,co)"];
	_this setVariable ['expEden_PCSetScreenDmg_enable', false, true];
};

private _item19022 = objNull;
if (_layer16010) then {
	_item19022 = createSimpleObject ["Land_PCSet_01_screen_F",[9760.89,5208.3,9.46906]];
	_this = _item19022;
	_objects pushback _this;
	_objectIDs pushback 19022;
	_this setPosWorld [9760.89,5208.3,9.72374];
	_this setVectorDirAndUp [[0.258819,0.965926,0],[0,0,1]];
	_this setObjectTextureGlobal [0,"#(argb,8,8,3)color(0,0,0,0,co)"];
	_this setVariable ['expEden_PCSetScreenDmg_enable', false, true];
};
...
if (_layer16010) then {
	_item19023 = createSimpleObject ["Land_PCSet_01_screen_F",[9775.86,5208.24,6.17912]];
	_this = _item19023;
	_objects pushback _this;
	_objectIDs pushback 19023;
	_this setPosWorld [9775.86,5208.24,6.4338];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setObjectTextureGlobal [0,"#(argb,8,8,3)color(0,0,0,0,co)"];
	_this setVariable ['expEden_PCSetScreenDmg_enable', false, true];
};

private _item19024 = objNull;
if (_layer16010) then {
	_item19024 = createSimpleObject ["Land_PCSet_01_screen_F",[9759.61,5208.35,9.46906]];
	_this = _item19024;
	_objects pushback _this;
	_objectIDs pushback 19024;
	_this setPosWorld [9759.61,5208.35,9.72374];
	_this setVectorDirAndUp [[-0.258819,0.965926,0],[0,0,1]];
	_this setObjectTextureGlobal [0,"#(argb,8,8,3)color(0,0,0,0,co)"];
	_this setVariable ['expEden_PCSetScreenDmg_enable', false, true];
};
...
if (_layer16010) then {
	_item18895 = createSimpleObject ["Land_PlasticBucket_01_closed_F",[9755.09,5208.26,8.65521]];
	_this = _item18895;
	_objects pushback _this;
	_objectIDs pushback 18895;
	_this setPosWorld [9755.09,5208.26,8.87793];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18900 = objNull;
if (_layer16010) then {
	_item18900 = createSimpleObject ["Land_PlasticBucket_01_closed_F",[9757.22,5211.48,5.31656]];
	_this = _item18900;
	_objects pushback _this;
	_objectIDs pushback 18900;
	_this setPosWorld [9757.22,5211.48,5.53928];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18918 = objNull;
if (_layer16010) then {
	_item18918 = createSimpleObject ["Land_PlasticBucket_01_closed_F",[9758.62,5208.34,5.31945]];
	_this = _item18918;
	_objects pushback _this;
	_objectIDs pushback 18918;
	_this setPosWorld [9758.62,5208.34,5.54217];
	_this setVectorDirAndUp [[-0.438371,0.898794,0],[0,0,1]];
};

private _item18944 = objNull;
if (_layer16010) then {
	_item18944 = createSimpleObject ["Land_PlasticBucket_01_closed_F",[9782.58,5214.06,8.66302]];
	_this = _item18944;
	_objects pushback _this;
	_objectIDs pushback 18944;
	_this setPosWorld [9782.58,5214.06,8.88574];
	_this setVectorDirAndUp [[-0.719339,0.694659,0],[0,0,1]];
};

private _item18945 = objNull;
if (_layer16010) then {
	_item18945 = createSimpleObject ["Land_PlasticBucket_01_closed_F",[9776.09,5211.44,5.32439]];
	_this = _item18945;
	_objects pushback _this;
	_objectIDs pushback 18945;
	_this setPosWorld [9776.09,5211.44,5.54711];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item18920 = objNull;
if (_layer16010) then {
	_item18920 = createSimpleObject ["Land_PlasticBucket_01_open_F",[9777.23,5212.65,5.32239]];
	_this = _item18920;
	_objects pushback _this;
	_objectIDs pushback 18920;
	_this setPosWorld [9777.23,5212.65,5.54511];
	_this setVectorDirAndUp [[0.956305,-0.292372,0],[0,0,1]];
};

private _item19047 = objNull;
if (_layer16010) then {
	_item19047 = createSimpleObject ["Fridge_01_open_F",[9775.93,5211.87,8.65731]];
	_this = _item19047;
	_objects pushback _this;
	_objectIDs pushback 19047;
	_this setPosWorld [9775.93,5211.87,9.1758];
	_this setVectorDirAndUp [[-0.965926,0.258819,0],[0,0,1]];
};

private _item18845 = objNull;
if (_layer16010) then {
	_item18845 = createVehicle ["Land_Laptop_03_olive_F",[9755.4,5206.38,1.411],[],0,"CAN_COLLIDE"];
	_this = _item18845;
	_objects pushback _this;
	_objectIDs pushback 18845;
	_this setPosWorld [9755.4,5206.38,6.37841];
	_this setVectorDirAndUp [[-0.999695,-0.0246767,0],[0,0,1]];
	_this setObjectTextureGlobal [1,""];
};

private _item18854 = objNull;
if (_layer16010) then {
	_item18854 = createVehicle ["Land_BagFence_01_corner_green_F",[9826.8,5157.68,9.27269],[],0,"CAN_COLLIDE"];
	_this = _item18854;
	_objects pushback _this;
	_objectIDs pushback 18854;
	_this setPosWorld [9826.8,5157.68,14.4938];
	_this setVectorDirAndUp [[0.999902,-4.37114e-008,0.0139649],[-0.0139649,0,0.999902]];
};

private _item18911 = objNull;
if (_layer16010) then {
	_item18911 = createVehicle ["Land_BagFence_Long_F",[9756.27,5214.4,7.4852],[],0,"CAN_COLLIDE"];
	_this = _item18911;
	_objects pushback _this;
	_objectIDs pushback 18911;
	_this setPosWorld [9756.27,5214.4,12.7045];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item19035 = objNull;
if (_layer16010) then {
	_item19035 = createVehicle ["Land_BagFence_Long_F",[9770.64,5218.06,0],[],0,"CAN_COLLIDE"];
	_this = _item19035;
	_objects pushback _this;
	_objectIDs pushback 19035;
	_this setPosWorld [9770.64,5218.06,5.21931];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item19036 = objNull;
if (_layer16010) then {
	_item19036 = createVehicle ["Land_BagFence_Long_F",[9768.7,5203.26,7.47751],[],0,"CAN_COLLIDE"];
	_this = _item19036;
	_objects pushback _this;
	_objectIDs pushback 19036;
	_this setPosWorld [9768.7,5203.26,12.6968];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item19037 = objNull;
if (_layer16010) then {
	_item19037 = createVehicle ["Land_BagFence_Long_F",[9759.06,5214.4,7.49211],[],0,"CAN_COLLIDE"];
	_this = _item19037;
	_objects pushback _this;
	_objectIDs pushback 19037;
	_this setPosWorld [9759.06,5214.4,12.7114];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item19038 = objNull;
if (_layer16010) then {
	_item19038 = createVehicle ["Land_BagFence_Long_F",[9761.87,5214.44,7.50918],[],0,"CAN_COLLIDE"];
	_this = _item19038;
	_objects pushback _this;
	_objectIDs pushback 19038;
	_this setPosWorld [9761.87,5214.44,12.7285];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item19039 = objNull;
if (_layer16010) then {
	_item19039 = createVehicle ["Land_BagFence_Long_F",[9763.01,5203.24,7.44785],[],0,"CAN_COLLIDE"];
	_this = _item19039;
	_objects pushback _this;
	_objectIDs pushback 19039;
	_this setPosWorld [9763.01,5203.24,12.6672];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item19040 = objNull;
if (_layer16010) then {
	_item19040 = createVehicle ["Land_BagFence_Long_F",[9773.45,5218.09,0.0170708],[],0,"CAN_COLLIDE"];
	_this = _item19040;
	_objects pushback _this;
	_objectIDs pushback 19040;
	_this setPosWorld [9773.45,5218.09,5.23638];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item19041 = objNull;
if (_layer16010) then {
	_item19041 = createVehicle ["Land_BagFence_Long_F",[9765.86,5203.27,7.47474],[],0,"CAN_COLLIDE"];
	_this = _item19041;
	_objects pushback _this;
	_objectIDs pushback 19041;
	_this setPosWorld [9765.86,5203.27,12.6941];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18855 = objNull;
if (_layer16010) then {
	_item18855 = createVehicle ["Land_BagFence_01_long_green_F",[9816.22,5170.76,9.2122],[],0,"CAN_COLLIDE"];
	_this = _item18855;
	_objects pushback _this;
	_objectIDs pushback 18855;
	_this setPosWorld [9816.22,5170.76,14.4295];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18856 = objNull;
if (_layer16010) then {
	_item18856 = createVehicle ["Land_BagFence_01_long_green_F",[9827.05,5159.56,9.27619],[],0,"CAN_COLLIDE"];
	_this = _item18856;
	_objects pushback _this;
	_objectIDs pushback 18856;
	_this setPosWorld [9827.05,5159.56,14.4935];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item18857 = objNull;
if (_layer16010) then {
	_item18857 = createVehicle ["Land_BagFence_01_long_green_F",[9825.18,5157.31,9.25],[],0,"CAN_COLLIDE"];
	_this = _item18857;
	_objects pushback _this;
	_objectIDs pushback 18857;
	_this setPosWorld [9825.18,5157.31,14.4673];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18858 = objNull;
if (_layer16010) then {
	_item18858 = createVehicle ["Land_BagFence_01_long_green_F",[9822.43,5157.31,9.21159],[],0,"CAN_COLLIDE"];
	_this = _item18858;
	_objects pushback _this;
	_objectIDs pushback 18858;
	_this setPosWorld [9822.43,5157.31,14.4289];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18859 = objNull;
if (_layer16010) then {
	_item18859 = createVehicle ["Land_BagFence_01_long_green_F",[9818.93,5170.81,9.25],[],0,"CAN_COLLIDE"];
	_this = _item18859;
	_objects pushback _this;
	_objectIDs pushback 18859;
	_this setPosWorld [9818.93,5170.81,14.4673];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18860 = objNull;
if (_layer16010) then {
	_item18860 = createVehicle ["Land_BagFence_01_long_green_F",[9819.72,5157.26,9.17379],[],0,"CAN_COLLIDE"];
	_this = _item18860;
	_objects pushback _this;
	_objectIDs pushback 18860;
	_this setPosWorld [9819.72,5157.26,14.3911];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18861 = objNull;
if (_layer16010) then {
	_item18861 = createVehicle ["Land_BagFence_01_long_green_F",[9821.68,5170.81,9.28841],[],0,"CAN_COLLIDE"];
	_this = _item18861;
	_objects pushback _this;
	_objectIDs pushback 18861;
	_this setPosWorld [9821.68,5170.81,14.5057];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item19031 = objNull;
if (_layer16010) then {
	_item19031 = createVehicle ["Land_BagFence_Round_F",[9763.54,5217.42,0],[],0,"CAN_COLLIDE"];
	_this = _item19031;
	_objects pushback _this;
	_objectIDs pushback 19031;
	_this setPosWorld [9763.54,5217.42,5.21931];
	_this setVectorDirAndUp [[-0.707107,-0.707107,0],[0,0,1]];
};

private _item19032 = objNull;
if (_layer16010) then {
	_item19032 = createVehicle ["Land_BagFence_Round_F",[9775.67,5217.42,0],[],0,"CAN_COLLIDE"];
	_this = _item19032;
	_objects pushback _this;
	_objectIDs pushback 19032;
	_this setPosWorld [9775.67,5217.42,5.21931];
	_this setVectorDirAndUp [[-0.707107,-0.707107,0],[0,0,1]];
};

private _item19033 = objNull;
if (_layer16010) then {
	_item19033 = createVehicle ["Land_BagFence_Round_F",[9768.09,5217.42,0],[],0,"CAN_COLLIDE"];
	_this = _item19033;
	_objects pushback _this;
	_objectIDs pushback 19033;
	_this setPosWorld [9768.09,5217.42,5.21931];
	_this setVectorDirAndUp [[0.707107,-0.707107,0],[0,0,1]];
};

private _item19034 = objNull;
if (_layer16010) then {
	_item19034 = createVehicle ["Land_BagFence_Round_F",[9780.15,5217.45,0],[],0,"CAN_COLLIDE"];
	_this = _item19034;
	_objects pushback _this;
	_objectIDs pushback 19034;
	_this setPosWorld [9780.15,5217.45,5.21931];
	_this setVectorDirAndUp [[0.707107,-0.707107,0],[0,0,1]];
};

private _item18908 = objNull;
if (_layer16010) then {
	_item18908 = createVehicle ["Land_BagFence_Short_F",[9754.95,5212.07,7.70395],[],0,"CAN_COLLIDE"];
	_this = _item18908;
	_objects pushback _this;
	_objectIDs pushback 18908;
	_this setPosWorld [9754.95,5212.07,12.9182];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
};

private _item18909 = objNull;
if (_layer16010) then {
	_item18909 = createVehicle ["Land_BagFence_Short_F",[9754.96,5213.48,7.57777],[],0,"CAN_COLLIDE"];
	_this = _item18909;
	_objects pushback _this;
	_objectIDs pushback 18909;
	_this setPosWorld [9754.96,5213.48,12.7921];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
};

private _item18997 = objNull;
if (_layer16010) then {
	_item18997 = createVehicle ["Land_BagFence_Short_F",[9761.71,5204.28,7.45538],[],0,"CAN_COLLIDE"];
	_this = _item18997;
	_objects pushback _this;
	_objectIDs pushback 18997;
	_this setPosWorld [9761.71,5204.28,12.6697];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item18998 = objNull;
if (_layer16010) then {
	_item18998 = createVehicle ["Land_BagFence_Short_F",[9784.05,5211.56,0],[],0,"CAN_COLLIDE"];
	_this = _item18998;
	_objects pushback _this;
	_objectIDs pushback 18998;
	_this setPosWorld [9784.05,5211.56,5.21428];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18999 = objNull;
if (_layer16010) then {
	_item18999 = createVehicle ["Land_BagFence_Short_F",[9784.87,5215.43,3.82922],[],0,"CAN_COLLIDE"];
	_this = _item18999;
	_objects pushback _this;
	_objectIDs pushback 18999;
	_this setPosWorld [9784.87,5215.43,9.0435];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
};

private _item19000 = objNull;
if (_layer16010) then {
	_item19000 = createVehicle ["Land_BagFence_Short_F",[9764.18,5215.55,0],[],0,"CAN_COLLIDE"];
	_this = _item19000;
	_objects pushback _this;
	_objectIDs pushback 19000;
	_this setPosWorld [9764.18,5215.55,5.21428];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item19001 = objNull;
if (_layer16010) then {
	_item19001 = createVehicle ["Land_BagFence_Short_F",[9784.1,5208.37,0],[],0,"CAN_COLLIDE"];
	_this = _item19001;
	_objects pushback _this;
	_objectIDs pushback 19001;
	_this setPosWorld [9784.1,5208.37,5.21428];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item19002 = objNull;
if (_layer16010) then {
	_item19002 = createVehicle ["Land_BagFence_Short_F",[9767.37,5215.67,0],[],0,"CAN_COLLIDE"];
	_this = _item19002;
	_objects pushback _this;
	_objectIDs pushback 19002;
	_this setPosWorld [9767.37,5215.67,5.21428];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item19003 = objNull;
if (_layer16010) then {
	_item19003 = createVehicle ["Land_BagFence_Short_F",[9776.31,5215.67,0],[],0,"CAN_COLLIDE"];
	_this = _item19003;
	_objects pushback _this;
	_objectIDs pushback 19003;
	_this setPosWorld [9776.31,5215.67,5.21428];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item19004 = objNull;
if (_layer16010) then {
	_item19004 = createVehicle ["Land_BagFence_Short_F",[9779.5,5215.73,0],[],0,"CAN_COLLIDE"];
	_this = _item19004;
	_objects pushback _this;
	_objectIDs pushback 19004;
	_this setPosWorld [9779.5,5215.73,5.21428];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item19005 = objNull;
if (_layer16010) then {
	_item19005 = createVehicle ["Land_BagFence_Short_F",[9770.07,5204.31,7.49951],[],0,"CAN_COLLIDE"];
	_this = _item19005;
	_objects pushback _this;
	_objectIDs pushback 19005;
	_this setPosWorld [9770.07,5204.31,12.7138];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item19006 = objNull;
if (_layer16010) then {
	_item19006 = createVehicle ["Land_BagFence_Short_F",[9784.18,5216.24,3.82122],[],0,"CAN_COLLIDE"];
	_this = _item19006;
	_objects pushback _this;
	_objectIDs pushback 19006;
	_this setPosWorld [9784.18,5216.24,9.0355];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item19007 = objNull;
if (_layer16010) then {
	_item19007 = createVehicle ["Land_BagFence_Short_F",[9782.15,5218.08,0],[],0,"CAN_COLLIDE"];
	_this = _item19007;
	_objects pushback _this;
	_objectIDs pushback 19007;
	_this setPosWorld [9782.15,5218.08,5.21428];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18898 = objNull;
if (_layer16010) then {
	_item18898 = createSimpleObject ["Land_ShelvesWooden_blue_F",[9755.21,5209.54,8.65177]];
	_this = _item18898;
	_objects pushback _this;
	_objectIDs pushback 18898;
	_this setPosWorld [9755.21,5209.54,9.15356];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18848 = objNull;
if (_layer16010) then {
	_item18848 = createVehicle ["Land_Shoot_House_Wall_F",[9811.42,5160.35,-5.24521e-006],[],0,"CAN_COLLIDE"];
	_this = _item18848;
	_objects pushback _this;
	_objectIDs pushback 18848;
	_this setPosWorld [9811.42,5160.35,6.47549];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
...
if (_layer16010) then {
	_item18849 = createVehicle ["Land_Shoot_House_Wall_F",[9813.77,5157.23,-5.24521e-006],[],0,"CAN_COLLIDE"];
	_this = _item18849;
	_objects pushback _this;
	_objectIDs pushback 18849;
	_this setPosWorld [9813.77,5157.23,6.47549];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setObjectTextureGlobal [0, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [1, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [2, "#(argb,8,8,3)color(0,0,0,0,ca)"];
...
if (_layer16010) then {
	_item18850 = createVehicle ["Land_Shoot_House_Wall_F",[9821.05,5157.23,-5.24521e-006],[],0,"CAN_COLLIDE"];
	_this = _item18850;
	_objects pushback _this;
	_objectIDs pushback 18850;
	_this setPosWorld [9821.05,5157.23,6.47549];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setObjectTextureGlobal [0, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [1, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [2, "#(argb,8,8,3)color(0,0,0,0,ca)"];
...
if (_layer16010) then {
	_item18851 = createVehicle ["Land_Shoot_House_Wall_F",[9811.42,5163.97,5],[],0,"CAN_COLLIDE"];
	_this = _item18851;
	_objects pushback _this;
	_objectIDs pushback 18851;
	_this setPosWorld [9811.42,5163.97,11.4755];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
	_this setObjectTextureGlobal [0, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [1, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [2, "#(argb,8,8,3)color(0,0,0,0,ca)"];
...
if (_layer16010) then {
	_item18852 = createVehicle ["Land_Shoot_House_Wall_F",[9817.41,5157.23,4.5],[],0,"CAN_COLLIDE"];
	_this = _item18852;
	_objects pushback _this;
	_objectIDs pushback 18852;
	_this setPosWorld [9817.41,5157.23,10.9755];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setObjectTextureGlobal [0, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [1, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [2, "#(argb,8,8,3)color(0,0,0,0,ca)"];
...
if (_layer16010) then {
	_item18853 = createVehicle ["Land_Shoot_House_Wall_F",[9835.25,5170.78,-5.24521e-006],[],0,"CAN_COLLIDE"];
	_this = _item18853;
	_objects pushback _this;
	_objectIDs pushback 18853;
	_this setPosWorld [9835.25,5170.78,6.47549];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
	_this setObjectTextureGlobal [0, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [1, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [2, "#(argb,8,8,3)color(0,0,0,0,ca)"];
...
if (_layer16010) then {
	_item18904 = createSimpleObject ["Land_Stretcher_01_olive_F",[9756.4,5211.68,8.66605]];
	_this = _item18904;
	_objects pushback _this;
	_objectIDs pushback 18904;
	_this setPosWorld [9756.4,5211.68,8.90767];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
};

private _item18976 = objNull;
if (_layer16010) then {
	_item18976 = createSimpleObject ["Land_Stretcher_01_olive_F",[9782.52,5212.36,8.65947]];
	_this = _item18976;
	_objects pushback _this;
	_objectIDs pushback 18976;
	_this setPosWorld [9782.52,5212.36,8.90109];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
};

private _item18977 = objNull;
if (_layer16010) then {
	_item18977 = createSimpleObject ["Land_Stretcher_01_olive_F",[9781.74,5211.42,5.3312]];
	_this = _item18977;
	_objects pushback _this;
	_objectIDs pushback 18977;
	_this setPosWorld [9781.74,5211.42,5.57282];
	_this setVectorDirAndUp [[1,-4.37114e-008,0],[0,0,1]];
};

private _item18978 = objNull;
if (_layer16010) then {
	_item18978 = createSimpleObject ["Land_Stretcher_01_olive_F",[9760.13,5208.27,5.36481]];
	_this = _item18978;
	_objects pushback _this;
	_objectIDs pushback 18978;
	_this setPosWorld [9760.13,5208.27,5.60643];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item18979 = objNull;
if (_layer16010) then {
	_item18979 = createSimpleObject ["Land_Stretcher_01_olive_F",[9772.2,5211.61,5.36481]];
	_this = _item18979;
	_objects pushback _this;
	_objectIDs pushback 18979;
	_this setPosWorld [9772.2,5211.61,5.60643];
	_this setVectorDirAndUp [[-1,1.19249e-008,0],[0,0,1]];
};

private _item18980 = objNull;
if (_layer16010) then {
	_item18980 = createSimpleObject ["Land_Stretcher_01_olive_F",[9777.59,5206.81,8.664]];
	_this = _item18980;
	_objects pushback _this;
	_objectIDs pushback 18980;
	_this setPosWorld [9777.59,5206.81,8.90562];
	_this setVectorDirAndUp [[-5.6426e-007,-1,0],[0,0,1]];
};

private _item18972 = objNull;
if (_layer16010) then {
	_item18972 = createSimpleObject ["Land_Stretcher_01_folded_olive_F",[9779.48,5208.25,8.664]];
	_this = _item18972;
	_objects pushback _this;
	_objectIDs pushback 18972;
	_this setPosWorld [9779.48,5208.25,8.73189];
	_this setVectorDirAndUp [[-0.956305,-0.292371,0],[0,0,1]];
};

private _item18973 = objNull;
if (_layer16010) then {
	_item18973 = createSimpleObject ["Land_Stretcher_01_folded_olive_F",[9782.23,5212.54,5.3312]];
	_this = _item18973;
	_objects pushback _this;
	_objectIDs pushback 18973;
	_this setPosWorld [9782.23,5212.54,5.39909];
	_this setVectorDirAndUp [[0.292372,-0.956305,0],[0,0,1]];
};

private _item18974 = objNull;
if (_layer16010) then {
	_item18974 = createSimpleObject ["Land_Stretcher_01_folded_olive_F",[9775.14,5207.87,8.65954]];
	_this = _item18974;
	_objects pushback _this;
	_objectIDs pushback 18974;
	_this setPosWorld [9775.14,5207.87,8.72743];
	_this setVectorDirAndUp [[-0.121869,0.992546,0],[0,0,1]];
};

private _item18975 = objNull;
if (_layer16010) then {
	_item18975 = createSimpleObject ["Land_Stretcher_01_folded_olive_F",[9760.57,5212.42,8.65679]];
	_this = _item18975;
	_objects pushback _this;
	_objectIDs pushback 18975;
	_this setPosWorld [9760.57,5212.42,8.72468];
	_this setVectorDirAndUp [[0.798635,0.601815,0],[0,0,1]];
};
...
if (_layer17402) then {
	...
	_this setPosWorld [5052.3,6455.59,6.19761];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5052.91,6452.96,7.76436];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5053.01,6453.7,7.88901];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5051.36,5973.25,6.54386];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5051.6,5970.09,6.7357];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5052.47,5970.03,6.77744];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [4911.2,5718.5,3.02733];
	_this setVectorDirAndUp [[0.239063,-0.970084,-0.0422559],[-0.0179963,-0.0479368,0.998688]];
...
if (_layer17402) then {
	...
	_this setPosWorld [4910.62,5718.52,3.14938];
	_this setVectorDirAndUp [[0.239063,-0.970084,-0.0422559],[-0.0179963,-0.0479368,0.998688]];
...
if (_layer17402) then {
	...
	_this setPosWorld [4910.79,5719.98,3.26997];
	_this setVectorDirAndUp [[0.239063,-0.970084,-0.0422559],[-0.0179963,-0.0479368,0.998688]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5153.1,5503.3,4.15799];
...
if (_layer17402) then {
	...
	_this setPosWorld [5146.89,5516.61,3.62156];
...
if (_layer17402) then {
	...
	_this setPosWorld [5146.32,5517.73,4.5508];
	_this setVectorDirAndUp [[0.399822,-0.915954,0.0342142],[-0.0259916,0.0259828,0.999324]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5091.45,4814.06,2.41255];
...
if (_layer17402) then {
	...
	_this setPosWorld [5139.3,4730.86,3.2008];
...
if (_layer17402) then {
	...
	_this setPosWorld [5078.91,4849.27,2.41829];
	_this setVectorDirAndUp [[0,0.999982,0.00599983],[-0.00399675,-0.00599978,0.999974]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5072.11,4785.31,3.66609];
	_this setVectorDirAndUp [[0.900464,0.43493,0],[0,0,1]];
	_this setname "Dalibor Janda";;
	_this setface "LivonianHead_6";;
	_this setspeaker "rhs_male02cz";;
...
if (_layer17402) then {
	...
	_this setPosWorld [5072.21,4784.74,3.79773];
	_this setVectorDirAndUp [[0.900464,0.43493,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5070.73,4784.6,3.84491];
	_this setVectorDirAndUp [[0.900464,0.43493,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5155.24,4773.15,4.63058];
...
if (_layer17402) then {
	...
	_this setPosWorld [5154.12,4775.91,4.33197];
	_this setVectorDirAndUp [[0.276907,-0.960827,0.0115563],[-0.0139947,0.00799266,0.99987]];
...
if (_layer17402) then {
	...
	_this setPosWorld [4972.84,4762.98,3.14155];
	_this setVectorDirAndUp [[0.839924,0.542705,0],[0,0,1]];
	_this setname "Libor Back";;
	_this setface "WhiteHead_21";;
	_this setspeaker "rhs_male01cz";;
...
if (_layer17402) then {
	...
	_this setPosWorld [4971.61,4762.12,3.59492];
	_this setVectorDirAndUp [[0.839924,0.542705,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [4966.87,4766.41,4.36984];
...
if (_layer17402) then {
	...
	_this setPosWorld [4964.57,4764.52,4.10899];
	_this setVectorDirAndUp [[0.836366,0.548172,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5078.49,6644.5,6.59802];
	_this setVectorDirAndUp [[-0.973563,0.228419,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5089.93,6581.09,6.49878];
	_this setVectorDirAndUp [[-0.361787,0.932261,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5125.26,6352.42,6.38368];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Roman Stejskal";;
	_this setface "WhiteHead_21";;
	_this setspeaker "rhs_male02cz";;
...
if (_layer17402) then {
	...
	_this setPosWorld [5126.44,6352.43,6.3874];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5125.65,6351.49,6.65558];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5125.85,6346.79,6.13332];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5126.09,6351.17,6.51017];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5290.66,4107.81,4.39902];
...
if (_layer17402) then {
	...
	_this setPosWorld [5287.83,4106.89,4.17202];
	_this setVectorDirAndUp [[0.978739,0.204815,-0.0110117],[0.00999464,0.00599977,0.999932]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5053.53,6094.04,6.37385];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [5051.29,6613.78,6.37385];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17402) then {
	...
	_this setPosWorld [4589.01,6550.65,13.8983];
...
if (_layer17402) then {
	_item19048 = createVehicle ["Land_Laptop_03_olive_F",[4989.42,4732.49,18.041],[],0,"CAN_COLLIDE"];
	_this = _item19048;
	_objects pushback _this;
	_objectIDs pushback 19048;
	_this setPosWorld [4989.42,4732.49,20.914];
	_this setVectorDirAndUp [[-0.999695,-0.0246767,0],[0,0,1]];
	_this setObjectTextureGlobal [1,""];
};
...
if (_layer17433) then {
	...
	_this setPosWorld [8885.53,793.198,16.8469];
...
if (_layer17433) then {
	...
	_this setPosWorld [8888.01,793.605,18.1181];
	_this setVectorDirAndUp [[-0.996358,0.0852631,0],[0,0,1]];
	_this setname "Erik Nosek";;
	_this setface "WhiteHead_20";;
	_this setspeaker "rhs_male02cz";;
...
if (_layer17433) then {
	...
	_this setPosWorld [8888.14,792.779,18.5068];
	_this setVectorDirAndUp [[-0.996358,0.0852631,0],[0,0,1]];
...
if (_layer17433) then {
	...
	_this setPosWorld [9429.17,452.146,19.968];
	_this setVectorDirAndUp [[-0.503,-0.864286,0],[0,0,1]];
...
if (_layer17433) then {
	...
	_this setPosWorld [9428.76,452.563,20.0997];
	_this setVectorDirAndUp [[-0.503,-0.864286,0],[0,0,1]];
...
if (_layer17433) then {
	...
	_this setPosWorld [9429.91,453.502,20.1469];
	_this setVectorDirAndUp [[-0.503,-0.864286,0],[0,0,1]];
	_this setname "Oskar Klaus";;
	_this setface "WhiteHead_04";;
	_this setspeaker "rhs_male02cz";;
...
if (_layer17433) then {
	_item18402 = _item18401 createUnit ["I_L_Criminal_SG_F",[9381.8,480.517,-3.8147e-006],[],0,"CAN_COLLIDE"];
	_item18401 selectLeader _item18402;
	_this = _item18402;
	_objects pushback _this;
	_objectIDs pushback 18402;
	_this setPosWorld [9381.8,480.567,18.7534];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17433) then {
	...
	_this setPosWorld [9355.03,405.322,36.5058];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Boris Koudelka";;
	_this setface "WhiteHead_16";;
	_this setspeaker "rhs_male03cz";;
...
if (_layer17433) then {
	...
	_this setPosWorld [9547.91,504.925,36.5058];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17433) then {
	...
	_this setPosWorld [9465.17,661.561,36.5058];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layer17433) then {
	...
	_this setPosWorld [9265.92,571.257,36.6034];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
private _item18751 = objNull;
if (_layer18796 && _layer17433) then {
	_item18751 = createSimpleObject ["AntidoteKit_01_F",[9368.38,586.218,24.1702]];
	_this = _item18751;
	_objects pushback _this;
	_objectIDs pushback 18751;
	_this setPosWorld [9368.38,586.218,24.1796];
	_this setVectorDirAndUp [[-0.628023,0.778195,0],[0,0,1]];
};

private _item18769 = objNull;
if (_layer18796 && _layer17433) then {
	_item18769 = createSimpleObject ["Land_Basket_F",[9374.97,588.318,23.3769]];
	_this = _item18769;
	_objects pushback _this;
	_objectIDs pushback 18769;
	_this setPosWorld [9374.97,588.318,23.7214];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
};

private _item18772 = objNull;
if (_layer18796 && _layer17433) then {
	_item18772 = createSimpleObject ["Land_Bucket_painted_F",[9376.28,591.224,23.5019]];
	_this = _item18772;
	_objects pushback _this;
	_objectIDs pushback 18772;
	_this setPosWorld [9376.28,591.224,23.6403];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
};

private _item18744 = objNull;
if (_layer18796 && _layer17433) then {
	_item18744 = createSimpleObject ["Land_CampingChair_V2_F",[9366.51,594.14,19.7621]];
	_this = _item18744;
	_objects pushback _this;
	_objectIDs pushback 18744;
	_this setPosWorld [9366.51,594.14,20.2686];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18747 = objNull;
if (_layer18796 && _layer17433) then {
	_item18747 = createSimpleObject ["Land_CampingChair_V2_F",[9374.75,584.803,19.7621]];
	_this = _item18747;
	_objects pushback _this;
	_objectIDs pushback 18747;
	_this setPosWorld [9374.75,584.803,20.2686];
	_this setVectorDirAndUp [[0.106188,0.994346,0],[0,0,1]];
};

private _item18745 = objNull;
if (_layer18796 && _layer17433) then {
	_item18745 = createSimpleObject ["Land_CampingChair_V2_white_F",[9368.4,585.545,23.3546]];
	_this = _item18745;
	_objects pushback _this;
	_objectIDs pushback 18745;
	_this setPosWorld [9368.4,585.545,23.8611];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18746 = objNull;
if (_layer18796 && _layer17433) then {
	_item18746 = createSimpleObject ["Land_CampingChair_V2_white_F",[9367.38,585.352,19.7621]];
	_this = _item18746;
	_objects pushback _this;
	_objectIDs pushback 18746;
	_this setPosWorld [9367.38,585.352,20.2686];
	_this setVectorDirAndUp [[0.154787,-0.987948,0],[0,0,1]];
};

private _item18749 = objNull;
if (_layer18796 && _layer17433) then {
	_item18749 = createSimpleObject ["Land_CampingTable_F",[9367.05,593.835,19.7621]];
	_this = _item18749;
	_objects pushback _this;
	_objectIDs pushback 18749;
	_this setPosWorld [9367.05,593.835,20.1736];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18780 = objNull;
if (_layer18796 && _layer17433) then {
	_item18780 = createSimpleObject ["Land_CampingTable_F",[9374.38,584.093,19.7621]];
	_this = _item18780;
	_objects pushback _this;
	_objectIDs pushback 18780;
	_this setPosWorld [9374.38,584.093,20.1736];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
};

private _item18761 = objNull;
if (_layer18796 && _layer17433) then {
	_item18761 = createSimpleObject ["Land_CampingTable_small_white_F",[9367.19,585.826,19.7621]];
	_this = _item18761;
	_objects pushback _this;
	_objectIDs pushback 18761;
	_this setPosWorld [9367.19,585.826,20.1673];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18748 = objNull;
if (_layer18796 && _layer17433) then {
	_item18748 = createSimpleObject ["Land_CampingTable_white_F",[9367.74,585.8,23.3546]];
	_this = _item18748;
	_objects pushback _this;
	_objectIDs pushback 18748;
	_this setPosWorld [9367.74,585.8,23.7662];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18718 = objNull;
if (_layer18796 && _layer17433) then {
	_item18718 = createSimpleObject ["Land_PaperBox_01_small_destroyed_white_IDAP_F",[9367.21,585.609,23.3546]];
	_this = _item18718;
	_objects pushback _this;
	_objectIDs pushback 18718;
	_this setPosWorld [9367.21,585.609,23.5749];
	_this setVectorDirAndUp [[0.808035,-0.589134,0],[0,0,1]];
};

private _item18694 = objNull;
if (_layer18796 && _layer17433) then {
	_item18694 = createSimpleObject ["Land_ChairWood_F",[9375.14,592.423,19.7621]];
	_this = _item18694;
	_objects pushback _this;
	_objectIDs pushback 18694;
	_this setPosWorld [9375.14,592.423,19.7614];
	_this setVectorDirAndUp [[0.628023,-0.778195,0],[0,0,1]];
};

private _item18695 = objNull;
if (_layer18796 && _layer17433) then {
	_item18695 = createSimpleObject ["Land_ChairWood_F",[9365.6,589.85,23.3546]];
	_this = _item18695;
	_objects pushback _this;
	_objectIDs pushback 18695;
	_this setPosWorld [9365.6,589.85,23.354];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
};

private _item18750 = objNull;
if (_layer18796 && _layer17433) then {
	_item18750 = createSimpleObject ["DeconKit_01_F",[9368.18,585.952,24.1702]];
	_this = _item18750;
	_objects pushback _this;
	_objectIDs pushback 18750;
	_this setPosWorld [9368.18,585.952,24.1907];
	_this setVectorDirAndUp [[-0.808035,0.589134,0],[0,0,1]];
};

private _item18710 = objNull;
if (_layer18796 && _layer17433) then {
	_item18710 = createSimpleObject ["Land_TableDesk_F",[9374.9,592.799,19.7621]];
	_this = _item18710;
	_objects pushback _this;
	_objectIDs pushback 18710;
	_this setPosWorld [9374.9,592.799,20.1692];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18719 = objNull;
if (_layer18796 && _layer17433) then {
	_item18719 = createSimpleObject ["Land_FoodContainer_01_White_F",[9368.89,586.307,23.3546]];
	_this = _item18719;
	_objects pushback _this;
	_objectIDs pushback 18719;
	_this setPosWorld [9368.89,586.307,23.5824];
	_this setVectorDirAndUp [[0.106188,0.994346,0],[0,0,1]];
};

private _item18724 = objNull;
if (_layer18796 && _layer17433) then {
	_item18724 = createSimpleObject ["Land_FoodSacks_01_small_brown_F",[9371.46,593.462,19.7621]];
	_this = _item18724;
	_objects pushback _this;
	_objectIDs pushback 18724;
	_this setPosWorld [9371.46,593.462,19.9786];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
	[_this, 2] call ace_cargo_fnc_setSize;
};
...
if (_layer18796 && _layer17433) then {
	_item18734 = createVehicle ["Land_Garbage_square3_F",[9365.26,592.631,1.01016],[],0,"CAN_COLLIDE"];
	_this = _item18734;
	_objects pushback _this;
	_objectIDs pushback 18734;
	_this setPosWorld [9365.26,592.631,19.814];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18735 = objNull;
if (_layer18796 && _layer17433) then {
	_item18735 = createVehicle ["Land_Garbage_square3_F",[9365.4,592.009,4.60267],[],0,"CAN_COLLIDE"];
	_this = _item18735;
	_objects pushback _this;
	_objectIDs pushback 18735;
	_this setPosWorld [9365.4,592.009,23.4065];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18736 = objNull;
if (_layer18796 && _layer17433) then {
	_item18736 = createVehicle ["Land_Garbage_square3_F",[9373.43,594.882,1.01015],[],0,"CAN_COLLIDE"];
	_this = _item18736;
	_objects pushback _this;
	_objectIDs pushback 18736;
	_this setPosWorld [9373.43,594.882,19.814];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
};

private _item18737 = objNull;
if (_layer18796 && _layer17433) then {
	_item18737 = createVehicle ["Land_Garbage_square3_F",[9375.78,590.183,1.01015],[],0,"CAN_COLLIDE"];
	_this = _item18737;
	_objects pushback _this;
	_objectIDs pushback 18737;
	_this setPosWorld [9375.78,590.183,19.814];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
};

private _item18738 = objNull;
if (_layer18796 && _layer17433) then {
	_item18738 = createVehicle ["Land_Garbage_square3_F",[9369.4,582.981,4.60267],[],0,"CAN_COLLIDE"];
	_this = _item18738;
	_objects pushback _this;
	_objectIDs pushback 18738;
	_this setPosWorld [9369.4,582.981,23.4065];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18739 = objNull;
if (_layer18796 && _layer17433) then {
	_item18739 = createVehicle ["Land_Garbage_square3_F",[9369.11,583.946,1.01015],[],0,"CAN_COLLIDE"];
	_this = _item18739;
	_objects pushback _this;
	_objectIDs pushback 18739;
	_this setPosWorld [9369.11,583.946,19.814];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18740 = objNull;
if (_layer18796 && _layer17433) then {
	_item18740 = createVehicle ["Land_Garbage_square3_F",[9370.38,583.551,1.01015],[],0,"CAN_COLLIDE"];
	_this = _item18740;
	_objects pushback _this;
	_objectIDs pushback 18740;
	_this setPosWorld [9370.38,583.551,19.814];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
};

private _item18741 = objNull;
if (_layer18796 && _layer17433) then {
	_item18741 = createVehicle ["Land_Garbage_square3_F",[9373.91,593.18,4.60267],[],0,"CAN_COLLIDE"];
	_this = _item18741;
	_objects pushback _this;
	_objectIDs pushback 18741;
	_this setPosWorld [9373.91,593.18,23.4065];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18742 = objNull;
if (_layer18796 && _layer17433) then {
	_item18742 = createVehicle ["Land_Garbage_square3_F",[9375,586.694,4.60267],[],0,"CAN_COLLIDE"];
	_this = _item18742;
	_objects pushback _this;
	_objectIDs pushback 18742;
	_this setPosWorld [9375,586.694,23.4065];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18762 = objNull;
if (_layer18796 && _layer17433) then {
	_item18762 = createSimpleObject ["HazmatBag_01_roll_F",[9367.19,585.826,24.1702]];
	_this = _item18762;
	_objects pushback _this;
	_objectIDs pushback 18762;
	_this setPosWorld [9367.19,585.826,24.3794];
	_this setVectorDirAndUp [[-0.359925,-0.932981,0],[0,0,1]];
};

private _item18763 = objNull;
if (_layer18796 && _layer17433) then {
	_item18763 = createSimpleObject ["HazmatBag_01_roll_F",[9367.01,585.61,24.1702]];
	_this = _item18763;
	_objects pushback _this;
	_objectIDs pushback 18763;
	_this setPosWorld [9367.01,585.61,24.3794];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18706 = objNull;
if (_layer18796 && _layer17433) then {
	_item18706 = createSimpleObject ["Land_OfficeCabinet_02_F",[9366.98,586.283,23.3546]];
	_this = _item18706;
	_objects pushback _this;
	_objectIDs pushback 18706;
	_this setPosWorld [9366.98,586.283,24.1351];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18707 = objNull;
if (_layer18796 && _layer17433) then {
	_item18707 = createSimpleObject ["Land_OfficeCabinet_02_F",[9372.04,584.425,19.7621]];
	_this = _item18707;
	_objects pushback _this;
	_objectIDs pushback 18707;
	_this setPosWorld [9372.04,584.425,20.5426];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18708 = objNull;
if (_layer18796 && _layer17433) then {
	_item18708 = createSimpleObject ["Land_OfficeCabinet_02_F",[9367.23,594.05,23.3546]];
	_this = _item18708;
	_objects pushback _this;
	_objectIDs pushback 18708;
	_this setPosWorld [9367.23,594.05,24.1351];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
};

private _item18709 = objNull;
if (_layer18796 && _layer17433) then {
	_item18709 = createSimpleObject ["Land_OfficeCabinet_02_F",[9373.42,592.419,19.7621]];
	_this = _item18709;
	_objects pushback _this;
	_objectIDs pushback 18709;
	_this setPosWorld [9373.42,592.419,20.5426];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
};

private _item18782 = objNull;
if (_layer18796 && _layer17433) then {
	_item18782 = createSimpleObject ["Land_OfficeCabinet_02_F",[9374.77,584.13,23.3546]];
	_this = _item18782;
	_objects pushback _this;
	_objectIDs pushback 18782;
	_this setPosWorld [9374.77,584.13,24.1351];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18753 = objNull;
if (_layer18796 && _layer17433) then {
	_item18753 = createSimpleObject ["Land_Pillow_F",[9365.5,591.346,23.3848]];
	_this = _item18753;
	_objects pushback _this;
	_objectIDs pushback 18753;
	_this setPosWorld [9365.5,591.346,23.4218];
	_this setVectorDirAndUp [[0.40515,-0.914217,-0.00774901],[0.00951544,-0.00425873,0.999946]];
};

private _item18758 = objNull;
if (_layer18796 && _layer17433) then {
	_item18758 = createSimpleObject ["Land_Pillow_F",[9370.28,584.215,19.7923]];
	_this = _item18758;
	_objects pushback _this;
	_objectIDs pushback 18758;
	_this setPosWorld [9370.28,584.215,19.8293];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
};

private _item18757 = objNull;
if (_layer18796 && _layer17433) then {
	_item18757 = createSimpleObject ["Land_Pillow_camouflage_F",[9374.09,594.985,19.7923]];
	_this = _item18757;
	_objects pushback _this;
	_objectIDs pushback 18757;
	_this setPosWorld [9374.09,594.985,19.8293];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
};

private _item18781 = objNull;
if (_layer18796 && _layer17433) then {
	_item18781 = createSimpleObject ["Land_Pillow_camouflage_F",[9369.51,582.318,23.3848]];
	_this = _item18781;
	_objects pushback _this;
	_objectIDs pushback 18781;
	_this setPosWorld [9369.51,582.318,23.4218];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18754 = objNull;
if (_layer18796 && _layer17433) then {
	_item18754 = createSimpleObject ["Land_Pillow_grey_F",[9368.96,583.058,19.7869]];
	_this = _item18754;
	_objects pushback _this;
	_objectIDs pushback 18754;
	_this setPosWorld [9368.96,583.058,19.8239];
	_this setVectorDirAndUp [[0.405171,-0.914184,-0.0101925],[0.00610187,-0.00844435,0.999946]];
};

private _item18755 = objNull;
if (_layer18796 && _layer17433) then {
	_item18755 = createSimpleObject ["Land_Pillow_grey_F",[9374.01,592.517,23.3848]];
	_this = _item18755;
	_objects pushback _this;
	_objectIDs pushback 18755;
	_this setPosWorld [9374.01,592.517,23.4218];
	_this setVectorDirAndUp [[0.40515,-0.914217,-0.00774901],[0.00951544,-0.00425873,0.999946]];
};

private _item18756 = objNull;
if (_layer18796 && _layer17433) then {
	_item18756 = createSimpleObject ["Land_Pillow_grey_F",[9365.37,591.968,19.7923]];
	_this = _item18756;
	_objects pushback _this;
	_objectIDs pushback 18756;
	_this setPosWorld [9365.37,591.968,19.8293];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18760 = objNull;
if (_layer18796 && _layer17433) then {
	_item18760 = createSimpleObject ["Land_Pillow_grey_F",[9374.34,586.591,23.3848]];
	_this = _item18760;
	_objects pushback _this;
	_objectIDs pushback 18760;
	_this setPosWorld [9374.34,586.591,23.4218];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18759 = objNull;
if (_layer18796 && _layer17433) then {
	_item18759 = createSimpleObject ["Land_Pillow_old_F",[9375.68,590.847,19.7923]];
	_this = _item18759;
	_objects pushback _this;
	_objectIDs pushback 18759;
	_this setPosWorld [9375.68,590.847,19.8232];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
};

private _item18777 = objNull;
if (_layer18796 && _layer17433) then {
	_item18777 = createSimpleObject ["Land_BottlePlastic_V1_F",[9378.68,586.411,24.2415]];
	_this = _item18777;
	_objects pushback _this;
	_objectIDs pushback 18777;
	_this setPosWorld [9378.68,586.411,24.3415];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18716 = objNull;
if (_layer18796 && _layer17433) then {
	_item18716 = createSimpleObject ["Land_PlasticCase_01_medium_gray_F",[9374.96,594.195,23.5519]];
	_this = _item18716;
	_objects pushback _this;
	_objectIDs pushback 18716;
	_this setPosWorld [9374.96,594.195,23.7461];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};

private _item18771 = objNull;
if (_layer18796 && _layer17433) then {
	_item18771 = createSimpleObject ["Land_PlasticCase_01_medium_olive_CBRN_F",[9374.11,590.261,23.5019]];
	_this = _item18771;
	_objects pushback _this;
	_objectIDs pushback 18771;
	_this setPosWorld [9374.11,590.261,23.6961];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};

private _item18770 = objNull;
if (_layer18796 && _layer17433) then {
	_item18770 = createSimpleObject ["Land_PlasticCase_01_small_F",[9376.39,591.274,24.3146]];
	_this = _item18770;
	_objects pushback _this;
	_objectIDs pushback 18770;
	_this setPosWorld [9376.39,591.274,24.4713];
	_this setVectorDirAndUp [[-0.808035,0.589134,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};

private _item18697 = objNull;
if (_layer18796 && _layer17433) then {
	_item18697 = createSimpleObject ["Land_PlasticCase_01_small_black_F",[9374.24,595.515,24.3146]];
	_this = _item18697;
	_objects pushback _this;
	_objectIDs pushback 18697;
	_this setPosWorld [9374.24,595.515,24.4713];
	_this setVectorDirAndUp [[0.359925,0.932981,0],[0,0,1]];
	[_this, 1] call ace_cargo_fnc_setSize;
};

private _item18743 = objNull;
if (_layer18796 && _layer17433) then {
	_item18743 = createSimpleObject ["Land_BatteryPack_01_battery_black_F",[9378.09,586.83,24.2508]];
	_this = _item18743;
	_objects pushback _this;
	_objectIDs pushback 18743;
	_this setPosWorld [9378.09,586.83,24.3118];
	_this setVectorDirAndUp [[0.154787,-0.987948,0],[0,0,1]];
};

private _item18714 = objNull;
if (_layer18796 && _layer17433) then {
	_item18714 = createSimpleObject ["Land_DeskChair_01_black_F",[9377.72,587.351,23.3546]];
	_this = _item18714;
	_objects pushback _this;
	_objectIDs pushback 18714;
	_this setPosWorld [9377.72,587.351,23.5754];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18775 = objNull;
if (_layer18796 && _layer17433) then {
	_item18775 = createSimpleObject ["Land_DeskChair_01_black_F",[9378.33,585.98,23.3546]];
	_this = _item18775;
	_objects pushback _this;
	_objectIDs pushback 18775;
	_this setPosWorld [9378.33,585.98,23.5754];
	_this setVectorDirAndUp [[-0.589134,-0.808035,0],[0,0,1]];
};

private _item18778 = objNull;
if (_layer18796 && _layer17433) then {
	_item18778 = createVehicle ["Land_Laptop_03_olive_F",[9378.19,586.316,5.556],[],0,"CAN_COLLIDE"];
	_this = _item18778;
	_objects pushback _this;
	_objectIDs pushback 18778;
	_this setPosWorld [9378.19,586.316,24.4754];
	_this setVectorDirAndUp [[0.987949,0.154779,0],[0,0,1]];
	_this setObjectTextureGlobal [1,""];
};

private _item18700 = objNull;
if (_layer18796 && _layer17433) then {
	_item18700 = createSimpleObject ["Land_PortableCabinet_01_4drawers_black_F",[9378.22,587.16,24.2416]];
	_this = _item18700;
	_objects pushback _this;
	_objectIDs pushback 18700;
	_this setPosWorld [9378.22,587.16,24.6596];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
...
private _item18698 = objNull;
if (_layer18796 && _layer17433) then {
	_item18698 = createSimpleObject ["Land_PortableCabinet_01_7drawers_black_F",[9378.42,586.703,24.2508]];
	_this = _item18698;
	_objects pushback _this;
	_objectIDs pushback 18698;
	_this setPosWorld [9378.42,586.703,24.6687];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
	_this animate ['Drawer_2_move_source',0,true];
	_this animate ['Drawer_3_move_source',0,true];
	_this animate ['Drawer_4_move_source',0,true];
...
private _item18699 = objNull;
if (_layer18796 && _layer17433) then {
	_item18699 = createSimpleObject ["Land_PortableCabinet_01_7drawers_black_F",[9378.01,587.617,24.2415]];
	_this = _item18699;
	_objects pushback _this;
	_objectIDs pushback 18699;
	_this setPosWorld [9378.01,587.617,24.6595];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
	_this animate ['Drawer_2_move_source',0,true];
	_this animate ['Drawer_3_move_source',0,true];
	_this animate ['Drawer_4_move_source',0,true];
...
if (_layer18796 && _layer17433) then {
	_item18717 = createSimpleObject ["Land_PortableCabinet_01_closed_olive_F",[9376.9,590.131,23.5019]];
	_this = _item18717;
	_objects pushback _this;
	_objectIDs pushback 18717;
	_this setPosWorld [9376.9,590.131,23.6655];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18713 = objNull;
if (_layer18796 && _layer17433) then {
	_item18713 = createSimpleObject ["Land_PortableDesk_01_black_F",[9378.25,586.767,23.3546]];
	_this = _item18713;
	_objects pushback _this;
	_objectIDs pushback 18713;
	_this setPosWorld [9378.25,586.767,23.7985];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
...
if (_layer18796 && _layer17433) then {
	_item18715 = createVehicle ["Land_Sacks_heap_F",[9365.74,589.698,1.01015],[],0,"CAN_COLLIDE"];
	_this = _item18715;
	_objects pushback _this;
	_objectIDs pushback 18715;
	_this setPosWorld [9365.74,589.698,20.1529];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
};

private _item18703 = objNull;
if (_layer18796 && _layer17433) then {
	_item18703 = createVehicle ["Land_BagFence_01_corner_green_F",[9363.23,593.509,8.544],[],0,"CAN_COLLIDE"];
	_this = _item18703;
	_objects pushback _this;
	_objectIDs pushback 18703;
	_this setPosWorld [9363.23,593.509,27.717];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18773 = objNull;
if (_layer18796 && _layer17433) then {
	_item18773 = createVehicle ["Land_BagFence_01_corner_green_F",[9368.82,581.217,8.543],[],0,"CAN_COLLIDE"];
	_this = _item18773;
	_objects pushback _this;
	_objectIDs pushback 18773;
	_this setPosWorld [9368.82,581.217,27.716];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18701 = objNull;
if (_layer18796 && _layer17433) then {
	_item18701 = createVehicle ["Land_BagFence_01_end_green_F",[9377.67,589.927,9.37499],[],0,"CAN_COLLIDE"];
	_this = _item18701;
	_objects pushback _this;
	_objectIDs pushback 18701;
	_this setPosWorld [9377.67,589.927,28.5366];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18702 = objNull;
if (_layer18796 && _layer17433) then {
	_item18702 = createVehicle ["Land_BagFence_01_end_green_F",[9366.28,595.27,8.56266],[],0,"CAN_COLLIDE"];
	_this = _item18702;
	_objects pushback _this;
	_objectIDs pushback 18702;
	_this setPosWorld [9366.28,595.27,27.7243];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
};

private _item18725 = objNull;
if (_layer18796 && _layer17433) then {
	_item18725 = createVehicle ["Land_BagFence_01_long_green_F",[9374.43,597.241,8.56266],[],0,"CAN_COLLIDE"];
	_this = _item18725;
	_objects pushback _this;
	_objectIDs pushback 18725;
	_this setPosWorld [9374.43,597.241,27.7319];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18726 = objNull;
if (_layer18796 && _layer17433) then {
	_item18726 = createVehicle ["Land_BagFence_01_long_green_F",[9364.88,589.338,8.54392],[],0,"CAN_COLLIDE"];
	_this = _item18726;
	_objects pushback _this;
	_objectIDs pushback 18726;
...
if (_layer18796 && _layer17433) then {
	_item18727 = createVehicle ["Land_BagFence_01_long_green_F",[9363.76,591.852,8.54392],[],0,"CAN_COLLIDE"];
	_this = _item18727;
	_objects pushback _this;
...
if (_layer18796 && _layer17433) then {
	_item18728 = createVehicle ["Land_BagFence_01_long_green_F",[9378.84,587.299,8.56266],[],0,"CAN_COLLIDE"];
	_this = _item18728;
	_objects pushback _this;
...
if (_layer18796 && _layer17433) then {
	_item18729 = createVehicle ["Land_BagFence_01_long_green_F",[9377.72,589.813,8.56266],[],0,"CAN_COLLIDE"];
	_this = _item18729;
	_objects pushback _this;
...
if (_layer18796 && _layer17433) then {
	_item18730 = createVehicle ["Land_BagFence_01_long_green_F",[9367.72,582.779,8.56266],[],0,"CAN_COLLIDE"];
	_this = _item18730;
	_objects pushback _this;
...
if (_layer18796 && _layer17433) then {
	_item18731 = createVehicle ["Land_BagFence_01_long_green_F",[9375.44,594.956,8.56266],[],0,"CAN_COLLIDE"];
	_this = _item18731;
	_objects pushback _this;
...
if (_layer18796 && _layer17433) then {
	_item18732 = createVehicle ["Land_BagFence_01_long_green_F",[9376.56,592.442,8.56266],[],0,"CAN_COLLIDE"];
	_this = _item18732;
	_objects pushback _this;
...
if (_layer18796 && _layer17433) then {
	_item18733 = createVehicle ["Land_BagFence_01_long_green_F",[9364.8,594.611,8.56266],[],0,"CAN_COLLIDE"];
	_this = _item18733;
	_objects pushback _this;
...
private _item18764 = objNull;
if (_layer18796 && _layer17433) then {
	_item18764 = createVehicle ["Land_BagFence_01_short_green_F",[9375.9,593.927,9.24999],[],0,"CAN_COLLIDE"];
	_this = _item18764;
	_objects pushback _this;
	_objectIDs pushback 18764;
	_this setPosWorld [9375.9,593.927,28.4147];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
};

private _item18765 = objNull;
if (_layer18796 && _layer17433) then {
	_item18765 = createVehicle ["Land_BagFence_01_short_green_F",[9378.13,588.899,9.36909],[],0,"CAN_COLLIDE"];
	_this = _item18765;
	_objects pushback _this;
	_objectIDs pushback 18765;
	_this setPosWorld [9378.13,588.899,28.5338];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
};

private _item18766 = objNull;
if (_layer18796 && _layer17433) then {
	_item18766 = createVehicle ["Land_BagFence_01_short_green_F",[9375.24,595.413,9.24999],[],0,"CAN_COLLIDE"];
	_this = _item18766;
	_objects pushback _this;
	_objectIDs pushback 18766;
	_this setPosWorld [9375.24,595.413,28.4147];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18774 = objNull;
if (_layer18796 && _layer17433) then {
	_item18774 = createVehicle ["Land_BagFence_01_short_green_F",[9370.18,581.546,8.56266],[],0,"CAN_COLLIDE"];
	_this = _item18774;
	_objects pushback _this;
	_objectIDs pushback 18774;
	_this setPosWorld [9370.18,581.546,27.7273];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
};

private _item18779 = objNull;
if (_layer18796 && _layer17433) then {
	_item18779 = createSimpleObject ["Land_ShelvesWooden_blue_F",[9368.68,581.839,19.7621]];
	_this = _item18779;
	_objects pushback _this;
	_objectIDs pushback 18779;
	_this setPosWorld [9368.68,581.839,20.2639];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18704 = objNull;
if (_layer18796 && _layer17433) then {
	_item18704 = createSimpleObject ["Land_ShelvesWooden_khaki_F",[9371.05,593.145,23.3546]];
	_this = _item18704;
	_objects pushback _this;
	_objectIDs pushback 18704;
	_this setPosWorld [9371.05,593.145,23.8564];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
};

private _item18705 = objNull;
if (_layer18796 && _layer17433) then {
	_item18705 = createSimpleObject ["Land_ShelvesWooden_khaki_F",[9365.28,594.141,23.3769]];
	_this = _item18705;
	_objects pushback _this;
	_objectIDs pushback 18705;
	_this setPosWorld [9365.28,594.141,23.8787];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18720 = objNull;
if (_layer18796 && _layer17433) then {
	_item18720 = createVehicle ["Land_Shoot_House_Panels_F",[9371.58,597.381,1.01015],[],0,"CAN_COLLIDE"];
	_this = _item18720;
	_objects pushback _this;
	_objectIDs pushback 18720;
	_this setPosWorld [9371.58,597.381,21.4376];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
	_this setObjectTextureGlobal [0, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [1, "#(argb,8,8,3)color(0,0,0,0,ca)"];
...
private _item18721 = objNull;
if (_layer18796 && _layer17433) then {
	_item18721 = createVehicle ["Land_Shoot_House_Panels_F",[9365.45,594.637,4.60267],[],0,"CAN_COLLIDE"];
	_this = _item18721;
	_objects pushback _this;
	_objectIDs pushback 18721;
	_this setPosWorld [9365.45,594.637,25.0301];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
	_this setObjectTextureGlobal [0, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [1, "#(argb,8,8,3)color(0,0,0,0,ca)"];
...
private _item18722 = objNull;
if (_layer18796 && _layer17433) then {
	_item18722 = createVehicle ["Land_Shoot_House_Panels_F",[9378.78,587.113,1.08099],[],0,"CAN_COLLIDE"];
	_this = _item18722;
	_objects pushback _this;
	_objectIDs pushback 18722;
	_this setPosWorld [9378.78,587.113,21.5084];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
	_this setObjectTextureGlobal [0, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [1, "#(argb,8,8,3)color(0,0,0,0,ca)"];
...
private _item18723 = objNull;
if (_layer18796 && _layer17433) then {
	_item18723 = createVehicle ["Land_Shoot_House_Panels_F",[9364.04,591.415,0.499994],[],0,"CAN_COLLIDE"];
	_this = _item18723;
	_objects pushback _this;
	_objectIDs pushback 18723;
	_this setPosWorld [9364.04,591.415,20.9274];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
	_this setObjectTextureGlobal [0, "#(argb,8,8,3)color(0,0,0,0,ca)"];
	_this setObjectTextureGlobal [1, "#(argb,8,8,3)color(0,0,0,0,ca)"];
...
private _item18686 = objNull;
if (_layer18796 && _layer17433) then {
	_item18686 = createVehicle ["Land_Sleeping_bag_F",[9364.78,591.87,4.60267],[],0,"CAN_COLLIDE"];
	_this = _item18686;
	_objects pushback _this;
	_objectIDs pushback 18686;
	_this setPosWorld [9364.78,591.87,23.3804];
	_this setVectorDirAndUp [[0.628023,-0.778195,0],[0,0,1]];
};

private _item18687 = objNull;
if (_layer18796 && _layer17433) then {
	_item18687 = createVehicle ["Land_Sleeping_bag_F",[9364.64,592.492,1.01016],[],0,"CAN_COLLIDE"];
	_this = _item18687;
	_objects pushback _this;
	_objectIDs pushback 18687;
	_this setPosWorld [9364.64,592.492,19.7879];
	_this setVectorDirAndUp [[0.628023,-0.778195,0],[0,0,1]];
};

private _item18688 = objNull;
if (_layer18796 && _layer17433) then {
	_item18688 = createVehicle ["Land_Sleeping_bag_F",[9368.78,582.842,4.60267],[],0,"CAN_COLLIDE"];
	_this = _item18688;
	_objects pushback _this;
	_objectIDs pushback 18688;
	_this setPosWorld [9368.78,582.842,23.3804];
	_this setVectorDirAndUp [[0.628023,-0.778195,0],[0,0,1]];
};

private _item18689 = objNull;
if (_layer18796 && _layer17433) then {
	_item18689 = createVehicle ["Land_Sleeping_bag_F",[9373.57,594.26,1.01015],[],0,"CAN_COLLIDE"];
	_this = _item18689;
	_objects pushback _this;
	_objectIDs pushback 18689;
	_this setPosWorld [9373.57,594.26,19.7879];
	_this setVectorDirAndUp [[0.778195,0.628023,0],[0,0,1]];
};

private _item18691 = objNull;
if (_layer18796 && _layer17433) then {
	_item18691 = createVehicle ["Land_Sleeping_bag_F",[9371,583.69,1.01015],[],0,"CAN_COLLIDE"];
	_this = _item18691;
	_objects pushback _this;
	_objectIDs pushback 18691;
	_this setPosWorld [9371,583.69,19.7879];
	_this setVectorDirAndUp [[-0.628023,0.778195,0],[0,0,1]];
};

private _item18685 = objNull;
if (_layer18796 && _layer17433) then {
	_item18685 = createVehicle ["Land_Sleeping_bag_blue_F",[9373.29,593.041,4.60267],[],0,"CAN_COLLIDE"];
	_this = _item18685;
	_objects pushback _this;
	_objectIDs pushback 18685;
	_this setPosWorld [9373.29,593.041,23.3804];
	_this setVectorDirAndUp [[0.628023,-0.778195,0],[0,0,1]];
};

private _item18690 = objNull;
if (_layer18796 && _layer17433) then {
	_item18690 = createVehicle ["Land_Sleeping_bag_brown_F",[9376.4,590.322,1.01015],[],0,"CAN_COLLIDE"];
	_this = _item18690;
	_objects pushback _this;
	_objectIDs pushback 18690;
	_this setPosWorld [9376.4,590.322,19.7879];
	_this setVectorDirAndUp [[-0.628023,0.778195,0],[0,0,1]];
};

private _item18692 = objNull;
if (_layer18796 && _layer17433) then {
	_item18692 = createVehicle ["Land_Sleeping_bag_brown_F",[9374.87,587.316,4.60267],[],0,"CAN_COLLIDE"];
	_this = _item18692;
	_objects pushback _this;
	_objectIDs pushback 18692;
	_this setPosWorld [9374.87,587.316,23.3804];
	_this setVectorDirAndUp [[-0.778195,-0.628022,0],[0,0,1]];
};

private _item18752 = objNull;
if (_layer18796 && _layer17433) then {
	_item18752 = createVehicle ["Land_Sleeping_bag_brown_F",[9368.49,583.807,1.01],[],0,"CAN_COLLIDE"];
	_this = _item18752;
	_objects pushback _this;
	_objectIDs pushback 18752;
	_this setPosWorld [9368.49,583.807,19.7878];
	_this setVectorDirAndUp [[0.154787,-0.987948,0],[0,0,1]];
};

private _item18693 = objNull;
if (_layer18796 && _layer17433) then {
	_item18693 = createSimpleObject ["Sponge_01_dry_F",[9367.56,585.526,24.1702]];
	_this = _item18693;
	_objects pushback _this;
	_objectIDs pushback 18693;
	_this setPosWorld [9367.56,585.526,24.1897];
	_this setVectorDirAndUp [[-0.154786,0.987948,0],[0,0,1]];
};

private _item18711 = objNull;
if (_layer18796 && _layer17433) then {
	_item18711 = createSimpleObject ["Land_Stretcher_01_olive_F",[9371.13,584.02,23.3546]];
	_this = _item18711;
	_objects pushback _this;
	_objectIDs pushback 18711;
	_this setPosWorld [9371.13,584.02,23.5962];
	_this setVectorDirAndUp [[0.405212,-0.914223,0],[0,0,1]];
};

private _item18776 = objNull;
if (_layer18796 && _layer17433) then {
	_item18776 = createSimpleObject ["Land_WaterBottle_01_empty_F",[9378.53,586.302,24.2415]];
	_this = _item18776;
	_objects pushback _this;
	_objectIDs pushback 18776;
	_this setPosWorld [9378.53,586.302,24.3724];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18712 = objNull;
if (_layer18796 && _layer17433) then {
	_item18712 = createSimpleObject ["Land_WoodenCounter_01_F",[9374.71,594.766,23.3546]];
	_this = _item18712;
	_objects pushback _this;
	_objectIDs pushback 18712;
	_this setPosWorld [9374.71,594.766,23.8305];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18767 = objNull;
if (_layer18796 && _layer17433) then {
	_item18767 = createSimpleObject ["Land_WoodenCounter_01_F",[9376.65,590.703,23.3546]];
	_this = _item18767;
	_objects pushback _this;
	_objectIDs pushback 18767;
	_this setPosWorld [9376.65,590.703,23.8305];
	_this setVectorDirAndUp [[-0.914223,-0.405211,0],[0,0,1]];
};

private _item18768 = objNull;
if (_layer18796 && _layer17433) then {
	_item18768 = createSimpleObject ["Land_WoodenCounter_01_F",[9374.36,589.69,23.3546]];
	_this = _item18768;
	_objects pushback _this;
	_objectIDs pushback 18768;
	_this setPosWorld [9374.36,589.69,23.8305];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
};

private _item18696 = objNull;
if (_layer18796 && _layer17433) then {
	_item18696 = createSimpleObject ["Land_WoodenTable_small_F",[9365.84,589.47,23.3546]];
	_this = _item18696;
	_objects pushback _this;
	_objectIDs pushback 18696;
	_this setPosWorld [9365.84,589.47,23.7869];
	_this setVectorDirAndUp [[0.914223,0.405212,0],[0,0,1]];
};

private _item18785 = objNull;
if (_layer17433) then {
	_item18785 = createVehicle ["UK3CB_GAF_O_DSHKM",[9477.7,676.015,5.23845],[],0,"CAN_COLLIDE"];
	_this = _item18785;
	_objects pushback _this;
	_objectIDs pushback 18785;
	_this setPosWorld [9477.7,676.015,25.6014];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	[_this, 2] call ace_cargo_fnc_setSize;
	_this setTurretLimits [ [0], -180, (_this getTurretLimits [0])#1, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
	_this setTurretLimits [ [0], (_this getTurretLimits [0])#0, 180, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
...
private _item18798 = objNull;
if (_layer17433) then {
	_item18798 = createVehicle ["UK3CB_GAF_O_DSHKM",[9258.11,576.654,5.13068],[],0,"CAN_COLLIDE"];
	_this = _item18798;
	_objects pushback _this;
	_objectIDs pushback 18798;
	_this setPosWorld [9258.11,576.654,25.4936];
	_this setVectorDirAndUp [[-0.926945,-0.375197,0],[0,0,1]];
	[_this, 2] call ace_cargo_fnc_setSize;
	_this setTurretLimits [ [0], -180, (_this getTurretLimits [0])#1, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
	_this setTurretLimits [ [0], (_this getTurretLimits [0])#0, 180, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
	_this setTurretLimits [ [0], (_this getTurretLimits [0])#0, (_this getTurretLimits [0])#1, -20, (_this getTurretLimits [0])#3 ];
...
private _item18801 = objNull;
if (_layer17433) then {
	_item18801 = createVehicle ["UK3CB_GAF_O_DSHKM",[9341.94,390.955,4.97927],[],0,"CAN_COLLIDE"];
	_this = _item18801;
	_objects pushback _this;
	_objectIDs pushback 18801;
	_this setPosWorld [9341.94,390.955,25.3422];
	_this setVectorDirAndUp [[0.361704,-0.932293,0],[0,0,1]];
	[_this, 2] call ace_cargo_fnc_setSize;
	_this setTurretLimits [ [0], -180, (_this getTurretLimits [0])#1, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
	_this setTurretLimits [ [0], (_this getTurretLimits [0])#0, 180, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
	_this setTurretLimits [ [0], (_this getTurretLimits [0])#0, (_this getTurretLimits [0])#1, -20, (_this getTurretLimits [0])#3 ];
...
private _item18804 = objNull;
if (_layer17433) then {
	_item18804 = createVehicle ["UK3CB_GAF_O_DSHKM",[9561.75,491.286,5.30852],[],0,"CAN_COLLIDE"];
	_this = _item18804;
	_objects pushback _this;
	_objectIDs pushback 18804;
	_this setPosWorld [9561.75,491.286,25.6715];
	_this setVectorDirAndUp [[0.880892,0.473317,0],[0,0,1]];
	[_this, 2] call ace_cargo_fnc_setSize;
	_this setTurretLimits [ [0], -180, (_this getTurretLimits [0])#1, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
	_this setTurretLimits [ [0], (_this getTurretLimits [0])#0, 180, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
	_this setTurretLimits [ [0], (_this getTurretLimits [0])#0, (_this getTurretLimits [0])#1, -20, (_this getTurretLimits [0])#3 ];
...
private _item18786 = objNull;
if (_layer17433) then {
	_item18786 = _item18784 createUnit ["UK3CB_GAF_O_RIF_1",[9477.17,676.386,6.84945],[],0,"CAN_COLLIDE"];
	_item18784 selectLeader _item18786;
	_this = _item18786;
	_objects pushback _this;
	_objectIDs pushback 18786;
	_this setPosWorld [9477.44,675.426,23.9374];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Cyril Adamec";;
	_this setface "WhiteHead_21";;
	_this setspeaker "RHS_Male02CZ";;
...
private _item18789 = objNull;
if (_layer17433) then {
	_item18789 = _item18787 createUnit ["UK3CB_GAF_O_RIF_1",[9349.27,638.911,-0.007267],[],0,"CAN_COLLIDE"];
	_item18787 selectLeader _item18789;
	_this = _item18789;
	_objects pushback _this;
	_objectIDs pushback 18789;
	_this setPosWorld [9349.26,638.172,18.7139];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
private _item18799 = objNull;
if (_layer17433) then {
	_item18799 = _item18797 createUnit ["UK3CB_GAF_O_RIF_1",[9257.9,576.48,6.74167],[],0,"CAN_COLLIDE"];
	_item18797 selectLeader _item18799;
	_this = _item18799;
	_objects pushback _this;
	_objectIDs pushback 18799;
	_this setPosWorld [9258.76,576.634,23.8296];
	_this setVectorDirAndUp [[-0.926945,-0.375197,0],[0,0,1]];
...
private _item18802 = objNull;
if (_layer17433) then {
	_item18802 = _item18800 createUnit ["UK3CB_GAF_O_RIF_1",[9342.36,390.895,6.59026],[],0,"CAN_COLLIDE"];
	_item18800 selectLeader _item18802;
	_this = _item18802;
	_objects pushback _this;
	_objectIDs pushback 18802;
	_this setPosWorld [9341.96,391.598,23.6783];
	_this setVectorDirAndUp [[0.361704,-0.932293,0],[0,0,1]];
	_this setname "Dan Malarkey";;
	_this setface "WhiteHead_17";;
	_this setspeaker "rhs_male05cz";;
	_this setpitch 1.00581;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
private _item18805 = objNull;
if (_layer17433) then {
	_item18805 = _item18803 createUnit ["UK3CB_GAF_O_RIF_1",[9562.58,491.666,6.91952],[],0,"CAN_COLLIDE"];
	_item18803 selectLeader _item18805;
	_this = _item18805;
	_objects pushback _this;
	_objectIDs pushback 18805;
	_this setPosWorld [9561.1,491.236,24.0075];
	_this setVectorDirAndUp [[0.880892,0.473317,0],[0,0,1]];
	_this setname "Denis Smetana";;
	_this setface "WhiteHead_12";;
	_this setspeaker "rhs_male02cz";;
	_this setpitch 1.02086;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
private _item18807 = objNull;
if (_layer17433) then {
	_item18807 = _item18806 createUnit ["UK3CB_GAF_O_RIF_1",[9357.68,622.004,0.122345],[],0,"CAN_COLLIDE"];
	_item18806 selectLeader _item18807;
	_this = _item18807;
	_objects pushback _this;
	_objectIDs pushback 18807;
	_this setPosWorld [9357.68,622.054,18.8757];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Ladislav Vrba";;
	_this setface "WhiteHead_20";;
	_this setspeaker "rhs_male05cz";;
	_this setpitch 0.953159;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
private _item18809 = objNull;
if (_layer17433) then {
	_item18809 = _item18808 createUnit ["UK3CB_GAF_O_RIF_1",[9359.07,617.674,0.122345],[],0,"CAN_COLLIDE"];
	_item18808 selectLeader _item18809;
	_this = _item18809;
	_objects pushback _this;
	_objectIDs pushback 18809;
	_this setPosWorld [9359.07,617.724,18.8757];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Felix Stejskal";;
	_this setface "WhiteHead_12";;
	_this setspeaker "rhs_male03cz";;
	_this setpitch 0.950079;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
private _item18811 = objNull;
if (_layer17433) then {
	_item18811 = _item18810 createUnit ["UK3CB_GAF_O_RIF_1",[9361.46,611.706,1.04894],[],0,"CAN_COLLIDE"];
	_item18810 selectLeader _item18811;
	_this = _item18811;
	_objects pushback _this;
	_objectIDs pushback 18811;
	_this setPosWorld [9361.46,611.756,19.8023];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Borek Back";;
	_this setface "WhiteHead_15";;
	_this setspeaker "rhs_male04cz";;
	_this setpitch 0.989555;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layer17433) then {
	_item18813 = _item18812 createUnit ["UK3CB_GAF_O_RIF_1",[9362.93,608.766,1.04967],[],0,"CAN_COLLIDE"];
	_item18812 selectLeader _item18813;
	_this = _item18813;
	_objects pushback _this;
	_objectIDs pushback 18813;
	_this setPosWorld [9362.93,608.816,19.8031];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Emil Kraus";;
	_this setface "WhiteHead_17";;
	_this setspeaker "rhs_male05cz";;
	_this setpitch 0.999052;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
private _item18815 = objNull;
if (_layer17433) then {
	_item18815 = _item18814 createUnit ["UK3CB_GAF_O_RIF_1",[9379.67,615.862,1.0491],[],0,"CAN_COLLIDE"];
	_item18814 selectLeader _item18815;
	_this = _item18815;
	_objects pushback _this;
	_objectIDs pushback 18815;
	_this setPosWorld [9379.67,615.912,19.8025];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Bohdan Urban";;
	_this setface "WhiteHead_15";;
	_this setspeaker "rhs_male01cz";;
	_this setpitch 1.01189;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
private _item18817 = objNull;
if (_layer17433) then {
	_item18817 = _item18816 createUnit ["UK3CB_GAF_O_RIF_1",[9379.13,618.944,1.04933],[],0,"CAN_COLLIDE"];
	_item18816 selectLeader _item18817;
	_this = _item18817;
	_objects pushback _this;
	_objectIDs pushback 18817;
	_this setPosWorld [9379.13,618.994,19.8027];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Standa Soukup";;
	_this setface "WhiteHead_11";;
	_this setspeaker "rhs_male01cz";;
	_this setpitch 1.02494;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
private _item18819 = objNull;
if (_layer17433) then {
	_item18819 = _item18818 createUnit ["UK3CB_GAF_O_RIF_1",[9373.3,630.627,0.122345],[],0,"CAN_COLLIDE"];
	_item18818 selectLeader _item18819;
	_this = _item18819;
	_objects pushback _this;
	_objectIDs pushback 18819;
	_this setPosWorld [9373.3,630.677,18.8757];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Libor Valenta";;
	_this setface "LivonianHead_6";;
	_this setspeaker "rhs_male03cz";;
	_this setpitch 0.992058;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
private _item18821 = objNull;
if (_layer17433) then {
	_item18821 = _item18820 createUnit ["UK3CB_GAF_O_RIF_1",[9374.79,628.072,0.122345],[],0,"CAN_COLLIDE"];
	_item18820 selectLeader _item18821;
	_this = _item18821;
	_objects pushback _this;
	_objectIDs pushback 18821;
	_this setPosWorld [9374.79,628.122,18.8757];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Denis Kouba";;
	_this setface "WhiteHead_06";;
	_this setspeaker "rhs_male04cz";;
	_this setpitch 1.01344;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
...
private _item18823 = objNull;
if (_layer17433) then {
	_item18823 = _item18822 createUnit ["UK3CB_GAF_O_RIF_1",[9368.68,645.845,0.163382],[],0,"CAN_COLLIDE"];
	_item18822 selectLeader _item18823;
	_this = _item18823;
	_objects pushback _this;
	_objectIDs pushback 18823;
	_this setPosWorld [9368.68,645.895,18.9168];
	_this setVectorDirAndUp [[-0.765878,0.642986,0],[0,0,1]];
	_this setname "Martin Mozek";;
	_this setface "WhiteHead_07";;
	_this setspeaker "rhs_male01cz";;
	_this setpitch 1.02908;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
private _item18825 = objNull;
if (_layer17433) then {
	_item18825 = _item18824 createUnit ["UK3CB_GAF_O_OFF",[9376.04,586.04,4.60267],[],0,"CAN_COLLIDE"];
	_item18824 selectLeader _item18825;
	_this = _item18825;
	_objects pushback _this;
	_objectIDs pushback 18825;
	_this setPosWorld [9376.04,586.09,23.356];
	_this setVectorDirAndUp [[-0.644013,0.765015,0],[0,0,1]];
	_this setname "Richard Satan";;
	_this setface "WhiteHead_05";;
	_this setspeaker "rhs_male02cz";;
	_this setpitch 1.03411;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layer17433) then {
	_item18829 = _item18827 createUnit ["UK3CB_GAF_O_STATIC_TRI_PODNOS",[9372.76,597.212,4.62168],[],0,"CAN_COLLIDE"];
	_this = _item18829;
	_objects pushback _this;
	_objectIDs pushback 18829;
	_this setPosWorld [9372.76,597.262,23.3751];
	_this setVectorDirAndUp [[-0.359925,-0.932981,0],[0,0,1]];
...
if (_layer17433) then {
	_item18831 = _item18827 createUnit ["UK3CB_GAF_O_STATIC_TRI_DSHKM_HIGH",[9368.68,583.087,1.03316],[],0,"CAN_COLLIDE"];
	_item18827 selectLeader _item18831;
	_this = _item18831;
	_objects pushback _this;
	_objectIDs pushback 18831;
	_this setPosWorld [9368.68,583.137,19.7865];
	_this setVectorDirAndUp [[-0.914223,-0.405212,0],[0,0,1]];
	_this setname "Filip Mozek";;
	_this setface "WhiteHead_14";;
	_this setspeaker "rhs_male01cz";;
...
private _item18832 = objNull;
if (_layer17433) then {
	_item18832 = _item18827 createUnit ["UK3CB_GAF_O_STATIC_GUN_SPG9",[9376.04,590.904,1.04135],[],0,"CAN_COLLIDE"];
	_this = _item18832;
	_objects pushback _this;
	_objectIDs pushback 18832;
	_this setPosWorld [9376.04,590.954,19.7947];
	_this setVectorDirAndUp [[-0.359925,-0.932981,0],[0,0,1]];
	_this setname "Daniel Svoboda";;
	_this setface "WhiteHead_06";;
	_this setspeaker "rhs_male03cz";;
	_this setpitch 1.00912;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
private _item18835 = objNull;
if (_layer17433) then {
	_item18835 = _item18827 createUnit ["UK3CB_GAF_O_AA_ASST",[9365.67,593.188,1.03301],[],0,"CAN_COLLIDE"];
	_this = _item18835;
	_objects pushback _this;
	_objectIDs pushback 18835;
	_this setPosWorld [9365.67,593.238,19.7864];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
	_this setname "Adam Kvapil";;
	_this setface "WhiteHead_21";;
	_this setspeaker "rhs_male02cz";;
...
private _item18836 = objNull;
if (_layer17433) then {
	_item18836 = _item18827 createUnit ["UK3CB_GAF_O_STATIC_GUN_PKM",[9373.6,596.709,8.33282],[],0,"CAN_COLLIDE"];
	_this = _item18836;
	_objects pushback _this;
	_objectIDs pushback 18836;
	_this setPosWorld [9373.6,596.759,27.0862];
	_this setVectorDirAndUp [[-0.405212,0.914223,0],[0,0,1]];
	_this setname "Radek Turek";;
	_this setface "WhiteHead_12";;
	_this setspeaker "rhs_male05cz";;
	_this setpitch 1.02573;;
	_this setUnitPos "MIDDLE";
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
...
private _item18837 = objNull;
if (_layer17433) then {
	_item18837 = _item18827 createUnit ["UK3CB_GAF_O_STATIC_TRI_AGS30",[9365.32,590.713,4.63976],[],0,"CAN_COLLIDE"];
	_this = _item18837;
	_objects pushback _this;
	_objectIDs pushback 18837;
	_this setPosWorld [9365.32,590.763,23.3931];
	_this setVectorDirAndUp [[-0.932981,0.359925,0],[0,0,1]];
	_this setname "Standa Adamec";;
	_this setface "WhiteHead_02";;
	_this setspeaker "rhs_male05cz";;
...
private _item18838 = objNull;
if (_layer17433) then {
	_item18838 = _item18827 createUnit ["UK3CB_GAF_O_MK",[9368.07,583.84,4.63976],[],0,"CAN_COLLIDE"];
	_this = _item18838;
	_objects pushback _this;
	_objectIDs pushback 18838;
	_this setPosWorld [9368.07,583.89,23.3931];
	_this setVectorDirAndUp [[-0.359925,-0.932981,0],[0,0,1]];
	_this setname "Hugo Urban";;
	_this setface "WhiteHead_11";;
	_this setspeaker "rhs_male04cz";;
	_this setpitch 0.957736;;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
private _item18788 = objNull;
if (_layer17433) then {
	_item18788 = createVehicle ["UK3CB_GAF_O_PKM_High",[9349.5,638.216,0],[],0,"CAN_COLLIDE"];
	_this = _item18788;
	_objects pushback _this;
	_objectIDs pushback 18788;
	_this setPosWorld [9349.27,638.911,18.7447];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	[_this, 2] call ace_cargo_fnc_setSize;
	_this setTurretLimits [ [0], -180, (_this getTurretLimits [0])#1, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
	_this setTurretLimits [ [0], (_this getTurretLimits [0])#0, 180, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
...
if (!isNull _item18842 && !isNull _item18841) then {_item18842 moveInTurret [_item18841,[0]];};
...
if (!isNull _item18786 && !isNull _item18785) then {_item18786 moveInTurret [_item18785,[0]];};
if (!isNull _item18799 && !isNull _item18798) then {_item18799 moveInTurret [_item18798,[0]];};
if (!isNull _item18802 && !isNull _item18801) then {_item18802 moveInTurret [_item18801,[0]];};
if (!isNull _item18805 && !isNull _item18804) then {_item18805 moveInTurret [_item18804,[0]];};
if (!isNull _item18789 && !isNull _item18788) then {_item18789 moveInTurret [_item18788,[0]];};
...
isNil {
	...
	if !(isnull _item18807) then {
		this = _item18807;
		this disableAI "PATH";
	};
	if !(isnull _item18809) then {
		this = _item18809;
		this disableAI "PATH";
	};
	if !(isnull _item18811) then {
		this = _item18811;
		this disableAI "PATH";
	};
	if !(isnull _item18813) then {
		this = _item18813;
		this disableAI "PATH";
	};
	if !(isnull _item18815) then {
		this = _item18815;
		this disableAI "PATH";
	};
	if !(isnull _item18817) then {
		this = _item18817;
		this disableAI "PATH";
	};
	if !(isnull _item18819) then {
		this = _item18819;
		this disableAI "PATH";
	};
	if !(isnull _item18821) then {
		this = _item18821;
		this disableAI "PATH";
	};
	if !(isnull _item18823) then {
		this = _item18823;
		this disableAI "PATH";
	};
	if !(isnull _item18825) then {
		this = _item18825;
		this disableAI "PATH";
	};
	if !(isnull _item18829) then {
		this = _item18829;
		this disableAI 'PATH';;
	};
	if !(isnull _item18831) then {
		this = _item18831;
		this disableAI 'PATH';;
	};
	if !(isnull _item18832) then {
		this = _item18832;
		this disableAI 'PATH';;
	};
	if !(isnull _item18835) then {
		this = _item18835;
		this disableAI 'PATH';;
	};
	if !(isnull _item18836) then {
		this = _item18836;
		this disableAI 'PATH';;
	};
	if !(isnull _item18837) then {
		this = _item18837;
		this disableAI 'PATH';;
	};
