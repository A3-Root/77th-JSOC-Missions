...
private _layer2586 = (_allWhitelisted || {"airfield and port large" in _layerWhiteList}) && {!("airfield and port large" in _layerBlackList)};
private _layer2585 = (_allWhitelisted || {"large airfield and port" in _layerWhiteList}) && {!("large airfield and port" in _layerBlackList)};
private _layer5112 = (_allWhitelisted || {"large airfield and port" in _layerWhiteList}) && {!("large airfield and port" in _layerBlackList)};
