...
private _layer19481 = true;
private _layer19363 = true;
private _layer19131 = true;
private _layer18970 = true;
private _layer18088 = true;
private _layer17899 = true;
private _layer7139 = true;
private _layer7536 = true;
...
monitor_briefing = objNull;
if (_layer18970) then {
	monitor_briefing = createVehicle ["Land_TripodScreen_01_large_black_F",[9233.06,19438.2,0.139008],[],0,"CAN_COLLIDE"];
	_this = monitor_briefing;
	_objects pushback _this;
...
mci_manueldiazimg = objNull;
if (_layer19893) then {
	mci_manueldiazimg = _item19904 createUnit ["C_man_polo_4_F_euro",[9206.93,19424.9,0.139008],[],0,"CAN_COLLIDE"];
	_item19904 selectLeader mci_manueldiazimg;
	_this = mci_manueldiazimg;
	_objects pushback _this;
...
mci_silvioimg = objNull;
if (_layer19893) then {
	mci_silvioimg = _item19908 createUnit ["C_man_polo_4_F_euro",[9207.26,19442.3,0.139008],[],0,"CAN_COLLIDE"];
	_item19908 selectLeader mci_silvioimg;
	_this = mci_silvioimg;
	_objects pushback _this;
...
mci_manueldiaz = objNull;
if (_layer19893) then {
	mci_manueldiaz = _item20102 createUnit ["C_man_polo_4_F_euro",[9161.9,9144.26,5.08398],[],0,"CAN_COLLIDE"];
	_item20102 selectLeader mci_manueldiaz;
	_this = mci_manueldiaz;
	_objects pushback _this;
...
mci_silvio = objNull;
if (_layer19893) then {
	mci_silvio = _item20115 createUnit ["C_man_polo_4_F_euro",[592.064,2332.37,3.79797],[],0,"CAN_COLLIDE"];
	_item20115 selectLeader mci_silvio;
	_this = mci_silvio;
	_objects pushback _this;
...
mci_ceo = objNull;
if (_layer19893) then {
	mci_ceo = _item19347 createUnit ["UK3CB_ION_O_Desert_CEO",[13262.9,14007.8,0.0319996],[],0,"CAN_COLLIDE"];
	_item19347 selectLeader mci_ceo;
	_this = mci_ceo;
	_objects pushback _this;
...
mci_runner = objNull;
if (_layer19893) then {
	mci_runner = _item20154 createUnit ["UK3CB_CHC_C_POLITIC",[13287.2,13992.3,0.0369987],[],0,"CAN_COLLIDE"];
	_item20154 selectLeader mci_runner;
	_this = mci_runner;
	_objects pushback _this;
...
if !(isnull monitor_briefing) then {
	this = monitor_briefing;
...
if !(isnull mci_manueldiazimg) then {
	this = mci_manueldiazimg;
	this disableAI "PATH";
...
if !(isnull mci_manueldiaz) then {
	this = mci_manueldiaz;
	this disableAI "PATH";
	publicVariable "mci_manueldiaz";
};
if !(isnull mci_silvio) then {
	this = mci_silvio;
	this disableAI "PATH";
