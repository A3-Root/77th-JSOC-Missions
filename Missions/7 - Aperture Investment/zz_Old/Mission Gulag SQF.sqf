// Export of 'Operation%20Ariana%20Ghandhi%20v4.egl_laghisola' by [Pfc.] Root on v0.9
...
private _item4685 = "";
if (_layer4665 && _layer2745 && _layer4706) then {
	_item4685 = createMarker ["GulagPos",[6520.84,9684.63,0]];
	_this = _item4685;
	_markers pushback _this;
	_markerIDs pushback 4685;
	_this setMarkerType "loc_Ruin";
	_this setMarkerSize [1.5,1.5];
	_this setMarkerDir 70.84;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3061 = createVehicle ["Land_BagFence_Long_F",[6504.45,9697.37,23.1132],[],0,"CAN_COLLIDE"];
	_this = _item3061;
	_objects pushback _this;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3062 = createVehicle ["Land_BagFence_Long_F",[6505.74,9699.96,23.202],[],0,"CAN_COLLIDE"];
	_this = _item3062;
	_objects pushback _this;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3063 = createVehicle ["Land_BagFence_Long_F",[6507.05,9702.55,23.3727],[],0,"CAN_COLLIDE"];
	_this = _item3063;
	_objects pushback _this;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3064 = createVehicle ["Land_BagFence_Long_F",[6507.06,9706.58,23.6491],[],0,"CAN_COLLIDE"];
	_this = _item3064;
	_objects pushback _this;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3065 = createVehicle ["Land_BagFence_Long_F",[6503.2,9694.82,22.9755],[],0,"CAN_COLLIDE"];
	_this = _item3065;
	_objects pushback _this;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3066 = createVehicle ["Land_BagFence_Long_F",[6500.41,9693.83,23.056],[],0,"CAN_COLLIDE"];
	_this = _item3066;
	_objects pushback _this;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3067 = createVehicle ["Land_BagFence_Long_F",[6497.88,9695.24,23.0863],[],0,"CAN_COLLIDE"];
	_this = _item3067;
	_objects pushback _this;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3068 = createVehicle ["Land_BagFence_Long_F",[6495.33,9696.49,23.1607],[],0,"CAN_COLLIDE"];
	_this = _item3068;
	_objects pushback _this;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3069 = createVehicle ["Land_BagFence_Long_F",[6504.48,9707.87,23.7338],[],0,"CAN_COLLIDE"];
	_this = _item3069;
	_objects pushback _this;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3075 = createVehicle ["Land_BagFence_Long_F",[6545.96,9685.93,21.4465],[],0,"CAN_COLLIDE"];
	_this = _item3075;
	_objects pushback _this;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3076 = createVehicle ["Land_BagFence_Long_F",[6546.85,9683.18,21.5045],[],0,"CAN_COLLIDE"];
	_this = _item3076;
	_objects pushback _this;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3077 = createVehicle ["Land_BagFence_Long_F",[6545.08,9688.64,21.3279],[],0,"CAN_COLLIDE"];
	_this = _item3077;
	_objects pushback _this;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3079 = createVehicle ["Land_BagFence_Long_F",[6547.72,9680.44,21.5582],[],0,"CAN_COLLIDE"];
	_this = _item3079;
	_objects pushback _this;
...
if (_layer3012 && _layer2745 && _layer4706) then {
	_item3080 = createVehicle ["Land_BagFence_Long_F",[6548.61,9677.69,21.592],[],0,"CAN_COLLIDE"];
	_this = _item3080;
	_objects pushback _this;
...
if (_layer4616 && _layer2745 && _layer4706) then {
	_item4632 = createVehicle ["Land_LampShabby_F",[6528.49,9677.52,2.37386],[],0,"CAN_COLLIDE"];
	_this = _item4632;
	_objects pushback _this;
	_objectIDs pushback 4632;
	_this setPosWorld [6528.49,9677.52,8.57589];
	_this setVectorDirAndUp [[-0.94461,-0.328194,0],[0,0,1]];
};
...
if (_layer4616 && _layer2745 && _layer4706) then {
	_item4641 = createVehicle ["Land_PortableLight_single_F",[6518.89,9681.59,3.16216],[],0,"CAN_COLLIDE"];
	_this = _item4641;
	_objects pushback _this;
...
if (_layer4645 && _layer2745 && _layer4706) then {
	_item16181 = createSimpleObject ["Land_MobilePhone_smart_F",[6507.84,9666.08,9.96637]];
	_this = _item16181;
	_objects pushback _this;
...
if (_layer4645 && _layer2745 && _layer4706) then {
	_item16185 = createSimpleObject ["Land_Laptop_03_olive_F",[6506.27,9670.95,9.95657]];
	_this = _item16185;
	_objects pushback _this;
	_objectIDs pushback 16185;
	_this setPosWorld [6506.27,9670.95,9.95686];
	_this setVectorDirAndUp [[-0.694445,-0.719546,0],[0,0,1]];
	_this enableSimulation false;
	_this allowdamage false;;
...
if (_layer4645 && _layer2745 && _layer4706) then {
	_item16201 = createVehicle ["GalleryInterior_plan_01",[6509.31,9669.9,7.619],[],0,"CAN_COLLIDE"];
	_this = _item16201;
	_objects pushback _this;
	_objectIDs pushback 16201;
	_this setPosWorld [6509.31,9669.9,10.049];
	_this setVectorDirAndUp [[0.286675,-0.958028,0],[0,0,1]];
	_this enableSimulation false;
...
if (_layer4112 && _layer2745 && _layer4706) then {
	_item16138 = createVehicle ["Land_radar_poster_01_F",[6521.31,9685.25,4.289],[],0,"CAN_COLLIDE"];
	_this = _item16138;
	_objects pushback _this;
	_objectIDs pushback 16138;
	_this setPosWorld [6521.31,9685.25,6.719];
	_this setVectorDirAndUp [[-0.390474,0.920614,0],[0,0,1]];
};

private _item16137 = objNull;
if (_layer4112 && _layer2745 && _layer4706) then {
	_item16137 = createVehicle ["A_FuelStation_Billboard2",[6519.87,9684.58,4.422],[],0,"CAN_COLLIDE"];
	_this = _item16137;
	_objects pushback _this;
	_objectIDs pushback 16137;
	_this setPosWorld [6519.87,9684.58,6.852];
...
if (_layer4665) then {missionNamespace setVariable ["Operation%20Ariana%20Ghandhi%20v4_Misc",[[_item4675],[_item4676,_item4677,_item4678,_item4679,_item4680,_item4681,_item4682,_item4683,_item4684,_item4685]]];};
...
if (_layer3852) then {missionNamespace setVariable ["Operation%20Ariana%20Ghandhi%20v4_Basement_Building",[[_item3853,_item3854,_item3855,_item3856,_item3859,_item3860,_item3861,_item3887,_item3888,_item3890,_item3891,_item3892,_item3893,_item3896,_item3897,_item3914,_item3915,_item3916,_item3919,_item16212,_item16213,_item16214,_item16215],[]]];};
