// Export of 'Operation: Aperture Investment' by [Pfc.] Root on 24 October 2024
...
private _layer7229 = (_allWhitelisted || {"sam" in _layerWhiteList}) && {!("sam" in _layerBlackList)};
private _layer7187 = (_allWhitelisted || {"spawn" in _layerWhiteList}) && {!("spawn" in _layerBlackList)};
private _layer5064 = (_allWhitelisted || {"vehicles" in _layerWhiteList}) && {!("vehicles" in _layerBlackList)};
private _layer4950 = (_allWhitelisted || {"walls_1" in _layerWhiteList}) && {!("walls_1" in _layerBlackList)};
private _layer4919 = (_allWhitelisted || {"rooms" in _layerWhiteList}) && {!("rooms" in _layerBlackList)};
private _layer4941 = (_allWhitelisted || {"objects_1" in _layerWhiteList}) && {!("objects_1" in _layerBlackList)};
private _layer4966 = (_allWhitelisted || {"ship interior" in _layerWhiteList}) && {!("ship interior" in _layerBlackList)};
private _layer4999 = (_allWhitelisted || {"objects" in _layerWhiteList}) && {!("objects" in _layerBlackList)};
private _layer1793 = (_allWhitelisted || {"november" in _layerWhiteList}) && {!("november" in _layerBlackList)};
private _layer6785 = (_allWhitelisted || {"objects" in _layerWhiteList}) && {!("objects" in _layerBlackList)};
private _layer3327 = (_allWhitelisted || {"zamak 2.8 t-100 turret" in _layerWhiteList}) && {!("zamak 2.8 t-100 turret" in _layerBlackList)};
private _layer1888 = (_allWhitelisted || {"csat t-140 (mlrs)_1" in _layerWhiteList}) && {!("csat t-140 (mlrs)_1" in _layerBlackList)};
private _layer1887 = (_allWhitelisted || {"csat t-140 (mlrs)" in _layerWhiteList}) && {!("csat t-140 (mlrs)" in _layerBlackList)};
private _layer5063 = (_allWhitelisted || {"vehicles" in _layerWhiteList}) && {!("vehicles" in _layerBlackList)};
private _layer5062 = (_allWhitelisted || {"infantry" in _layerWhiteList}) && {!("infantry" in _layerBlackList)};
private _layer1792 = (_allWhitelisted || {"juliet" in _layerWhiteList}) && {!("juliet" in _layerBlackList)};
private _layer1583 = (_allWhitelisted || {"vehicles" in _layerWhiteList}) && {!("vehicles" in _layerBlackList)};
private _layer1581 = (_allWhitelisted || {"infantry" in _layerWhiteList}) && {!("infantry" in _layerBlackList)};
private _layer1580 = (_allWhitelisted || {"mike" in _layerWhiteList}) && {!("mike" in _layerBlackList)};
private _layer1463 = (_allWhitelisted || {"objects" in _layerWhiteList}) && {!("objects" in _layerBlackList)};
private _layer1462 = (_allWhitelisted || {"infantry" in _layerWhiteList}) && {!("infantry" in _layerBlackList)};
private _layer1461 = (_allWhitelisted || {"vehicles" in _layerWhiteList}) && {!("vehicles" in _layerBlackList)};
private _layer1460 = (_allWhitelisted || {"victor" in _layerWhiteList}) && {!("victor" in _layerBlackList)};
private _layer1253 = (_allWhitelisted || {"infantry" in _layerWhiteList}) && {!("infantry" in _layerBlackList)};
private _layer1203 = (_allWhitelisted || {"vehicles" in _layerWhiteList}) && {!("vehicles" in _layerBlackList)};
private _layer1202 = (_allWhitelisted || {"concord" in _layerWhiteList}) && {!("concord" in _layerBlackList)};
private _layer1092 = (_allWhitelisted || {"mci" in _layerWhiteList}) && {!("mci" in _layerBlackList)};
private _layer1568 = (_allWhitelisted || {"objects" in _layerWhiteList}) && {!("objects" in _layerBlackList)};
private _layer1112 = (_allWhitelisted || {"infantry" in _layerWhiteList}) && {!("infantry" in _layerBlackList)};
private _layer1111 = (_allWhitelisted || {"vehicles" in _layerWhiteList}) && {!("vehicles" in _layerBlackList)};
private _layer1091 = (_allWhitelisted || {"asylum" in _layerWhiteList}) && {!("asylum" in _layerBlackList)};
...
if (_layer4941 && _layer4966 && _layer1793) then {
	...
	_this setVariable ['s',1];;
	[_this, 8] call ace_cargo_fnc_setSpace;
	_this setVariable ['rhs_decalNumber_type', "Default"];[_this,[['Number', SS21NumberPlaces, "Default"]]] call rhs_fnc_decalsInit;
	if( -1 >= 0)then{if( -1 == 0)then{{[_this setobjectTexture [_x,'a3\data_f\clear_empty.paa']]}foreach SS21NumberPlaces}else{[_this, [['Number', SS21NumberPlaces, _this getVariable ['rhs_decalNumber_type','Default'], -1] ] ] call rhs_fnc_decalsInit}};;
...
if (_layer7187) then {
	_item7298 = createVehicle ["RHS_UH60M_ESSS2_d",[4479.92,2963.65,0],[],0,"CAN_COLLIDE"];
	_this = _item7298;
	_objects pushback _this;
	_objectIDs pushback 7298;
	_this setPosWorld [4479.92,2963.64,15.8958];
	_this setVectorDirAndUp [[0.0192323,0.999815,0],[0,0,1]];
	_this setPylonLoadout [1,"rhs_mag_ATAS_2"];
	_this setPylonLoadout [2,"rhs_mag_M229_19"];
...
if (_layer7187) then {
	_item7299 = createVehicle ["RHS_UH60M_ESSS2_d",[4459.67,2961.67,0],[],0,"CAN_COLLIDE"];
	_this = _item7299;
	_objects pushback _this;
	_objectIDs pushback 7299;
	_this setPosWorld [4459.67,2961.67,15.8958];
...
if (_layer7187) then {
	_item7300 = createVehicle ["RHS_UH60M_ESSS2_d",[4437.27,2960.67,-0.00600052],[],0,"CAN_COLLIDE"];
	_this = _item7300;
	_objects pushback _this;
	_objectIDs pushback 7300;
	_this setPosWorld [4437.27,2960.67,15.9198];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setPylonLoadout [1,"rhs_mag_ATAS_2"];
	_this setPylonLoadout [2,"rhs_mag_M229_19"];
	_this setPylonLoadout [3,"rhsusf_M130_CMFlare_Chaff_Magazine_x2"];
...
if (_layer7187) then {
	_item7301 = createVehicle ["RHS_UH60M_ESSS2_d",[4413.67,2960.01,0],[],0,"CAN_COLLIDE"];
	_this = _item7301;
	_objects pushback _this;
	_objectIDs pushback 7301;
	_this setPosWorld [4413.67,2960.01,16.0058];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setPylonLoadout [1,"rhs_mag_ATAS_2"];
	_this setPylonLoadout [2,"rhs_mag_M229_19"];
	_this setPylonLoadout [3,"rhsusf_M130_CMFlare_Chaff_Magazine_x2"];
...
if (_layer7187) then {
	_item7302 = createVehicle ["RHS_UH60M_ESSS2_d",[4386.98,2960.88,0],[],0,"CAN_COLLIDE"];
	_this = _item7302;
	_objects pushback _this;
	_objectIDs pushback 7302;
	_this setPosWorld [4386.98,2960.88,16.0058];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setPylonLoadout [1,"rhs_mag_ATAS_2"];
	_this setPylonLoadout [2,"rhs_mag_M229_19"];
	_this setPylonLoadout [3,"rhsusf_M130_CMFlare_Chaff_Magazine_x2"];
...
if (_layer7187) then {
	_item7303 = createVehicle ["RHS_UH60M_ESSS2_d",[4362.05,2960.71,-0.0129995],[],0,"CAN_COLLIDE"];
	_this = _item7303;
	_objects pushback _this;
	_objectIDs pushback 7303;
	_this setPosWorld [4362.03,2960.73,15.9048];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setPylonLoadout [1,"rhs_mag_ATAS_2"];
	_this setPylonLoadout [2,"rhs_mag_M229_19"];
	_this setPylonLoadout [3,"rhsusf_M130_CMFlare_Chaff_Magazine_x2"];
...
if (_layer7187) then {missionNamespace setVariable ["Operation%20Aperture%20Investment_Spawn",[[_item7200,_item7201,_item7202,_item7203,_item7188,_item7189,_item7190,_item7191,_item7192,_item7193,_item7216,_item7217,_item7204,_item7207,_item7210,_item7213,_item7205,_item7208,_item7211,_item7214,_item7206,_item7209,_item7212,_item7215,_item7298,_item7299,_item7300,_item7301,_item7302,_item7303],[]]];};
