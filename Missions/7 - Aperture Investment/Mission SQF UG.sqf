...
if (_layer12669 && _layer11585) then {
	...
	_this setVectorDirAndUp [[0.528771,-0.848764,0],[0,0,1]];
};
...
if (_layer12669 && _layer11585) then {
	_item12672 = createVehicle ["VR_Crew_passanger_13",[1235.44,422.712,149.108],[],0,"CAN_COLLIDE"];
	_this = _item12672;
	_objects pushback _this;
	_objectIDs pushback 12672;
	_this setPosWorld [1235.44,422.712,92.6825];
	_this setVectorDirAndUp [[-0.765129,-0.643877,0],[0,0,1]];
	_this enableSimulation false;
	_this allowdamage false;;
};
...
this addAction [ 
 ...
 nil, 1.5, true, true, "", "true", 5, false, "", "" 
	...
	if !(isnull _item12677) then {
		this = _item12677;
		ug_cleanup pushBack this;
[this, 2, false, 0, "Download simulation and research data", ["OMIntelGrabPC_01", "OMIntelGrabPC_02", "OMIntelGrabPC_03"], 10, "Downloaded Research Data", "Simulation research data pertaining to NATO tanks, armor sets and equipment against advanced CSAT technology."] call zen_modules_fnc_addIntelAction;;
	};
	if !(isnull _item12678) then {
		this = _item12678;
		ug_cleanup pushBack this;
[this, 2, false, 0, "Decrypt Transfer Logs", ["OMIntelGrabPC_01", "OMIntelGrabPC_02", "OMIntelGrabPC_03"], 10, "Partially Decrypted Technology Transfer Logs", "*** Last Transfer successfully completed by 'Dan Druff'. Coordniates: ######, North Isla Abramia."] call zen_modules_fnc_addIntelAction;;
	};
