// Export of 'OPORD-0724-C15.7 @ Phuc Tuy Province, Vietnam' by [Pfc.] Root on July 04, 2024 for 77th JSOC.

private _allWhitelisted = true;
private _layerRoot = true;
private _layer999 = true;
private _layer998 = true;
private _layer1026 = true;
private _layer388 = true;

evac_helo = [];
publicVariable "evac_helo";
...
private _item62 = "";
if (_layerRoot) then {
	_item62 = createMarker ["marker_7",[12545.8,7714.58,0]];
	_this = _item62;
	_markers pushback _this;
	_markerIDs pushback 62;
	_this setMarkerType "loc_help";
	_this setMarkerText "FSB Scobie";
	_this setMarkerShape "ICON";
...
private _item64 = "";
if (_layerRoot) then {
	_item64 = createMarker ["marker_9",[13653,7141.32,0]];
	_this = _item64;
	_markers pushback _this;
	_markerIDs pushback 64;
	_this setMarkerType "loc_help";
	_this setMarkerText "FSB Elaine";
	_this setMarkerShape "ICON";
	_this setMarkerColor "ColorWEST";
	if (([0,0,0] # 0 isNotEqualTo 0) || ([0,0,0] # 1 isNotEqualTo 0)) then {[_this, [0,0,0] # 0, [0,0,0] # 1] spawn BIS_fnc_blinkMarker};
};
...
if (_layerRoot) then {
	_item677 = createGroup west;
	_this = _item677;
	_groups pushback _this;
	_groupIDs pushback 677;
};

private _item690 = grpNull;
if (_layerRoot) then {
	_item690 = createGroup west;
	_this = _item690;
	_groups pushback _this;
	_groupIDs pushback 690;
};

private _item693 = grpNull;
if (_layerRoot) then {
	_item693 = createGroup west;
	_this = _item693;
	_groups pushback _this;
...
private _item772 = grpNull;
if (_layerRoot) then {
	_item772 = createGroup west;
	_this = _item772;
	_groups pushback _this;
	_groupIDs pushback 772;
};

private _item778 = grpNull;
if (_layerRoot) then {
	_item778 = createGroup west;
	_this = _item778;
	_groups pushback _this;
	_groupIDs pushback 778;
};
...
private _item806 = grpNull;
if (_layerRoot) then {
	_item806 = createGroup west;
	_this = _item806;
	_groups pushback _this;
	_groupIDs pushback 806;
};
...
if (_layerRoot) then {
	_item213 = createVehicle ["Map4",[6561.85,7342.65,0.718258],[],0,"CAN_COLLIDE"];
	_this = _item213;
	_objects pushback _this;
	_objectIDs pushback 213;
	_this setPosWorld [6561.85,7342.65,14.2544];
	_this setVectorDirAndUp [[-0.988113,-0.153727,0.000404222],[0,0.00262947,0.999997]];
};

private _item228 = objNull;
if (_layerRoot) then {
	_item228 = createVehicle ["wx_radio",[6563.14,7348.01,1.59565],[],0,"CAN_COLLIDE"];
	_this = _item228;
	_objects pushback _this;
	_objectIDs pushback 228;
	_this setPosWorld [6563.14,7348.01,14.8142];
	_this setVectorDirAndUp [[-0.869485,-0.493957,0.00129885],[0,0.00262947,0.999997]];
};

private _item316 = objNull;
if (_layer388) then {
	_item316 = createVehicle ["Land_CampingChair_V2_F",[6561.94,7347.93,0.722792],[],0,"CAN_COLLIDE"];
	_this = _item316;
	_objects pushback _this;
	_objectIDs pushback 316;
	_this setPosWorld [6561.94,7347.93,13.8638];
	_this setVectorDirAndUp [[-0.999788,-0.0206035,5.41766e-005],[0,0.00262947,0.999997]];
};

private _item317 = objNull;
if (_layer388) then {
	_item317 = createSimpleObject ["Land_PortableDesk_01_black_F",[6563.18,7345.04,13.365]];
	_this = _item317;
	_objects pushback _this;
	_objectIDs pushback 317;
	_this setPosWorld [6563.18,7345.04,13.8088];
	_this setVectorDirAndUp [[0.99999,-0.00449063,1.1808e-005],[0,0.00262947,0.999997]];
...
if (_layer388) then {
	_item318 = createSimpleObject ["Land_PortableDesk_01_black_F",[6563.19,7347.04,13.3596]];
	_this = _item318;
	_objects pushback _this;
	_objectIDs pushback 318;
	_this setPosWorld [6563.19,7347.04,13.8035];
	_this setVectorDirAndUp [[0.99999,-0.00449063,1.1808e-005],[0,0.00262947,0.999997]];
	_this enableSimulation false;
	_this allowdamage false;
	if(_this animationSourcePhase 'Lid_2_hide_source' > 0)then{_this animate ['Drawer_1_move_source',0,true]};
...
if (_layer388) then {
	_item319 = createVehicle ["Land_CampingChair_V2_F",[6561.94,7346.93,0.728106],[],0,"CAN_COLLIDE"];
	_this = _item319;
	_objects pushback _this;
	_objectIDs pushback 319;
	_this setPosWorld [6561.94,7346.93,13.8664];
	_this setVectorDirAndUp [[-0.999788,-0.0206107,5.41955e-005],[0,0.00262947,0.999997]];
};

private _item320 = objNull;
if (_layer388) then {
	_item320 = createVehicle ["Land_CampingChair_V2_F",[6561.94,7345.93,0.731524],[],0,"CAN_COLLIDE"];
	_this = _item320;
	_objects pushback _this;
	_objectIDs pushback 320;
	_this setPosWorld [6561.94,7345.93,13.8691];
	_this setVectorDirAndUp [[-0.999788,-0.0206107,5.41955e-005],[0,0.00262947,0.999997]];
};

private _item321 = objNull;
if (_layer388) then {
	_item321 = createVehicle ["Land_CampingChair_V2_F",[6561.94,7345.93,0.731524],[],0,"CAN_COLLIDE"];
	_this = _item321;
	_objects pushback _this;
...
if (_layer388) then {
	_item322 = createVehicle ["Land_CampingChair_V2_F",[6561.94,7344.93,0.726178],[],0,"CAN_COLLIDE"];
	_this = _item322;
	_objects pushback _this;
	_objectIDs pushback 322;
	_this setPosWorld [6561.94,7344.93,13.8717];
	_this setVectorDirAndUp [[-0.999788,-0.0206107,5.41955e-005],[0,0.00262947,0.999997]];
};

private _item323 = objNull;
if (_layer388) then {
	_item323 = createVehicle ["Land_CampingChair_V2_F",[6561.94,7343.93,0.720829],[],0,"CAN_COLLIDE"];
	_this = _item323;
	_objects pushback _this;
	_objectIDs pushback 323;
	_this setPosWorld [6561.94,7343.93,13.8744];
	_this setVectorDirAndUp [[-0.999788,-0.0206107,5.41955e-005],[0,0.00262947,0.999997]];
};
...
if (_layerRoot) then {
	_item489 = _item488 createUnit ["uns_US_1CAV_RTO",[6561.75,7350.71,0.706],[],0,"CAN_COLLIDE"];
	_item488 selectLeader _item489;
	_this = _item489;
	_objects pushback _this;
	_objectIDs pushback 489;
	_this setPosWorld [6561.75,7350.76,13.3512];
...
if (_layerRoot) then {
	_item198 = createVehicle ["uns_ch47_m60_usmc",[6664.85,7137.74,0.093833],[],0,"CAN_COLLIDE"];
	_this = _item198;
	_objects pushback _this;
	_objectIDs pushback 198;
	_this setPosWorld [6664.83,7137.65,18.111];
	_this setVectorDirAndUp [[0.135823,0.99073,0.00265259],[-0.00484604,-0.00201301,0.999986]];
	[_this,"[[[[""uns_38spec"",""uns_xm177e2_short"",""uns_mkvFlarePistol""],[1,1,1]],[[""uns_20Rnd_556x45_Stanag"",""uns_kabar"",""uns_38specmag"",""uns_40mm_mkv_Red"",""UNS_EAM2Braft""],[8,1,4,12,1]],[[""FirstAidKit""],[3]],[[],[]]],false]"] call bis_fnc_initAmmoBox;
	_this setVehicleReportRemoteTargets true;
	_this setVehicleReceiveRemoteTargets true;
	_this setVehicleReportOwnPosition true;
...
if (_layerRoot) then {
	...
	_this setPosWorld [8238.8,5567.15,3.85369];
...
if (_layerRoot) then {
	...
	_this setPosWorld [8237.47,5567.41,4.1748];
	_this setVectorDirAndUp [[0.739699,-0.672909,0.0062781],[-0.0133317,-0.00532607,0.999897]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [8232.37,5573.79,3.73608];
...
if (_layerRoot) then {
	...
	_this setPosWorld [8231.18,5574.17,4.80714];
	_this setVectorDirAndUp [[0.581836,-0.813287,0.00560853],[-0.031983,-0.0159893,0.999361]];
...
if (_layerRoot) then {
	_item624 = _item623 createUnit ["uns_US_1CAV_SL",[12532.9,7725.74,0],[],0,"CAN_COLLIDE"];
	_item623 selectLeader _item624;
	_this = _item624;
	_objects pushback _this;
	_objectIDs pushback 624;
	_this setPosWorld [12532.9,7725.79,12.0714];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item626 = _item625 createUnit ["uns_US_1CAV_PL",[12532.1,7727.1,0],[],0,"CAN_COLLIDE"];
	_item625 selectLeader _item626;
	_this = _item626;
	_objects pushback _this;
	_objectIDs pushback 626;
	_this setPosWorld [12532.1,7727.15,12.0714];
	_this setVectorDirAndUp [[0.921762,0.387757,0],[0,0,1]];
...
if (_layerRoot) then {
	_item628 = _item627 createUnit ["uns_US_1CAV_RF3",[12532.2,7725.98,0],[],0,"CAN_COLLIDE"];
	_item627 selectLeader _item628;
	_this = _item628;
	_objects pushback _this;
	_objectIDs pushback 628;
	_this setPosWorld [12532.2,7726.03,12.0714];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item630 = _item629 createUnit ["uns_US_1CAV_RF4",[12535.9,7725.96,0],[],0,"CAN_COLLIDE"];
	_item629 selectLeader _item630;
	_this = _item630;
	_objects pushback _this;
	_objectIDs pushback 630;
	_this setPosWorld [12535.9,7726.01,12.0714];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item632 = _item631 createUnit ["uns_US_1CAV_RF4",[12536.9,7689.18,9.53674e-007],[],0,"CAN_COLLIDE"];
	_item631 selectLeader _item632;
	_this = _item632;
	_objects pushback _this;
	_objectIDs pushback 632;
	_this setPosWorld [12536.9,7689.23,12.077];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item634 = _item633 createUnit ["uns_US_1CAV_RF5",[12536.8,7688.7,3.8147e-006],[],0,"CAN_COLLIDE"];
	_item633 selectLeader _item634;
	_this = _item634;
	_objects pushback _this;
	_objectIDs pushback 634;
	_this setPosWorld [12536.8,7688.75,12.0782];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item636 = _item635 createUnit ["uns_US_1CAV_RF6",[12536.9,7688.16,1.90735e-006],[],0,"CAN_COLLIDE"];
	_item635 selectLeader _item636;
	_this = _item636;
	_objects pushback _this;
	_objectIDs pushback 636;
	_this setPosWorld [12536.9,7688.21,12.0797];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item638 = _item637 createUnit ["uns_US_1CAV_RF2",[12577.3,7726.16,0],[],0,"CAN_COLLIDE"];
	_item637 selectLeader _item638;
	_this = _item638;
	_objects pushback _this;
	_objectIDs pushback 638;
	_this setPosWorld [12577.3,7726.21,12.0714];
	_this setVectorDirAndUp [[0.423087,-0.906089,0],[0,0,1]];
...
if (_layerRoot) then {
	_item640 = _item639 createUnit ["uns_US_1CAV_RF4",[12576.8,7727.04,0],[],0,"CAN_COLLIDE"];
	_item639 selectLeader _item640;
	_this = _item640;
	_objects pushback _this;
	_objectIDs pushback 640;
	_this setPosWorld [12576.8,7727.09,12.0714];
	_this setVectorDirAndUp [[0.45902,-0.888426,0],[0,0,1]];
...
if (_layerRoot) then {
	_item642 = _item641 createUnit ["uns_US_1CAV_RF3",[12576.5,7725.93,0],[],0,"CAN_COLLIDE"];
	_item641 selectLeader _item642;
	_this = _item642;
	_objects pushback _this;
	_objectIDs pushback 642;
	_this setPosWorld [12576.5,7725.98,12.0714];
	_this setVectorDirAndUp [[0.679426,-0.733744,0],[0,0,1]];
...
if (_layerRoot) then {
	_item644 = _item643 createUnit ["uns_US_1CAV_MED",[12575.7,7726.35,0],[],0,"CAN_COLLIDE"];
	_item643 selectLeader _item644;
	_this = _item644;
	_objects pushback _this;
	_objectIDs pushback 644;
	_this setPosWorld [12575.7,7726.4,12.0714];
	_this setVectorDirAndUp [[0.843048,-0.537838,0],[0,0,1]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [12496.8,7718.48,12.9943];
	_this setVectorDirAndUp [[-0.363024,0.93178,0],[0,0,1]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [12497.6,7718.7,12.9055];
	_this setVectorDirAndUp [[-0.363024,0.93178,0],[0,0,1]];
...
if (_layerRoot) then {
	_item646 = createVehicle ["uns_willys",[12497.1,7718.84,0],[],0,"CAN_COLLIDE"];
	_this = _item646;
	_objects pushback _this;
	_objectIDs pushback 646;
	_this setPosWorld [12497.1,7718.84,13.7254];
	_this setVectorDirAndUp [[-0.363024,0.93178,0],[0,0,1]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [12524.6,7742.27,14.1995];
	_this setVectorDirAndUp [[-0.563717,0.825968,0],[0,0,1]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [12525,7741.76,14.038];
	_this setVectorDirAndUp [[-0.563717,0.825968,0],[0,0,1]];
...
if (_layerRoot) then {
	_item650 = createVehicle ["uns_xm706e2",[12525,7741.7,-0.0200005],[],0,"CAN_COLLIDE"];
	_this = _item650;
	_objects pushback _this;
	_objectIDs pushback 650;
	_this setPosWorld [12525,7741.7,14.5026];
	_this setVectorDirAndUp [[-0.563717,0.825968,0],[0,0,1]];
	[_this,"[[[[""uns_mkvFlarePistol"",""uns_MX991_g""],[1,1]],[[""uns_40mm_mkv_Green"",""uns_ItemFuelcan"",""DemoCharge_Remote_Mag""],[8,1,1]],[[""FirstAidKit"",""ToolKit"",""ACE_rope12""],[4,1,1]],[[],[]]],false]"] call bis_fnc_initAmmoBox;
	_this setVariable ['s',1];
	[_this, 4] call ace_cargo_fnc_setSpace;
...
if (_layerRoot) then {
	...
	_this setPosWorld [12484,7743.28,14.5082];
	_this setVectorDirAndUp [[0,1,0],[-0.0903023,0,0.995914]];
...
if (_layerRoot) then {
	_item674 = createVehicle ["uns_M132",[12484,7743.28,-0.208],[],0,"CAN_COLLIDE"];
	_this = _item674;
	_objects pushback _this;
...
if (_layerRoot) then {
	_item679 = _item677 createUnit ["uns_men_US_Arty_RTO",[12557.1,7718.47,1.07036],[],0,"CAN_COLLIDE"];
	_item677 selectLeader _item679;
	_this = _item679;
	_objects pushback _this;
	_objectIDs pushback 679;
	_this setPosWorld [12556.7,7718.05,12.3258];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Oscar Moore";
	_this setface "WhiteHead_04";
	_this setpitch 1.02141;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layerRoot) then {
	_item678 = createVehicle ["uns_M30_107mm_mortar",[12557.1,7718.47,0.252],[],0,"CAN_COLLIDE"];
	_this = _item678;
	_objects pushback _this;
	_objectIDs pushback 678;
	_this setPosWorld [12557.1,7718.47,13.3924];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	[_this, 2] call ace_cargo_fnc_setSize;
	...
	_this setTurretLimits [ [0], (_this getTurretLimits [0])#0, (_this getTurretLimits [0])#1, (_this getTurretLimits [0])#2, 35 ];
...
if (_layerRoot) then {
	_item692 = _item690 createUnit ["uns_men_US_Arty_RTO",[12534,7707.08,0.735189],[],0,"CAN_COLLIDE"];
	_item690 selectLeader _item692;
	_this = _item692;
	_objects pushback _this;
	_objectIDs pushback 692;
	_this setPosWorld [12533.7,7706.83,12.0726];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Benjamin Halliwell";
	_this setface "WhiteHead_02";
...
if (_layerRoot) then {
	_item691 = createVehicle ["uns_M1_81mm_mortar",[12534,7707.08,0],[],0,"CAN_COLLIDE"];
	_this = _item691;
	_objects pushback _this;
	_objectIDs pushback 691;
	_this setPosWorld [12534,7707.08,12.8052];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	[_this, 2] call ace_cargo_fnc_setSize;
	_this setTurretLimits [ [0], -180, (_this getTurretLimits [0])#1, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
	_this setTurretLimits [ [0], (_this getTurretLimits [0])#0, 180, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
...
if (_layerRoot) then {
	_item695 = _item693 createUnit ["uns_men_US_Arty_RTO",[12531.2,7705.73,0.735189],[],0,"CAN_COLLIDE"];
	_item693 selectLeader _item695;
	_this = _item695;
	_objects pushback _this;
	_objectIDs pushback 695;
	_this setPosWorld [12530.8,7705.48,12.0726];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Chris Acker";
	_this setface "GreekHead_A3_06";
	_this setpitch 1.02443;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layerRoot) then {
	_item694 = createVehicle ["uns_M1_81mm_mortar",[12531.2,7705.73,0],[],0,"CAN_COLLIDE"];
	_this = _item694;
	_objects pushback _this;
	_objectIDs pushback 694;
	_this setPosWorld [12531.2,7705.73,12.8052];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	[_this, 2] call ace_cargo_fnc_setSize;
	_this setTurretLimits [ [0], -180, (_this getTurretLimits [0])#1, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
	_this setTurretLimits [ [0], (_this getTurretLimits [0])#0, 180, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
...
if (_layerRoot) then {
	_item688 = createVehicle ["Uns_M102_artillery",[12552.4,7695.05,0],[],0,"CAN_COLLIDE"];
	_this = _item688;
	_objects pushback _this;
	_objectIDs pushback 688;
	_this setPosWorld [12552.7,7695.33,12.1286];
	_this setVectorDirAndUp [[0.81187,0.583839,0],[0,0,1]];
	[_this, 2] call ace_cargo_fnc_setSize;
	_this setTurretLimits [ [0], -180, (_this getTurretLimits [0])#1, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
	_this setTurretLimits [ [0], (_this getTurretLimits [0])#0, 180, (_this getTurretLimits [0])#2, (_this getTurretLimits [0])#3 ];
...
if (_layerRoot) then {
	_item689 = _item687 createUnit ["uns_men_US_Arty_CS",[12550.4,7693.63,0.10565],[],0,"CAN_COLLIDE"];
	_item687 selectLeader _item689;
	_this = _item689;
	_objects pushback _this;
	_objectIDs pushback 689;
	_this setPosWorld [12551.3,7695.12,12.1315];
	_this setVectorDirAndUp [[0.81187,0.583839,0],[0,0,1]];
	_this setname "Charles Spiegelman";
	_this setface "WhiteHead_18";
	_this setpitch 0.989436;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layerRoot) then {
	...
	_this setPosWorld [12564.3,7746.69,13.3584];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [12564.7,7745.48,13.0378];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item700 = createVehicle ["uns_m37b1_m1919",[12564.8,7747.14,0],[],0,"CAN_COLLIDE"];
	_this = _item700;
	_objects pushback _this;
	_objectIDs pushback 700;
	_this setPosWorld [12564.8,7746.32,12.1766];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [7569.79,9986.75,43.255];
...
if (_layerRoot) then {
	...
	_this setPosWorld [7570.31,9985.51,43.593];
	_this setVectorDirAndUp [[0.146875,0.989149,-0.00340598],[0.00532321,0.00265286,0.999982]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [7563.11,9993.49,43.1793];
...
if (_layerRoot) then {
	...
	_this setPosWorld [7563.45,9992.32,44.2875];
	_this setVectorDirAndUp [[0.34027,0.940262,-0.0111452],[0.0106641,0.00799299,0.999911]];
...
if (_layerRoot) then {
	_item774 = _item772 createUnit ["uns_pilot5",[13638.3,7187.54,0],[],0,"CAN_COLLIDE"];
	_item772 selectLeader _item774;
	_this = _item774;
	_objects pushback _this;
	_objectIDs pushback 774;
	_this setPosWorld [13637.9,7184.4,14.3769];
	_this setVectorDirAndUp [[0.0297883,-0.999556,0],[0,0,1]];
	_this setname "Matthew Wright";
	_this setface "Default";
	_this setspeaker "male03gre";
	_this setpitch 0.991792;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layerRoot) then {
	_item775 = _item772 createUnit ["uns_pilot5",[13638.3,7187.54,1.9614],[],0,"CAN_COLLIDE"];
	_this = _item775;
	_objects pushback _this;
	_objectIDs pushback 775;
	_this setPosWorld [13639,7184.43,14.3778];
	_this setVectorDirAndUp [[0.0297883,-0.999556,0],[0,0,1]];
	_this setname "George Conrad";
	_this setface "Default";
	_this setspeaker "male06eng";
	_this setpitch 0.988084;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layerRoot) then {
	_item776 = _item772 createUnit ["uns_pilot5",[13638.3,7187.54,1.9614],[],0,"CAN_COLLIDE"];
	_this = _item776;
	_objects pushback _this;
	_objectIDs pushback 776;
	_this setPosWorld [13639.1,7186.63,14.3938];
	_this setVectorDirAndUp [[0.0297883,-0.999556,0],[0,0,1]];
	_this setname "Tavish Wood";
	_this setface "Default";
	_this setspeaker "male04gre";
	_this setpitch 1.04751;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layerRoot) then {
	_item777 = _item772 createUnit ["uns_pilot5",[13638.3,7187.54,1.9614],[],0,"CAN_COLLIDE"];
	_this = _item777;
	_objects pushback _this;
	_objectIDs pushback 777;
	_this setPosWorld [13637.6,7186.64,14.3782];
	_this setVectorDirAndUp [[0.0297883,-0.999556,0],[0,0,1]];
	_this setname "Paul Anderson";
	_this setface "Default";
	_this setspeaker "male09eng";
	_this setpitch 0.955979;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layerRoot) then {
	_item773 = createVehicle ["uns_UH1D_m60",[13638.3,7187.54,0],[],0,"CAN_COLLIDE"];
	_this = _item773;
	_objects pushback _this;
	_objectIDs pushback 773;
	_this setPosWorld [13638.3,7187.54,15.1514];
	_this setVectorDirAndUp [[0.0297883,-0.999556,0],[0,0,1]];
...
if (_layerRoot) then {
	_item780 = _item778 createUnit ["uns_pilot5",[13657.8,7191.28,0],[],0,"CAN_COLLIDE"];
	_item778 selectLeader _item780;
	_this = _item780;
	_objects pushback _this;
	_objectIDs pushback 780;
	_this setPosWorld [13658.6,7188.49,14.1113];
	_this setVectorDirAndUp [[0.0906674,-0.995881,0],[0,0,1]];
	_this setname "Jammie Newton";
	_this setface "Default";
	_this setspeaker "male08eng";
	_this setpitch 1.00595;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layerRoot) then {
	_item781 = _item778 createUnit ["uns_pilot5",[13657.8,7191.28,1.63917],[],0,"CAN_COLLIDE"];
	_this = _item781;
	_objects pushback _this;
	_objectIDs pushback 781;
	_this setPosWorld [13658,7188.46,14.1101];
	_this setVectorDirAndUp [[0.0906674,-0.995881,0],[0,0,1]];
	_this setname "Harvey Dayton";
	_this setface "Default";
	_this setspeaker "male02engb";
	_this setpitch 1.00121;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layerRoot) then {
	_item779 = createVehicle ["uns_H13_transport_Army",[13658.1,7190.85,0],[],0,"CAN_COLLIDE"];
	_this = _item779;
	_objects pushback _this;
	_objectIDs pushback 779;
	_this setPosWorld [13658.1,7190.85,14.8292];
	_this setVectorDirAndUp [[0.0906674,-0.995881,0],[0,0,1]];
	[_this,"[[[[""uns_mkvFlarePistol"",""uns_MX991_w"",""uns_m16"",""FirstAidKit""],[1,2,1,8]],[[""UNS_EAM2Braft"",""uns_20Rnd_556x45_Stanag"",""uns_ItemFuelcan"",""uns_40mm_mkv_White""],[1,6,1,4]],[[""Binocular""],[1]],[[],[]]],false]"] call bis_fnc_initAmmoBox;
	[_this, 8] call ace_cargo_fnc_setSpace;
};

private _item792 = objNull;
if (_layerRoot) then {
	_item792 = _item790 createUnit ["uns_pilot1",[6683.57,7651.3,37.769],[],0,"CAN_COLLIDE"];
	_item790 selectLeader _item792;
	_this = _item792;
	_objects pushback _this;
	_objectIDs pushback 792;
	_this setPosWorld [6683.6,7642.18,48.6321];
	_this setVectorDirAndUp [[0.057097,-0.998369,0],[0,0,1]];
...
if (_layerRoot) then {
	_item793 = _item790 createUnit ["uns_pilot1",[6683.57,7651.3,37.769],[],0,"CAN_COLLIDE"];
	_this = _item793;
	_objects pushback _this;
	_objectIDs pushback 793;
	_this setPosWorld [6684.51,7642.96,48.0335];
	_this setVectorDirAndUp [[0.057097,-0.998369,0],[0,0,1]];
...
if (_layerRoot) then {
	_item808 = _item806 createUnit ["uns_pilot11",[6664.72,7352.52,0],[],0,"CAN_COLLIDE"];
	_item806 selectLeader _item808;
	_this = _item808;
	_objects pushback _this;
	_objectIDs pushback 808;
	_this setPosWorld [6670.57,7366.21,16.1575];
	_this setVectorDirAndUp [[0,1,0],[-0.0128351,0,0.999918]];
	_this setname "Jack Faulkner";
	_this setface "Default";
...
if (_layerRoot) then {
	_item809 = _item806 createUnit ["uns_pilot11",[6664.69,7352.54,5.74467],[],0,"CAN_COLLIDE"];
	_this = _item809;
	_objects pushback _this;
	_objectIDs pushback 809;
	_this setPosWorld [6671.55,7366.21,16.1706];
	_this setVectorDirAndUp [[0,1,0],[-0.0128351,0,0.999918]];
	_this setname "Spencer Davis";
	_this setface "Default";
	_this setspeaker "male04engb";
	_this setpitch 1.03114;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layerRoot) then {
	_item810 = _item806 createUnit ["uns_pilot11",[6664.69,7352.54,5.74467],[],0,"CAN_COLLIDE"];
	_this = _item810;
	_objects pushback _this;
	_objectIDs pushback 810;
	_this setPosWorld [6671.06,7365.18,16.1223];
	_this setVectorDirAndUp [[0,1,0],[-0.0128351,0,0.999918]];
	_this setname "Tyler Moore";
	_this setface "Default";
	_this setspeaker "male01per";
	_this setpitch 1.01677;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layerRoot) then {
	_item811 = _item806 createUnit ["uns_pilot11",[6664.69,7352.54,5.74467],[],0,"CAN_COLLIDE"];
	_this = _item811;
	_objects pushback _this;
	_objectIDs pushback 811;
	_this setPosWorld [6670,7350.82,14.5321];
	_this setVectorDirAndUp [[0,1,0],[-0.0128351,0,0.999918]];
	_this setname "Jacob Jones";
	_this setface "Default";
	_this setspeaker "male05gre";
	_this setpitch 1.00757;
	if !(0 == ([0, 1] select (_this getUnitTrait 'engineer')) || {0 == -1}) then {_this setVariable ['s', 0, true]};
	_this setVariable ["ace_advanced_fatigue_performanceFactor", 1, true];
	_this setVariable ['ACE_isEOD', false, true];
	if (0 >= 0.1) then {_this setVariable ["ace_medical_damageThreshold", 0, true]};
...
if (_layerRoot) then {
	_item807 = createVehicle ["uns_KC130_H",[6671.09,7350.39,-0.000181198],[],0,"CAN_COLLIDE"];
	_this = _item807;
	_objects pushback _this;
	_objectIDs pushback 807;
	_this setPosWorld [6671.01,7350.41,19.0193];
	_this setVectorDirAndUp [[0,1,0],[-0.0128351,0,0.999918]];
	_this setFuel 0;
	[_this,"[[[[""FirstAidKit""],[4]],[[],[]],[[""ItemGPS"",""ItemRadio""],[1,1]],[[""B_Parachute""],[3]]],false]"] call bis_fnc_initAmmoBox;
	_this setVehicleReportRemoteTargets true;
...
if (_layerRoot) then {
	...
	_this setPosWorld [7310.29,16063.6,437.203];
...
if (_layerRoot) then {
	...
	_this setPosWorld [7309.32,16063.6,437.204];
	_this setVectorDirAndUp [[-0.0299105,-0.999553,0],[0,0,1]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [7309.84,16064.6,437.162];
	_this setVectorDirAndUp [[-0.0299105,-0.999553,0],[0,0,1]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [7311.34,16078.9,435.585];
	_this setVectorDirAndUp [[-0.0299105,-0.999553,0],[0,0,1]];
...
if (_layerRoot) then {
	_item813 = createVehicle ["uns_KC130_H",[7309.71,16079.6,255.946],[],0,"FLY"];
	_this = _item813;
	_objects pushback _this;
	_objectIDs pushback 813;
	_this setPosWorld [7310.29,16079.4,440.059];
	_this setVectorDirAndUp [[-0.0299105,-0.999553,0],[0,0,1]];
	[_this,"[[[[""FirstAidKit""],[4]],[[],[]],[[""ItemGPS"",""ItemRadio""],[1,1]],[[""B_Parachute""],[3]]],false]"] call bis_fnc_initAmmoBox;
	_this setVehicleReportRemoteTargets true;
	_this setVehicleReceiveRemoteTargets true;
...
if (_layerRoot) then {
	...
	_this setPosWorld [3525.05,1657.32,52.6488];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3526.09,1658.09,52.6528];
	_this setVectorDirAndUp [[0.591894,-0.806012,-0.00265154],[-0.000567943,-0.00370675,0.999993]];
	_this setname "Jack Robertson";
	_this setface "Default";
	_this setspeaker "male04gre";
...
if (_layerRoot) then {
	...
	_this setPosWorld [3290.21,6313.2,4.26568];
	_this setVectorDirAndUp [[-0.606327,0.795209,-0.00340563],[0.00181514,0.00566661,0.999982]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3291.46,6312.7,4.60364];
	_this setVectorDirAndUp [[-0.606327,0.795209,-0.00340563],[0.00181514,0.00566661,0.999982]];
...
if (_layerRoot) then {
	_item1112 = createVehicle ["uns_M113_transport",[3291.19,6312.34,0.0565565],[],0,"CAN_COLLIDE"];
	_this = _item1112;
	_objects pushback _this;
	_objectIDs pushback 1112;
	_this setPosWorld [3291.19,6312.33,6.28096];
	_this setVectorDirAndUp [[-0.606327,0.795209,-0.00340563],[0.00181514,0.00566661,0.999982]];
	[_this,"[[[[""uns_mkvFlarePistol"",""uns_MX991_g"",""FirstAidKit""],[1,1,20]],[[""uns_ItemFuelcan"",""uns_m18white"",""uns_m18Purple"",""uns_m18Yellow"",""uns_m18Green"",""uns_40mm_mkv_White""],[2,10,10,10,10,12]],[[""Binocular"",""ToolKit"",""ACE_rope12""],[1,1,1]],[[],[]]],false]"] call bis_fnc_initAmmoBox;
	_this setVariable ['s',1];
	[_this, 4] call ace_cargo_fnc_setSpace;
};
...
if (_layerRoot) then {
	...
	_this setPosWorld [3267.09,6338.49,5.67968];
	_this setVectorDirAndUp [[-0.32517,0.945656,0],[0,0,1]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3267.37,6337.89,5.51815];
	_this setVectorDirAndUp [[-0.32517,0.945656,0],[0,0,1]];
...
if (_layerRoot) then {
	_item1118 = createVehicle ["uns_xm706e2",[3267.38,6337.88,-0.161286],[],0,"CAN_COLLIDE"];
	_this = _item1118;
	_objects pushback _this;
	_objectIDs pushback 1118;
	_this setPosWorld [3267.37,6337.82,5.98276];
	_this setVectorDirAndUp [[-0.32517,0.945656,0],[0,0,1]];
	[_this,"[[[[""uns_mkvFlarePistol"",""uns_MX991_g"",""FirstAidKit""],[1,1,4]],[[""uns_40mm_mkv_Green"",""uns_ItemFuelcan"",""DemoCharge_Remote_Mag""],[8,1,1]],[[""ToolKit"",""ACE_rope12""],[1,1]],[[],[]]],false]"] call bis_fnc_initAmmoBox;
	_this setVariable ['s',1];
	[_this, 4] call ace_cargo_fnc_setSpace;
...
if (_layerRoot) then {
	...
	_this setPosWorld [3280.72,6313.11,4.18966];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3281.79,6312.54,5.29789];
	_this setVectorDirAndUp [[-0.436396,0.899686,-0.0111452],[0.00171119,0.0132168,0.999911]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3268.08,6321.82,5.8414];
	_this setVectorDirAndUp [[-0.707471,0.706742,0],[0,0,1]];
...
if (_layerRoot) then {
	_item1136 = createVehicle ["uns_xm706e1",[3268.11,6321.83,0.0283089],[],0,"CAN_COLLIDE"];
	_this = _item1136;
	_objects pushback _this;
...
if (_layerRoot) then {
	_item1218 = _item1217 createUnit ["uns_US_1CAV_RF1",[13645.8,7160.25,0],[],0,"CAN_COLLIDE"];
	_item1217 selectLeader _item1218;
	_this = _item1218;
	_objects pushback _this;
	_objectIDs pushback 1218;
	_this setPosWorld [13645.8,7160.3,13.1914];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item1220 = _item1219 createUnit ["uns_US_1CAV_SL",[13646.4,7159.27,0],[],0,"CAN_COLLIDE"];
	_item1219 selectLeader _item1220;
	_this = _item1220;
	_objects pushback _this;
	_objectIDs pushback 1220;
	_this setPosWorld [13646.4,7159.31,13.1914];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item1222 = _item1221 createUnit ["uns_US_1CAV_RF1",[13643.9,7159.89,0],[],0,"CAN_COLLIDE"];
	_item1221 selectLeader _item1222;
	_this = _item1222;
	_objects pushback _this;
	_objectIDs pushback 1222;
	_this setPosWorld [13643.9,7159.94,13.1914];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item1224 = _item1223 createUnit ["uns_US_1CAV_HMG",[13648.7,7155.58,0],[],0,"CAN_COLLIDE"];
	_item1223 selectLeader _item1224;
	_this = _item1224;
	_objects pushback _this;
	_objectIDs pushback 1224;
	_this setPosWorld [13648.7,7155.63,13.1914];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item1226 = _item1225 createUnit ["uns_US_1CAV_MED",[13672.5,7125,0],[],0,"CAN_COLLIDE"];
	_item1225 selectLeader _item1226;
	_this = _item1226;
	_objects pushback _this;
	_objectIDs pushback 1226;
	_this setPosWorld [13672.5,7125.05,13.1914];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item1228 = _item1227 createUnit ["uns_US_1CAV_MRK",[13673.5,7126.15,0],[],0,"CAN_COLLIDE"];
	_item1227 selectLeader _item1228;
	_this = _item1228;
	_objects pushback _this;
	_objectIDs pushback 1228;
	_this setPosWorld [13673.5,7126.2,13.1914];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item1230 = _item1229 createUnit ["uns_US_1CAV_GL",[13618.4,7134.95,0],[],0,"CAN_COLLIDE"];
	_item1229 selectLeader _item1230;
	_this = _item1230;
	_objects pushback _this;
	_objectIDs pushback 1230;
	_this setPosWorld [13618.4,7135,13.1513];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item1232 = _item1231 createUnit ["uns_US_1CAV_DEM",[13619.2,7134.61,0],[],0,"CAN_COLLIDE"];
	_item1231 selectLeader _item1232;
	_this = _item1232;
	_objects pushback _this;
	_objectIDs pushback 1232;
	_this setPosWorld [13619.2,7134.66,13.158];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item1234 = _item1233 createUnit ["uns_US_1CAV_AT",[13618.5,7133.68,-1.43051e-005],[],0,"CAN_COLLIDE"];
	_item1233 selectLeader _item1234;
	_this = _item1234;
	_objects pushback _this;
	_objectIDs pushback 1234;
	_this setPosWorld [13618.5,7133.73,13.1495];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [6606.11,7394.91,13.9625];
...
if (_layerRoot) then {
	...
	_this setPosWorld [6606.1,7393.24,14.3287];
	_this setVectorDirAndUp [[0.420569,0.90726,0],[0,0,1]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [6715.3,7360.7,13.8305];
	_this setVectorDirAndUp [[0,0.999996,-0.00265204],[0.00265199,0.00265203,0.999993]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [6716,7359.18,14.1988];
	_this setVectorDirAndUp [[0,0.999996,-0.00265204],[0.00265199,0.00265203,0.999993]];
	_this setname "Daniel Santorum";
	_this setface "WhiteHead_21";
...
if (_layerRoot) then {
	...
	_this setPosWorld [3716.25,2782.19,4.14772];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3716.99,2780.72,4.60011];
...
if (_layerRoot) then {
	_item1348 = _item1346 createUnit ["uns_US_6TB_DRV2",[6640.85,7345.55,-3.8147e-006],[],0,"CAN_COLLIDE"];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3581.32,1816.11,9.25933];
	_this setVectorDirAndUp [[0,1,0],[0.00594023,0,0.999982]];
...
if (_layerRoot) then {
	_item1562 = createVehicle ["uns_UH1D_USMC_m60",[3581.85,1812.98,1.14441e-005],[],0,"CAN_COLLIDE"];
	_this = _item1562;
	_objects pushback _this;
...
if (_layerRoot) then {
	...
	_this setPosWorld [3510.08,1830.93,9.6849];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3511.02,1830.93,9.68143];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Lee Baker";
	_this setface "Default";
	_this setspeaker "male04gre";
...
if (_layerRoot) then {
	...
	_this setPosWorld [3509.86,1829.38,9.05015];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3511.26,1829.35,9.05239];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Thomas Robertson";
	_this setface "Default";
	_this setspeaker "male02eng";
...
if (_layerRoot) then {
	...
	_this setPosWorld [3510.75,1818.88,9.07519];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
	_this setname "Cameron Newton";
	_this setface "Default";
	_this setspeaker "male02eng";
...
if (_layerRoot) then {
	...
	_this setPosWorld [3612.41,1831.74,9.70229];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3611.11,1831.74,9.70998];
	_this setVectorDirAndUp [[0,0.999999,-0.00161945],[0.00549153,0.00161942,0.999984]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3610.97,1830.18,9.1065];
	_this setVectorDirAndUp [[0,0.999999,-0.00161945],[0.00549153,0.00161942,0.999984]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3612.35,1830.15,9.10122];
	_this setVectorDirAndUp [[0,0.999999,-0.00161945],[0.00549153,0.00161942,0.999984]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3611.64,1820.58,8.3143];
	_this setVectorDirAndUp [[0,0.999999,-0.00161945],[0.00549153,0.00161942,0.999984]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3481.63,1708.63,10.7068];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3480.42,1708.18,10.7268];
	_this setVectorDirAndUp [[-0.346887,0.937891,0.00554739],[0.0159899,0,0.999872]];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3459.69,1699.23,10.2174];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3458.68,1698.82,10.2174];
	_this setVectorDirAndUp [[-0.375405,0.92686,0.00102418],[-0.000345267,-0.00124485,0.999999]];
	_this setname "Ryan Jones";
	_this setface "Default";
	_this setspeaker "male01gre";
...
if (_layerRoot) then {
	...
	_this setPosWorld [3439.38,1692.19,10.1984];
...
if (_layerRoot) then {
	...
	_this setPosWorld [3438.37,1691.82,10.1989];
	_this setVectorDirAndUp [[-0.347713,0.9376,0.00112112],[0,-0.00119573,0.999999]];
...
if (_layerRoot) then {
	_item1622 = createVehicle ["uns_UH1D_USMC_m60",[6931,7127.58,0.0817127],[],0,"CAN_COLLIDE"];
	_this = _item1622;
	_objects pushback _this;
...
if (_layerRoot) then {
	_item1624 = createVehicle ["uns_UH1D_USMC_m60",[6709.31,7071.39,0.237257],[],0,"CAN_COLLIDE"];
	_this = _item1624;
	_objects pushback _this;
...
if (_layerRoot) then {
	_item1627 = _item1626 createUnit ["uns_pil_usmc_1",[3645.06,2193.15,0],[],0,"CAN_COLLIDE"];
...
if (_layerRoot) then {
	_item1628 = createVehicle ["uns_f8e_USMC_BMB",[3645.06,2193.15,0],[],0,"CAN_COLLIDE"];
	_this = _item1628;
	_objects pushback _this;
...
if (_layerRoot) then {
	_item1630 = _item1629 createUnit ["uns_pil_usmc_1",[3644.21,2079.17,0.000124931],[],0,"CAN_COLLIDE"];
...
if (_layerRoot) then {
	...
	_this setVectorDirAndUp [[0,0.999943,0.0106641],[0.0133317,-0.0106631,0.999854]];
	_this setPylonLoadout [1,"uns_pylonRack_2Rnd_AIM9D_F8"];
	_this setPylonLoadout [2,"uns_pylonRack_1Rnd_Bomb_MK82"];
	_this setPylonLoadout [3,"uns_pylonRack_1Rnd_Bomb_MK82"];
	_this setFuel 0;
...
private _item1519 = [];
if (_layerRoot) then {
	_item1519 = _item812 addWaypoint [[5260.82,3669.67,2.38419e-007],0];
	_this = _item1519;
	_waypoints pushback _this;
	_waypointIDs pushback 1519;
	_this setWaypointType "MOVE";
};
...
private _item1522 = [];
if (_layerRoot) then {
	_item1522 = _item812 addWaypoint [[8540.95,-6238.01,32.1208],0];
	_this = _item1522;
	_waypoints pushback _this;
...
private _item1523 = [];
if (_layerRoot) then {
	_item1523 = _item812 addWaypoint [[20916.4,-43.6377,26.923],0];
	_this = _item1523;
	_waypoints pushback _this;
	_waypointIDs pushback 1523;
	_this setWaypointType "MOVE";
};

private _item1524 = [];
if (_layerRoot) then {
	_item1524 = _item812 addWaypoint [[21832.7,12160,0],0];
	_this = _item1524;
	_waypoints pushback _this;
	_waypointIDs pushback 1524;
	_this setWaypointType "MOVE";
};

private _item1525 = [];
if (_layerRoot) then {
	_item1525 = _item812 addWaypoint [[9585.46,21687.3,0],0];
	_this = _item1525;
	_waypoints pushback _this;
	_waypointIDs pushback 1525;
	_this setWaypointType "CYCLE";
};
...
if (_layer388) then {missionNamespace setVariable ["OPORD-0724-C15%2e8_Briefing Area",[[_item316,_item317,_item318,_item319,_item320,_item321,_item322,_item323,_item324,_item325,_item326,_item327,_item328,_item329,_item330,_item331,_item332,_item333,_item334,_item335,_item336,_item337,_item338,_item339,_item340,_item341,_item342,_item343,_item344,_item345,_item346,_item347,_item348,_item349,_item350,_item351,_item352,_item353,_item354,_item355,_item356,_item357,_item358,_item359,_item360,_item361,_item362,_item363,_item364,_item365,_item366,_item367,_item368,_item369,_item370,_item371,_item372,_item373,_item374,_item375,_item376,_item377,_item378,_item379,_item380,_item381,_item382,_item383,_item384,_item385,_item386,_item387],[]]];};
...
if (!isNull _item679 && !isNull _item678) then {_item679 moveInTurret [_item678,[0]];};
if (!isNull _item692 && !isNull _item691) then {_item692 moveInTurret [_item691,[0]];};
if (!isNull _item695 && !isNull _item694) then {_item695 moveInTurret [_item694,[0]];};
if (!isNull _item689 && !isNull _item688) then {_item689 moveInTurret [_item688,[0]];};
...
if (!isNull _item774 && !isNull _item773) then {_item774 moveInDriver _item773;};
if (!isNull _item775 && !isNull _item773) then {_item775 moveInTurret [_item773,[0]];};
if (!isNull _item776 && !isNull _item773) then {_item776 moveInTurret [_item773,[1]];};
if (!isNull _item777 && !isNull _item773) then {_item777 moveInTurret [_item773,[2]];};
if (!isNull _item780 && !isNull _item779) then {_item780 moveInDriver _item779;};
if (!isNull _item781 && !isNull _item779) then {_item781 moveInTurret [_item779,[0]];};
...
if (!isNull _item808 && !isNull _item807) then {_item808 moveInDriver _item807;};
if (!isNull _item809 && !isNull _item807) then {_item809 moveInTurret [_item807,[0]];};
if (!isNull _item810 && !isNull _item807) then {_item810 moveInTurret [_item807,[1]];};
if (!isNull _item811 && !isNull _item807) then {_item811 moveInTurret [_item807,[2]];};
