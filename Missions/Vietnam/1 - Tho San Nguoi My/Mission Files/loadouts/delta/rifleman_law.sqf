...
ACE_player addWeapon "launch_MRAWS_green_F";
ACE_player addSecondaryWeaponItem "MRAWS_HEAT_F";
...
ACE_player addItemToUniform "ACE_EntrenchingTool";
...
for "_i" from 1 to 2 do {ACE_player addItemToBackpack "MRAWS_HEAT_F";};
ACE_player addItemToBackpack "MRAWS_HE_F";
