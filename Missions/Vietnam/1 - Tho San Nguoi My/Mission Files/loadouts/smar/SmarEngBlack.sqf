...
player forceAddUniform "Alpine_Massif_Camo";
player addVest "Exer_LPC_blk_Light";
player addBackpack "Exer_Belt_BLK_2";
...
player addHeadgear "jsoc_rhsusf_cvc_winter_helmet";
