[mapclick_pos,"PortableHelipadLight_01_blue_F",[0,0,1000,1]] spawn { 
    ...
    private _laserPointObject = nearestObject [_turretBase,_lightClass]; 
    ...
    ROOT_fnc_RE_Server = { 
        ...
        _varName = ("ROOT"+str (round random 10000)); 
    ...
    ROOT_fnc_InitializeLaserCannon = { 
        ...
        [[_turretBase,_laserPointObject,_laserColor],{ 
            ...
            [[_turretBase,_laserPointObject,_laserColor],{ 
                ...
                _turretBase setVariable ["ROOTLightObject",_laserPointObject]; 
                _turretBase setVariable ["ROOTLaserColor",_laserColor]; 
                _turretBase setVariable ["ROOTLightSource",_lightSource]; 
            
                ROOT_fnc_spawnFireLaserCannon = { 
                    ...
                    [_laserPointObject,_laserColor,_laserTime,_turretBase,_startPos] spawn { 
                        ...
                        if (local _turretBase) then { 
                            ...
                            if (!isNil "_impactTarget") then {_impactTarget setDamage ((damage _impactTarget)+0.05);}; 
                            uiSleep 10; 
                            deleteVehicle _exp; 
                        }; 
                    }; 
                ...
                _turretBase addEventHandler ["Fired",{ 
                    ...
                    private _laserPointObject = _unit getVariable "ROOTLightObject"; 
                    if (isNil "_laserPointObject") exitWith {}; 
                    private _laserColor = _unit getVariable "ROOTLaserColor"; 
                    if (isNil "_laserColor") exitWith {}; 
                    private _lightSource = _unit getVariable "ROOTLightSource"; 
                    if (isNil "_laserColor") exitWith {}; 
                
                    [_laserPointObject,_laserColor,0.05,_unit,_lightSource] spawn ROOT_fnc_spawnFireLaserCannon; 
                ...
                addMissionEventHandler ['EachFrame',{ 
                    ...
                    if (local _turretBase) then { 
                        ...
                        [_turretBase,_gunner,_closestTarget] call ROOT_fnc_FireAI; 
                    }; 
                },[_turretBase]]; 
            }] remoteExec ["Spawn",0,_turretBase]; 
        }] call ROOT_fnc_RE_Server; 
    }; 

    [_turretBase,_laserPointObject,_laserColor] call ROOT_fnc_InitializeLaserCannon; 
};